...
shader using [set and binding decorations](#descriptorheaps-bindings),
which will be the preferred path for some implementations initially, though
such implementations are expected to lean less on this mechanism over time. |
...
* 
[](#VUID-VkDescriptorSetAndBindingMappingEXT-source-12452) VUID-VkDescriptorSetAndBindingMappingEXT-source-12452

If `source` is [VK_DESCRIPTOR_MAPPING_SOURCE_PUSH_DATA_EXT](#VkDescriptorMappingSourceEXT),
`sourceData.pushDataOffset` **must** be less than or equal to
`maxPushDataSize` - 4
...
* 
[](#VUID-VkDescriptorSetAndBindingMappingEXT-source-12453) VUID-VkDescriptorSetAndBindingMappingEXT-source-12453

If `source` is [VK_DESCRIPTOR_MAPPING_SOURCE_PUSH_ADDRESS_EXT](#VkDescriptorMappingSourceEXT),
`sourceData.pushAddressOffset` **must** be less than or equal to
`maxPushDataSize` - 8
...
or [VK_DESCRIPTOR_MAPPING_SOURCE_HEAP_WITH_SHADER_RECORD_INDEX_EXT](#VkDescriptorMappingSourceEXT),
and `descriptorSet`, `firstBinding`, and `bindingCount`
identify any `OpTypeSampledImage` variables, and
`pEmbeddedSampler` is `NULL`, then any `samplerHeapOffset` and
`samplerHeapArrayStride` members of the corresponding member of
`sourceData` **must** be 0 or a multiple of
[`samplerDescriptorAlignment`](limits.html#limits-samplerDescriptorAlignment)

* 
[](#VUID-VkDescriptorSetAndBindingMappingEXT-source-12406) VUID-VkDescriptorSetAndBindingMappingEXT-source-12406
...
or [VK_DESCRIPTOR_MAPPING_SOURCE_HEAP_WITH_SHADER_RECORD_INDEX_EXT](#VkDescriptorMappingSourceEXT),
and `descriptorSet`, `firstBinding`, and `bindingCount`
identify any `OpTypeSampledImage` variables, any `heapOffset` and
`heapArrayStride` members of the corresponding member of
`sourceData` **must** be 0 or a multiple of
[`imageDescriptorAlignment`](limits.html#limits-imageDescriptorAlignment)

* 
[](#VUID-VkDescriptorSetAndBindingMappingEXT-source-12456) VUID-VkDescriptorSetAndBindingMappingEXT-source-12456

If `source` is
[VK_DESCRIPTOR_MAPPING_SOURCE_HEAP_WITH_PUSH_INDEX_EXT](#VkDescriptorMappingSourceEXT), and
`descriptorSet`, `firstBinding`, and `bindingCount` identify
any `OpTypeSampledImage` variables, and `pEmbeddedSampler` is
`NULL`, `samplerPushOffset` **must** be a multiple of 4

* 
[](#VUID-VkDescriptorSetAndBindingMappingEXT-source-12457) VUID-VkDescriptorSetAndBindingMappingEXT-source-12457

If `source` is
[VK_DESCRIPTOR_MAPPING_SOURCE_HEAP_WITH_PUSH_INDEX_EXT](#VkDescriptorMappingSourceEXT), and
`descriptorSet`, `firstBinding`, and `bindingCount` identify
any `OpTypeSampledImage` variables, and `pEmbeddedSampler` is
`NULL`, `samplerPushOffset` **must** be less than or equal to
`maxPushDataSize` - 4

* 
[](#VUID-VkDescriptorSetAndBindingMappingEXT-source-12458) VUID-VkDescriptorSetAndBindingMappingEXT-source-12458
...
and `descriptorSet`, `firstBinding`, and `bindingCount`
identify any `OpTypeSampledImage` variables, and
`pEmbeddedSampler` is `NULL`, `samplerPushOffset` **must** be a
multiple of 8

* 
[](#VUID-VkDescriptorSetAndBindingMappingEXT-source-12459) VUID-VkDescriptorSetAndBindingMappingEXT-source-12459
...
and `descriptorSet`, `firstBinding`, and `bindingCount`
identify any `OpTypeSampledImage` variables, and
`pEmbeddedSampler` is `NULL`, `samplerPushOffset` **must** be less
than or equal to `maxPushDataSize` - 8

* 
[](#VUID-VkDescriptorSetAndBindingMappingEXT-source-12460) VUID-VkDescriptorSetAndBindingMappingEXT-source-12460
...
and `descriptorSet`, `firstBinding`, and `bindingCount`
identify any `OpTypeSampledImage` variables, and
`pEmbeddedSampler` is `NULL`, `samplerAddressOffset` **must** be a
multiple of 4
...
* 
[](#VUID-VkDescriptorMappingSourceConstantOffsetEXT-pEmbeddedSampler-12432) VUID-VkDescriptorMappingSourceConstantOffsetEXT-pEmbeddedSampler-12432

If `pEmbeddedSampler` is a valid pointer to a
[VkSamplerCreateInfo](samplers.html#VkSamplerCreateInfo), the [VkSamplerCreateInfo](samplers.html#VkSamplerCreateInfo)::`pNext`
chain **must** not contain [VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT)
...
* 
[](#VUID-VkDescriptorMappingSourcePushIndexEXT-pEmbeddedSampler-11445) VUID-VkDescriptorMappingSourcePushIndexEXT-pEmbeddedSampler-11445
...
* 
[](#VUID-VkDescriptorMappingSourcePushIndexEXT-pEmbeddedSampler-11415) VUID-VkDescriptorMappingSourcePushIndexEXT-pEmbeddedSampler-11415
...
* 
[](#VUID-VkDescriptorMappingSourcePushIndexEXT-pEmbeddedSampler-12432) VUID-VkDescriptorMappingSourcePushIndexEXT-pEmbeddedSampler-12432
...
* 
[](#VUID-VkDescriptorMappingSourceIndirectIndexEXT-pEmbeddedSampler-11445) VUID-VkDescriptorMappingSourceIndirectIndexEXT-pEmbeddedSampler-11445
...
* 
[](#VUID-VkDescriptorMappingSourceIndirectIndexEXT-pEmbeddedSampler-11415) VUID-VkDescriptorMappingSourceIndirectIndexEXT-pEmbeddedSampler-11415
...
* 
[](#VUID-VkDescriptorMappingSourceIndirectIndexEXT-pEmbeddedSampler-12432) VUID-VkDescriptorMappingSourceIndirectIndexEXT-pEmbeddedSampler-12432
...
* 
[](#VUID-VkDescriptorMappingSourceIndirectIndexArrayEXT-pEmbeddedSampler-11445) VUID-VkDescriptorMappingSourceIndirectIndexArrayEXT-pEmbeddedSampler-11445
...
* 
[](#VUID-VkDescriptorMappingSourceIndirectIndexArrayEXT-pEmbeddedSampler-11415) VUID-VkDescriptorMappingSourceIndirectIndexArrayEXT-pEmbeddedSampler-11415
...
* 
[](#VUID-VkDescriptorMappingSourceIndirectIndexArrayEXT-pEmbeddedSampler-12432) VUID-VkDescriptorMappingSourceIndirectIndexArrayEXT-pEmbeddedSampler-12432
...
* 
[](#VUID-VkDescriptorMappingSourceShaderRecordIndexEXT-pEmbeddedSampler-11445) VUID-VkDescriptorMappingSourceShaderRecordIndexEXT-pEmbeddedSampler-11445
...
* 
[](#VUID-VkDescriptorMappingSourceShaderRecordIndexEXT-pEmbeddedSampler-11415) VUID-VkDescriptorMappingSourceShaderRecordIndexEXT-pEmbeddedSampler-11415
...
* 
[](#VUID-VkDescriptorMappingSourceShaderRecordIndexEXT-pEmbeddedSampler-12432) VUID-VkDescriptorMappingSourceShaderRecordIndexEXT-pEmbeddedSampler-12432
...
|  | Values returned by this function may be non power-of-two. |
| --- | --- |

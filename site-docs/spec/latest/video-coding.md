...
the internal state of the implementation’s [rate    control](#encode-rate-control) algorithm to account for the bitrate budget consumed by these
...
(⌈`width` / `texelSize.width`⌉,
⌈`height` / `texelSize.height`⌉).
...
encoded pictures in order to enable the implementation’s rate control
...
* 
`gopRemainingI` specifies the number of [I    frames](#encode-h264-i-pic) the implementation’s rate control algorithm **should** assume to
be remaining in the [GOP](#encode-h264-gop) prior to executing the video
encode operation.

* 
`gopRemainingP` specifies the number of [P    frames](#encode-h264-p-pic) the implementation’s rate control algorithm **should** assume to
be remaining in the [GOP](#encode-h264-gop) prior to executing the video
encode operation.

* 
`gopRemainingB` specifies the number of [B    frames](#encode-h264-b-pic) the implementation’s rate control algorithm **should** assume to
be remaining in the [GOP](#encode-h264-gop) prior to executing the video
encode operation.
...
* 
`gopRemainingI` specifies the number of [I    frames](#encode-h265-i-pic) the implementation’s rate control algorithm **should** assume to
be remaining in the [GOP](#encode-h265-gop) prior to executing the video
encode operation.

* 
`gopRemainingP` specifies the number of [P    frames](#encode-h265-p-pic) the implementation’s rate control algorithm **should** assume to
be remaining in the [GOP](#encode-h265-gop) prior to executing the video
encode operation.

* 
`gopRemainingB` specifies the number of [B    frames](#encode-h265-b-pic) the implementation’s rate control algorithm **should** assume to
be remaining in the [GOP](#encode-h265-gop) prior to executing the video
encode operation.

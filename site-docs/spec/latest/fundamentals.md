...
- [Effective Flags](#fundamentals-effective-flags)
...
- [Success Codes](#fundamentals-successcodes)
- [Error Codes](#fundamentals-errorcodes)
...
*Synchronization commands* impose ordering constraints on action
commands, by introducing explicit
[execution and memory dependencies](synchronization.html#synchronization-dependencies).
...
* 
The `commandBuffer` parameter in [vkCmdSetDescriptorBufferOffsets2EXT](descriptorbuffers.html#vkCmdSetDescriptorBufferOffsets2EXT)

* 
The `commandBuffer` parameter in [vkCmdBindDescriptorBufferEmbeddedSamplers2EXT](descriptorbuffers.html#vkCmdBindDescriptorBufferEmbeddedSamplers2EXT)
...
* 
The `gpaSession` parameter in [vkDestroyGpaSessionAMD](gpa_interface.html#vkDestroyGpaSessionAMD)

* 
The `commandBuffer` parameter in [vkCmdBeginGpaSessionAMD](gpa_interface.html#vkCmdBeginGpaSessionAMD)

* 
The `commandBuffer` parameter in [vkCmdEndGpaSessionAMD](gpa_interface.html#vkCmdEndGpaSessionAMD)

* 
The `commandBuffer` parameter in [vkCmdBeginGpaSampleAMD](gpa_interface.html#vkCmdBeginGpaSampleAMD)

* 
The `commandBuffer` parameter in [vkCmdEndGpaSampleAMD](gpa_interface.html#vkCmdEndGpaSampleAMD)

* 
The `commandBuffer` parameter in [vkCmdCopyGpaSessionResultsAMD](gpa_interface.html#vkCmdCopyGpaSessionResultsAMD)
...
* 
The `queue` parameter in [vkQueueSetPerfHintQCOM](devsandqueues.html#vkQueueSetPerfHintQCOM),
if it was not created with
[VK_DEVICE_QUEUE_CREATE_INTERNALLY_SYNCHRONIZED_BIT_KHR](devsandqueues.html#VkDeviceQueueCreateFlagBits)

* 
The `commandBuffer` parameter in [vkCmdBindDescriptorBuffersEXT](descriptorbuffers.html#vkCmdBindDescriptorBuffersEXT)

* 
The `commandBuffer` parameter in [vkCmdSetDescriptorBufferOffsetsEXT](descriptorbuffers.html#vkCmdSetDescriptorBufferOffsetsEXT)

* 
The `commandBuffer` parameter in [vkCmdBindDescriptorBufferEmbeddedSamplersEXT](descriptorbuffers.html#vkCmdBindDescriptorBufferEmbeddedSamplersEXT)
...
* 
The `commandBuffer` parameter in [vkCmdBuildMicromapsEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdBuildMicromapsEXT)

* 
The `commandBuffer` parameter in [vkCmdCopyMicromapEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapEXT)

* 
The `commandBuffer` parameter in [vkCmdCopyMicromapToMemoryEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapToMemoryEXT)

* 
The `commandBuffer` parameter in [vkCmdCopyMemoryToMicromapEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMemoryToMicromapEXT)

* 
The `commandBuffer` parameter in [vkCmdWriteMicromapsPropertiesEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdWriteMicromapsPropertiesEXT)
...
* 
The `commandBuffer` parameter in [vkCmdSetDispatchParametersARM](dispatch.html#vkCmdSetDispatchParametersARM)
...
* 
The `commandBuffer` parameter in [vkCmdSetPrimitiveRestartIndexEXT](drawing.html#vkCmdSetPrimitiveRestartIndexEXT)
...
* 
Each element of the `pSwapchains` parameter in [vkSetHdrMetadataEXT](VK_KHR_surface/wsi.html#vkSetHdrMetadataEXT)
...
* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdSetDescriptorBufferOffsets2EXT](descriptorbuffers.html#vkCmdSetDescriptorBufferOffsets2EXT)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdBindDescriptorBufferEmbeddedSamplers2EXT](descriptorbuffers.html#vkCmdBindDescriptorBufferEmbeddedSamplers2EXT)
...
* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdBeginGpaSessionAMD](gpa_interface.html#vkCmdBeginGpaSessionAMD)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdEndGpaSessionAMD](gpa_interface.html#vkCmdEndGpaSessionAMD)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdBeginGpaSampleAMD](gpa_interface.html#vkCmdBeginGpaSampleAMD)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdEndGpaSampleAMD](gpa_interface.html#vkCmdEndGpaSampleAMD)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdCopyGpaSessionResultsAMD](gpa_interface.html#vkCmdCopyGpaSessionResultsAMD)
...
* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdBindDescriptorBuffersEXT](descriptorbuffers.html#vkCmdBindDescriptorBuffersEXT)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdSetDescriptorBufferOffsetsEXT](descriptorbuffers.html#vkCmdSetDescriptorBufferOffsetsEXT)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdBindDescriptorBufferEmbeddedSamplersEXT](descriptorbuffers.html#vkCmdBindDescriptorBufferEmbeddedSamplersEXT)
...
* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdBuildMicromapsEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdBuildMicromapsEXT)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdCopyMicromapEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapEXT)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdCopyMicromapToMemoryEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapToMemoryEXT)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdCopyMemoryToMicromapEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMemoryToMicromapEXT)

* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdWriteMicromapsPropertiesEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdWriteMicromapsPropertiesEXT)
...
* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdSetDispatchParametersARM](dispatch.html#vkCmdSetDispatchParametersARM)
...
* 
The `VkCommandPool` that `commandBuffer` was allocated from, in [vkCmdSetPrimitiveRestartIndexEXT](drawing.html#vkCmdSetPrimitiveRestartIndexEXT)
...
`FlagBits2`.
For example, a flag value of type [VkAccessFlags2](synchronization.html#VkAccessFlags2) **must** contain only
bit flags defined by [VkAccessFlagBits2](synchronization.html#VkAccessFlagBits2).
...
When the effective value of a bitmask command parameter or structure member
is determined by an extending structure providing a 64-bit version of the
bitflags, that effective value is used in all specification language,
including valid usage statements, referring to the original parameter.

Examples of such extending structures include (this list is not complete):

* 
[VkBufferUsageFlags2CreateInfo](resources.html#VkBufferUsageFlags2CreateInfo)

* 
[VkImageUsageFlags2CreateInfoKHR](resources.html#VkImageUsageFlags2CreateInfoKHR)

|  | When a 64-bit version of a flags type is defined, the implementation **must**
| --- | --- |
always represent those flags internally as 64 bits, whether they are
specified through the 32-bit or 64-bit APIs. |
...
* 
[VK_ERROR_PRESENT_TIMING_QUEUE_FULL_EXT](#VkResult) A present operation on a
swapchain created with [VK_SWAPCHAIN_CREATE_PRESENT_TIMING_BIT_EXT](VK_KHR_surface/wsi.html#VkSwapchainCreateFlagBitsKHR)

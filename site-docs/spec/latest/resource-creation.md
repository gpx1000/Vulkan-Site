...
- [Buffer-Image Granularity](#resources-bufferimagegranularity)
...
`usage` defines the [effective usage flags](fundamentals.html#fundamentals-effective-flags) for the buffer.
...
by [VkBufferUsageFlags2CreateInfo](#VkBufferUsageFlags2CreateInfo)::`usage`.
...
* 
[](#VUID-VkBufferCreateInfo-maintenance11-13353) VUID-VkBufferCreateInfo-maintenance11-13353

If the [`maintenance11`](features.html#features-maintenance11) feature is enabled
and `sharingMode` is [VK_SHARING_MODE_CONCURRENT](#VkSharingMode), then
...
If
the [`maintenance11`](features.html#features-maintenance11) feature is not
enabled and
`sharingMode` is [VK_SHARING_MODE_CONCURRENT](#VkSharingMode), then
...
If the `pNext` chain includes a
[VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT) structure, `flags`
**must** contain
...
[](#VUID-VkBufferCreateInfo-usage-10763) VUID-VkBufferCreateInfo-usage-10763
    ...
    `flags` **must** not contain any of the
[VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT](#VkBufferCreateFlagBits),
[VK_BUFFER_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT](#VkBufferCreateFlagBits),
[VK_BUFFER_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR](#VkBufferCreateFlagBits),
    [VK_BUFFER_CREATE_SPARSE_BINDING_BIT](#VkBufferCreateFlagBits),
    [VK_BUFFER_CREATE_SPARSE_RESIDENCY_BIT](#VkBufferCreateFlagBits),
    [VK_BUFFER_CREATE_SPARSE_ALIASED_BIT](#VkBufferCreateFlagBits), or
    [VK_BUFFER_CREATE_PROTECTED_BIT](#VkBufferCreateFlagBits) flags
...
[effective usage flags](#resources-effective-buffer-usage) **must** not
contain bits other than
...
property is not supported and the [    effective usage flags](#resources-effective-buffer-usage) include the
...
including [VkBufferUsageFlags](#VkBufferUsageFlags), the usage flags of the buffer are
returned in `flags` of this structure, allowing additional usage flags
to be queried.
The flags representable in [VkBufferUsageFlags](#VkBufferUsageFlags) are still returned in
...
* 
[VkDescriptorBufferBindingInfoEXT](descriptorbuffers.html#VkDescriptorBufferBindingInfoEXT)
...
// Provided by VK_AMDX_shader_enqueue with VK_VERSION_1_4 or VK_KHR_extended_flags or VK_KHR_maintenance5
...
// Provided by VK_KHR_extended_flags with VK_EXT_opacity_micromap, VK_EXT_opacity_micromap with VK_KHR_maintenance5 or VK_VERSION_1_4
...
// Provided by VK_KHR_extended_flags with VK_EXT_conditional_rendering, VK_KHR_maintenance5 with VK_EXT_conditional_rendering
static const VkBufferUsageFlagBits2 VK_BUFFER_USAGE_2_CONDITIONAL_RENDERING_BIT_EXT = 0x00000200ULL;
// Provided by VK_KHR_extended_flags with VK_KHR_ray_tracing_pipeline, VK_KHR_maintenance5 with VK_KHR_ray_tracing_pipeline
...
// Provided by VK_KHR_extended_flags with VK_EXT_transform_feedback, VK_KHR_maintenance5 with VK_EXT_transform_feedback
...
// Provided by VK_KHR_extended_flags with VK_KHR_video_decode_queue, VK_KHR_maintenance5 with VK_KHR_video_decode_queue
...
// Provided by VK_KHR_extended_flags with VK_KHR_video_encode_queue, VK_KHR_maintenance5 with VK_KHR_video_encode_queue
...
// Provided by VK_KHR_extended_flags with VK_VERSION_1_2 or VK_KHR_buffer_device_address or VK_EXT_buffer_device_address, VK_KHR_maintenance5 with VK_VERSION_1_2 or VK_KHR_buffer_device_address or VK_EXT_buffer_device_address
static const VkBufferUsageFlagBits2 VK_BUFFER_USAGE_2_SHADER_DEVICE_ADDRESS_BIT_KHR = 0x00020000ULL;
// Provided by VK_KHR_acceleration_structure with VK_KHR_extended_flags, VK_KHR_acceleration_structure with VK_KHR_maintenance5
...
// Provided by VK_KHR_extended_flags with VK_EXT_descriptor_buffer, VK_KHR_maintenance5 with VK_EXT_descriptor_buffer
...
* 
[VK_BUFFER_USAGE_2_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT](#VkBufferUsageFlagBits2KHR) specifies
that the buffer **can** be used as a [read-only    ](VK_KHR_opacity_micromap/micromaps.html#micromap-building)[VkMicromapEXT](#VkMicromapEXT) build input, which includes the `data` and
`triangleArray` parameters

* 
[VK_BUFFER_USAGE_2_MICROMAP_STORAGE_BIT_EXT](#VkBufferUsageFlagBits2KHR) specifies that the
buffer **can** be used to [create ](#resources-micromaps)[VkMicromapEXT](#VkMicromapEXT)    objects.
...
* 
[VK_BUFFER_USAGE_MICROMAP_BUILD_INPUT_READ_ONLY_BIT_EXT](#VkBufferUsageFlagBits) specifies
that when building a [VkMicromapEXT](#VkMicromapEXT), the buffer **can** be used as a
[read-only micromap build input](VK_KHR_opacity_micromap/micromaps.html#micromap-building), which includes the
`data` and `triangleArray` parameters

* 
[VK_BUFFER_USAGE_MICROMAP_STORAGE_BIT_EXT](#VkBufferUsageFlagBits) specifies that the buffer
**can** be used to [create ](#resources-micromaps)[VkMicromapEXT](#VkMicromapEXT)    objects.
...
[VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT) for more detail.
...
of `format` for [VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER](descriptors.html#VkDescriptorType) as
defined by
...
`offset` **must** be a multiple of the effective alignment requirement
of `format` for [VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER](descriptors.html#VkDescriptorType) as
defined by
[`minTexelBufferOffsetAlignment`](limits.html#limits-minTexelBufferOffsetAlignment)
...
via [resource descriptors](descriptors.html#descriptors).
...
`flags` defines the [effective create flags](fundamentals.html#fundamentals-effective-flags) for the image.
If the `pNext` chain includes a [VkImageCreateFlags2CreateInfoKHR](#VkImageCreateFlags2CreateInfoKHR)
structure, `flags` is ignored, and the effective create flags are
defined by [VkImageCreateFlags2CreateInfoKHR](#VkImageCreateFlags2CreateInfoKHR)::`flags`.

`usage` defines the [effective usage flags](fundamentals.html#fundamentals-effective-flags) for the image.
If the `pNext` chain includes a [VkImageUsageFlags2CreateInfoKHR](#VkImageUsageFlags2CreateInfoKHR)
structure, `usage` is ignored, and the effective usage flags are defined
by [VkImageUsageFlags2CreateInfoKHR](#VkImageUsageFlags2CreateInfoKHR)::`usage`.
...
* 
[](#VUID-VkImageCreateInfo-maintenance11-13354) VUID-VkImageCreateInfo-maintenance11-13354
...
[](#VUID-VkImageCreateInfo-initialLayout-00993) VUID-VkImageCreateInfo-initialLayout-00993
    ...
    `initialLayout` **must** be [VK_IMAGE_LAYOUT_UNDEFINED](#VkImageLayout),
[VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT](#VkImageLayout),
    or [VK_IMAGE_LAYOUT_PREINITIALIZED](#VkImageLayout)

* 
[](#VUID-VkImageCreateInfo-initialLayout-12478) VUID-VkImageCreateInfo-initialLayout-12478

If `initialLayout` is [VK_IMAGE_LAYOUT_PREINITIALIZED](#VkImageLayout),
...
* 
[](#VUID-VkImageCreateInfo-flags-13355) VUID-VkImageCreateInfo-flags-13355

If `flags` contains
[VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR](#VkImageCreateFlagBits), the
[`maintenance11`](features.html#features-maintenance11) feature **must** be enabled

* 
[](#VUID-VkImageCreateInfo-flags-13356) VUID-VkImageCreateInfo-flags-13356

If `flags` contains
[VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR](#VkImageCreateFlagBits),
`imageType` **must** be [VK_IMAGE_TYPE_1D](#VkImageType) or
[VK_IMAGE_TYPE_2D](#VkImageType)
...
* 
[](#VUID-VkImageCreateInfo-pNext-12480) VUID-VkImageCreateInfo-pNext-12480

If the `pNext` chain includes a
[VkImageTilingControlCreateInfoEXT](#VkImageTilingControlCreateInfoEXT) structure, then the `pNext`
chain **must** not include a
[VkImageDrmFormatModifierExplicitCreateInfoEXT](#VkImageDrmFormatModifierExplicitCreateInfoEXT) structure

* 
[](#VUID-VkImageCreateInfo-pNext-12442) VUID-VkImageCreateInfo-pNext-12442

`pNext` **must** contain at most one of the structures
[VkImageStencilUsageCreateInfo](#VkImageStencilUsageCreateInfo) and
[VkImageStencilUsage2CreateInfoKHR](#VkImageStencilUsage2CreateInfoKHR)
...
[](#VUID-VkImageCreateInfo-pNext-pNext) VUID-VkImageCreateInfo-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkBufferCollectionImageCreateInfoFUCHSIA](#VkBufferCollectionImageCreateInfoFUCHSIA), [VkDataGraphOpticalFlowImageFormatInfoARM](VK_ARM_data_graph/graphs.html#VkDataGraphOpticalFlowImageFormatInfoARM), [VkDedicatedAllocationImageCreateInfoNV](#VkDedicatedAllocationImageCreateInfoNV), [VkExportMetalObjectCreateInfoEXT](memory.html#VkExportMetalObjectCreateInfoEXT), [VkExternalFormatANDROID](#VkExternalFormatANDROID), [VkExternalFormatOHOS](#VkExternalFormatOHOS), [VkExternalFormatQNX](#VkExternalFormatQNX), [VkExternalMemoryImageCreateInfo](#VkExternalMemoryImageCreateInfo), [VkExternalMemoryImageCreateInfoNV](#VkExternalMemoryImageCreateInfoNV), [VkImageAlignmentControlCreateInfoMESA](#VkImageAlignmentControlCreateInfoMESA), [VkImageCompressionControlEXT](#VkImageCompressionControlEXT), [VkImageCreateFlags2CreateInfoKHR](#VkImageCreateFlags2CreateInfoKHR), [VkImageDrmFormatModifierExplicitCreateInfoEXT](#VkImageDrmFormatModifierExplicitCreateInfoEXT), [VkImageDrmFormatModifierListCreateInfoEXT](#VkImageDrmFormatModifierListCreateInfoEXT), [VkImageFormatListCreateInfo](#VkImageFormatListCreateInfo), [VkImageStencilUsage2CreateInfoKHR](#VkImageStencilUsage2CreateInfoKHR), [VkImageStencilUsageCreateInfo](#VkImageStencilUsageCreateInfo), [VkImageSwapchainCreateInfoKHR](#VkImageSwapchainCreateInfoKHR), [VkImageTilingControlCreateInfoEXT](#VkImageTilingControlCreateInfoEXT), [VkImageUsageFlags2CreateInfoKHR](#VkImageUsageFlags2CreateInfoKHR), [VkImportMetalIOSurfaceInfoEXT](memory.html#VkImportMetalIOSurfaceInfoEXT), [VkImportMetalTextureInfoEXT](memory.html#VkImportMetalTextureInfoEXT), [VkOpaqueCaptureDataCreateInfoEXT](#VkOpaqueCaptureDataCreateInfoEXT), [VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT), [VkOpticalFlowImageFormatInfoNV](VK_NV_optical_flow/optical_flow.html#VkOpticalFlowImageFormatInfoNV), or [VkVideoProfileListInfoKHR](videocoding.html#VkVideoProfileListInfoKHR)
...
* 
`flags` is a bitmask of [VkImageCreateFlagBits2KHR](#VkImageCreateFlagBits2KHR) specifying
...
If this structure is included in the `pNext` chain of a query structure
including [VkImageCreateFlags](#VkImageCreateFlags), the create flags of the image are
returned in `flags` of this structure, allowing additional create flags
to be queried.
The flags representable in [VkImageCreateFlags](#VkImageCreateFlags) are still returned in
the query structure in this case.
...
[](#VUID-VkImageCreateFlags2CreateInfoKHR-sType-sType) VUID-VkImageCreateFlags2CreateInfoKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_IMAGE_CREATE_FLAGS_2_CREATE_INFO_KHR](fundamentals.html#VkStructureType)

* 
[](#VUID-VkImageCreateFlags2CreateInfoKHR-flags-parameter) VUID-VkImageCreateFlags2CreateInfoKHR-flags-parameter

 `flags` **must** be a valid combination of [VkImageCreateFlagBits2KHR](#VkImageCreateFlagBits2KHR) values
...
* 
[VkFramebufferAttachmentImageInfo](renderpass.html#VkFramebufferAttachmentImageInfo)
...
* 
[VkVideoFormatPropertiesKHR](videocoding.html#VkVideoFormatPropertiesKHR)
...
* 
`usage` is a bitmask of [VkImageUsageFlagBits2KHR](#VkImageUsageFlagBits2KHR) specifying
...
If this structure is included in the `pNext` chain of a query structure
including [VkImageCreateFlags](#VkImageCreateFlags), the usage flags of the image are
returned in `flags` of this structure, allowing additional usage flags
to be queried.
The flags representable in [VkImageUsageFlags](#VkImageUsageFlags) are still returned in the
...
[](#VUID-VkImageUsageFlags2CreateInfoKHR-sType-sType) VUID-VkImageUsageFlags2CreateInfoKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_IMAGE_USAGE_FLAGS_2_CREATE_INFO_KHR](fundamentals.html#VkStructureType)

* 
[](#VUID-VkImageUsageFlags2CreateInfoKHR-usage-parameter) VUID-VkImageUsageFlags2CreateInfoKHR-usage-parameter

 `usage` **must** be a valid combination of [VkImageUsageFlagBits2KHR](#VkImageUsageFlagBits2KHR) values
...
* 
[VkPhysicalDeviceSparseImageFormatInfo2](sparsemem.html#VkPhysicalDeviceSparseImageFormatInfo2)

* 
[VkPhysicalDeviceVideoFormatInfoKHR](videocoding.html#VkPhysicalDeviceVideoFormatInfoKHR)

* 
[VkSurfaceCapabilities2KHR](VK_KHR_surface/wsi.html#VkSurfaceCapabilities2KHR)
...
* 
`stencilUsage` is a bitmask of [VkImageUsageFlagBits2KHR](#VkImageUsageFlagBits2KHR)
...
If `stencilUsage` includes
[VK_IMAGE_USAGE_2_TRANSIENT_ATTACHMENT_BIT_KHR](#VkImageUsageFlagBits2KHR), it **must** not
include bits other than
[VK_IMAGE_USAGE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR](#VkImageUsageFlagBits2KHR) or
[VK_IMAGE_USAGE_2_INPUT_ATTACHMENT_BIT_KHR](#VkImageUsageFlagBits2KHR)
...
[](#VUID-VkImageStencilUsage2CreateInfoKHR-sType-sType) VUID-VkImageStencilUsage2CreateInfoKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_2_CREATE_INFO_KHR](fundamentals.html#VkStructureType)
...
[](#VUID-VkImageStencilUsage2CreateInfoKHR-stencilUsage-parameter) VUID-VkImageStencilUsage2CreateInfoKHR-stencilUsage-parameter
 ...
 `stencilUsage` **must** be a valid combination of [VkImageUsageFlagBits2KHR](#VkImageUsageFlagBits2KHR) values
...
The choice of modifier
**can** be influenced by also including a
[VkImageTilingControlCreateInfoEXT](#VkImageTilingControlCreateInfoEXT) structure in the `pNext` chain,
but otherwise, it
...
* 
`imageTiling` is a [VkImageTilingControlEXT](#VkImageTilingControlEXT) value specifying
...
[VK_IMAGE_TILING_CONTROL_DEFAULT_EXT](#VkImageTilingControlEXT), the
[`imageTilingControl`](features.html#features-imageTilingControl) feature **must**
be enabled
...
If `VkImageTilingControlCreateInfoEXT`::`imageTiling` is not
[VK_IMAGE_TILING_CONTROL_DEFAULT_EXT](#VkImageTilingControlEXT),
[VkImageCreateInfo](#VkImageCreateInfo)::`tiling` **must** not be
...
[](#VUID-VkImageTilingControlCreateInfoEXT-sType-sType) VUID-VkImageTilingControlCreateInfoEXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_IMAGE_TILING_CONTROL_CREATE_INFO_EXT](fundamentals.html#VkStructureType)
...
[](#VUID-VkImageTilingControlCreateInfoEXT-tilingControl-parameter) VUID-VkImageTilingControlCreateInfoEXT-tilingControl-parameter
 ...
 `tilingControl` **must** be a valid [VkImageTilingControlEXT](#VkImageTilingControlEXT) value
...
Possible values of
[VkImageTilingControlCreateInfoEXT](#VkImageTilingControlCreateInfoEXT)::`imageTiling`, specifying image
...
* 
[VK_IMAGE_TILING_CONTROL_DEFAULT_EXT](#VkImageTilingControlEXT) specifies that the image
tiling arrangement balances memory size requirements and memory access
performance.
It is the same selection as with the
[VkImageTilingControlCreateInfoEXT](#VkImageTilingControlCreateInfoEXT) structure omitted from the
`pNext` chain of [VkImageCreateInfo](#VkImageCreateInfo).

* 
[VK_IMAGE_TILING_CONTROL_MIN_SIZE_EXT](#VkImageTilingControlEXT) specifies that the image
tiling arrangement minimizes memory size requirements with reduced
consideration for memory access performance.

* 
[VK_IMAGE_TILING_CONTROL_MAX_PERFORMANCE_EXT](#VkImageTilingControlEXT) specifies that the
...
[VK_IMAGE_TILING_CONTROL_MIN_SIZE_EXT](#VkImageTilingControlEXT).
However, there are no performance guarantees when using
[VK_IMAGE_TILING_CONTROL_MAX_PERFORMANCE_EXT](#VkImageTilingControlEXT) as image access times are
dependent on other variables such as the shader access pattern.

Bits which **can** be set in
[VkImageUsageFlags2CreateInfoKHR](#VkImageUsageFlags2CreateInfoKHR)::`usage`, specifying intended
...
* 
[VK_IMAGE_USAGE_2_TRANSFER_SRC_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be used as the source of a transfer command.

* 
[VK_IMAGE_USAGE_2_TRANSFER_DST_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be used as the destination of a transfer command.

* 
[VK_IMAGE_USAGE_2_SAMPLED_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image **can** be
...
[VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType), and be sampled by a
shader.

* 
[VK_IMAGE_USAGE_2_STORAGE_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image **can** be
used to create a `VkImageView` suitable for occupying a
`VkDescriptorSet` slot of type
[VK_DESCRIPTOR_TYPE_STORAGE_IMAGE](descriptors.html#VkDescriptorType).

* 
[VK_IMAGE_USAGE_2_COLOR_ATTACHMENT_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be used to create a `VkImageView` suitable for use as a color
or resolve attachment in a `VkFramebuffer`.

* 
[VK_IMAGE_USAGE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that
...
* 
[VK_IMAGE_USAGE_2_TRANSIENT_ATTACHMENT_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that
...
* 
[VK_IMAGE_USAGE_2_INPUT_ATTACHMENT_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be used to create a `VkImageView` suitable for occupying
`VkDescriptorSet` slot of type
[VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT](descriptors.html#VkDescriptorType); be read from a shader as an
input attachment; and be used as an input attachment in a framebuffer.

* 
[VK_IMAGE_USAGE_2_FRAGMENT_DENSITY_MAP_BIT_EXT](#VkImageUsageFlagBits2KHR) specifies that the
...
* 
[VK_IMAGE_USAGE_2_FRAGMENT_SHADING_RATE_ATTACHMENT_BIT_KHR](#VkImageUsageFlagBits2KHR)
...
* 
[VK_IMAGE_USAGE_2_VIDEO_DECODE_DST_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be used as a [decode output picture](videocoding.html#decode-output-picture) in a
[video decode operation](videocoding.html#video-decode-operations).

* 
[VK_IMAGE_USAGE_2_VIDEO_DECODE_SRC_BIT_KHR](#VkImageUsageFlagBits2KHR) is reserved for future
use.

* 
[VK_IMAGE_USAGE_2_VIDEO_DECODE_DPB_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
...
* 
[VK_IMAGE_USAGE_2_VIDEO_ENCODE_DST_BIT_KHR](#VkImageUsageFlagBits2KHR) is reserved for future
use.

* 
[VK_IMAGE_USAGE_2_VIDEO_ENCODE_SRC_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be used as an [encode input picture](videocoding.html#encode-input-picture) in a
[video encode operation](videocoding.html#video-encode-operations).

* 
[VK_IMAGE_USAGE_2_VIDEO_ENCODE_DPB_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be used as an output [reconstructed    picture](videocoding.html#reconstructed-picture) or an input [reference picture](videocoding.html#reference-picture) in a
[video encode operation](videocoding.html#video-encode-operations).

* 
[VK_IMAGE_USAGE_2_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT](#VkImageUsageFlagBits2KHR) specifies that
...
* 
[VK_IMAGE_USAGE_2_TILE_MEMORY_BIT_QCOM](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be bound to `VkDeviceMemory` allocated from a
[VkMemoryHeap](memory.html#VkMemoryHeap) with the [VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM](memory.html#VkMemoryHeapFlagBits)
property.

* 
[VK_IMAGE_USAGE_2_HOST_TRANSFER_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that the image
**can** be used with host copy commands and host layout transitions.

* 
[VK_IMAGE_USAGE_2_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR](#VkImageUsageFlagBits2KHR)
specifies that the image **can** be used as a
[quantization delta map](videocoding.html#encode-quantization-delta-map) in a
[video encode operation](videocoding.html#video-encode-operations).

* 
[VK_IMAGE_USAGE_2_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR](#VkImageUsageFlagBits2KHR) specifies that
the image **can** be used as an [emphasis map](videocoding.html#encode-emphasis-map) in a
[video encode operation](videocoding.html#video-encode-operations).

* 
[VK_IMAGE_USAGE_2_TENSOR_ALIASING_BIT_ARM](#VkImageUsageFlagBits2KHR) specifies that the image
...
`VkImageUsageFlags2KHR` is a bitmask type for setting a mask of zero or
more [VkImageUsageFlagBits2KHR](#VkImageUsageFlagBits2KHR).
...
* 
[VK_IMAGE_USAGE_SAMPLE_WEIGHT_BIT_QCOM](#VkImageUsageFlagBits) specifies that the image
**can** be used in [weight image sampling    operations](textures.html#textures-weightimage).

* 
[VK_IMAGE_USAGE_SAMPLE_BLOCK_MATCH_BIT_QCOM](#VkImageUsageFlagBits) specifies that the
image **can** be used in [block matching operations](textures.html#textures-blockmatch).
...
Bits which **can** be set in
[VkImageCreateFlags2CreateInfoKHR](#VkImageCreateFlags2CreateInfoKHR)::`flags`, specifying additional
parameters of an image, are:
...
* 
[VK_IMAGE_CREATE_2_SPARSE_BINDING_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that the image
will be backed using sparse memory binding.

* 
[VK_IMAGE_CREATE_2_SPARSE_RESIDENCY_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that the
image **can** be partially backed using sparse memory binding.
Images created with this flag **must** also be created with the
[VK_IMAGE_CREATE_2_SPARSE_BINDING_BIT_KHR](#VkImageCreateFlagBits2KHR) flag.

* 
[VK_IMAGE_CREATE_2_SPARSE_ALIASED_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that the image
...
* 
[VK_IMAGE_CREATE_2_MUTABLE_FORMAT_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that the image
**can** be used to create a `VkImageView` with a different format from
the image.
For [multi-planar formats](formats.html#formats-multiplanar),
[VK_IMAGE_CREATE_2_MUTABLE_FORMAT_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that a
`VkImageView` can be created of a *plane* of the image.

* 
[VK_IMAGE_CREATE_2_CUBE_COMPATIBLE_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that the image
...
* 
[VK_IMAGE_CREATE_2_2D_ARRAY_COMPATIBLE_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that the
...
* 
[VK_IMAGE_CREATE_2_2D_VIEW_COMPATIBLE_BIT_EXT](#VkImageCreateFlagBits2KHR) specifies that the
image **can** be used to create a `VkImageView` of type
[VK_IMAGE_VIEW_TYPE_2D](#VkImageViewType).

* 
[VK_IMAGE_CREATE_2_PROTECTED_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that the image is a
protected image.

* 
[VK_IMAGE_CREATE_2_SPLIT_INSTANCE_BIND_REGIONS_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies
...
* 
[VK_IMAGE_CREATE_2_BLOCK_TEXEL_VIEW_COMPATIBLE_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies
that the image having a compressed format **can** be used to create a
...
* 
[VK_IMAGE_CREATE_2_EXTENDED_USAGE_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that the image
...
* 
[VK_IMAGE_CREATE_2_DISJOINT_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that an image with a
...
* 
[VK_IMAGE_CREATE_2_ALIAS_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that two images created
...
[VkExternalMemoryImageCreateInfoNV](#VkExternalMemoryImageCreateInfoNV)
    ...
    [VK_IMAGE_CREATE_2_ALIAS_BIT_KHR](#VkImageCreateFlagBits2KHR) is set.

* 
[VK_IMAGE_CREATE_2_SAMPLE_LOCATIONS_COMPATIBLE_DEPTH_BIT_EXT](#VkImageCreateFlagBits2KHR)
...
* 
[VK_IMAGE_CREATE_2_CORNER_SAMPLED_BIT_NV](#VkImageCreateFlagBits2KHR) specifies that the image
is a [corner-sampled image](#resources-images-corner-sampled).

* 
[VK_IMAGE_CREATE_2_SUBSAMPLED_BIT_EXT](#VkImageCreateFlagBits2KHR) specifies that an image **can**
be in a subsampled format which **may** be more optimal when written as an
...
[VK_IMAGE_CREATE_2_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT](#VkImageCreateFlagBits2KHR) specifies
...
created with
[VK_IMAGE_CREATE_2_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT](#VkImageCreateFlagBits2KHR).

[VK_IMAGE_CREATE_2_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT](#VkImageCreateFlagBits2KHR)
specifies that the image **can** be used with descriptor buffers when
capturing and replaying (e.g. for trace capture and replay), see
[VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT) for more detail.

[VK_IMAGE_CREATE_2_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT](#VkImageCreateFlagBits2KHR)
...
[VK_IMAGE_CREATE_2_VIDEO_PROFILE_INDEPENDENT_BIT_KHR](#VkImageCreateFlagBits2KHR) specifies that
...
`VkImageCreateFlags2KHR` is a bitmask type for setting a mask of zero or
more [VkImageCreateFlagBits2KHR](#VkImageCreateFlagBits2KHR).
...
[VK_IMAGE_CREATE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_BIT_EXT](#VkImageCreateFlagBits)
specifies that an image **can** be used with
[multisampled rendering as a    single-sampled render pass attachment](renderpass.html#multisampled-render-to-single-sampled)

[VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR](#VkImageCreateFlagBits) specifies
that a single layer image view created from this image can be accessed
with both `Arrayed` equal to 0 and `Arrayed` equal to 1 in a
shader.
If accessed with `Arrayed` equal to 1 in a shader, and
[VkImageViewCreateInfo](#VkImageViewCreateInfo)::`viewType` is
[VK_IMAGE_VIEW_TYPE_1D](#VkImageViewType) or [VK_IMAGE_VIEW_TYPE_2D](#VkImageViewType), the image is
treated as having an array size of `1`, and
`subresourceRange.baseArrayLayer` is accessed.
If accessed with `Arrayed` equal to 0 in a shader, and
[VkImageViewCreateInfo](#VkImageViewCreateInfo)::`viewType` is
[VK_IMAGE_VIEW_TYPE_1D_ARRAY](#VkImageViewType) or [VK_IMAGE_VIEW_TYPE_2D_ARRAY](#VkImageViewType),
the descriptor is accessed as-if the view was created with
[VK_IMAGE_VIEW_TYPE_1D](#VkImageViewType) or [VK_IMAGE_VIEW_TYPE_2D](#VkImageViewType) respectively.
Cube map view aliasing is not included by this flag bit.
Also, image views created with a [multi-planar    format](formats.html#formats-multiplanar) **can** not alias like this.
...
The `initialLayout` **must** be either [VK_IMAGE_LAYOUT_UNDEFINED](#VkImageLayout),
[VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT](#VkImageLayout),
or [VK_IMAGE_LAYOUT_PREINITIALIZED](#VkImageLayout).
If it is [VK_IMAGE_LAYOUT_PREINITIALIZED](#VkImageLayout) and the image has linear
tiling, then the image data **can** be preinitialized by the host while using
this layout, and the transition away from this layout will preserve that
data.
...
* 
[VK_IMAGE_LAYOUT_PREINITIALIZED](#VkImageLayout) specifies that a linear image’s
memory is in a defined layout and **can** be populated by data, but that it
has not yet been initialized by the driver.
Image memory **cannot** be transitioned into this layout.
This layout **can** be used as the `initialLayout` member of
[VkImageCreateInfo](#VkImageCreateInfo) when `tiling` is
[VK_IMAGE_TILING_LINEAR](#VkImageTiling).
...
* 
[](#VUID-vkCreateImageView-pNext-12444) VUID-vkCreateImageView-pNext-12444

The `pNext` chain of `pCreateInfo` **must** contain at most one of
the structures [VkImageViewUsageCreateInfo](#VkImageViewUsageCreateInfo) and
[VkImageViewUsage2CreateInfoKHR](#VkImageViewUsage2CreateInfoKHR)
...
or [VkImageViewUsage2CreateInfoKHR](#VkImageViewUsage2CreateInfoKHR)
...
`subresourceRange.aspectMask` provided:
...
If `image`’s format is [multi-planar](formats.html#formats-multiplanar) and
`aspectMask` is one of [VK_IMAGE_ASPECT_PLANE_0_BIT](#VkImageAspectFlagBits),
[VK_IMAGE_ASPECT_PLANE_1_BIT](#VkImageAspectFlagBits), or [VK_IMAGE_ASPECT_PLANE_2_BIT](#VkImageAspectFlagBits), the
*view format* is the [compatible format for the plane](formats.html#formats-compatible-planes).
Otherwise the
...
flag, `format` **can** be set to a [format that is compatible](formats.html#formats-compatibility-classes) with the *view format*.
If the image was not created with [VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](#VkImageCreateFlagBits),
`format` **must** equal the *view format*.

When creating a single-plane view of a [multi-planar image](formats.html#formats-multiplanar), `width` and `height` **must** be derived from the multi-planar
...
Image views with [formats that require YCBCR conversion](formats.html#formats-requiring-sampler-ycbcr-conversion)
or [external formats](memory.html#memory-external-android-hardware-buffer-external-formats)
**must** be created with a [VkSamplerYcbcrConversionInfo](samplers.html#VkSamplerYcbcrConversionInfo) structure in the
`pNext` chain to be used with sampling.
Any image view created with a [VkSamplerYcbcrConversionInfo](samplers.html#VkSamplerYcbcrConversionInfo) structure
in the `pNext` chain **must** only be sampled using a sampler with an
identically defined [VkSamplerYcbcrConversion](samplers.html#VkSamplerYcbcrConversion).
When used in a [video coding](videocoding.html#video-coding) operation, the specified
...
[](#VUID-VkImageViewCreateInfo-usage-12488) VUID-VkImageViewCreateInfo-usage-12488

If `usage` contains
[VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT](#VkImageUsageFlagBits), then the image view’s
[format features](#resources-image-view-format-features) **must** contain
[VK_FORMAT_FEATURE_2_FRAGMENT_DENSITY_MAP_BIT_EXT](formats.html#VkFormatFeatureFlagBits2KHR)
...
[VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT](#VkImageCreateFlagBits) flag `format` **must** be
...
If the `format` of the `image` is a [    multi-planar format](formats.html#formats-multiplanar) and `subresourceRange.aspectMask` is
[VK_IMAGE_ASPECT_COLOR_BIT](#VkImageAspectFlagBits), `format` **must** be identical to the
`format` used to create `image`

[](#VUID-VkImageViewCreateInfo-format-06415) VUID-VkImageViewCreateInfo-format-06415

If the image view’s format [    requires a sampler Y′CBCR conversion](formats.html#formats-requiring-sampler-ycbcr-conversion) and `usage` contains
...
If the [    `attachmentFragmentShadingRate`](features.html#features-attachmentFragmentShadingRate) feature is not enabled, the
...
[](#VUID-VkImageViewCreateInfo-image-13357) VUID-VkImageViewCreateInfo-image-13357

If `image` was created with
[VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR](#VkImageCreateFlagBits),
`format` **must** not be a [multi-planar format](formats.html#formats-multiplanar)
...
[](#VUID-VkImageViewCreateInfo-pNext-pNext) VUID-VkImageViewCreateInfo-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkExportMetalObjectCreateInfoEXT](memory.html#VkExportMetalObjectCreateInfoEXT), [VkImageViewASTCDecodeModeEXT](#VkImageViewASTCDecodeModeEXT), [VkImageViewMinLodCreateInfoEXT](#VkImageViewMinLodCreateInfoEXT), [VkImageViewSampleWeightCreateInfoQCOM](#VkImageViewSampleWeightCreateInfoQCOM), [VkImageViewSlicedCreateInfoEXT](#VkImageViewSlicedCreateInfoEXT), [VkImageViewUsage2CreateInfoKHR](#VkImageViewUsage2CreateInfoKHR), [VkImageViewUsageCreateInfo](#VkImageViewUsageCreateInfo), [VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT), or [VkSamplerYcbcrConversionInfo](samplers.html#VkSamplerYcbcrConversionInfo)
...
[](#VUID-VkImageViewUsage2CreateInfoKHR-sType-sType) VUID-VkImageViewUsage2CreateInfoKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_2_CREATE_INFO_KHR](fundamentals.html#VkStructureType)
...
`descriptorType` **must** be [VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE](descriptors.html#VkDescriptorType),
...
is [VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType)
...
[VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType), the image that
...
If descriptorType is [VK_DESCRIPTOR_TYPE_STORAGE_IMAGE](descriptors.html#VkDescriptorType), the image
...
extension`
and micromaps for the `[VK_KHR_opacity_micromap](../appendices/extensions.html#VK_KHR_opacity_micromap) extension`
are represented by `VkAccelerationStructureKHR` handles:
...
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](#VkAccelerationStructureTypeNV),
...
* 
[](#VUID-VkAccelerationStructureCreateInfo2KHR-micromap-11609) VUID-VkAccelerationStructureCreateInfo2KHR-micromap-11609

If `type` is
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](#VkAccelerationStructureTypeNV), the
[`VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](features.html#features-micromap)
feature **must** be enabled

* 
[](#VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11610) VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11610
...
* 
[](#VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11611) VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11611
...
* 
[](#VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11673) VUID-VkAccelerationStructureCreateInfo2KHR-createFlags-11673
...
If the `pNext` chain includes a
[VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT) structure,
`createFlags` **must** contain
[VK_ACCELERATION_STRUCTURE_CREATE_DESCRIPTOR_BUFFER_CAPTURE_REPLAY_BIT_EXT](#VkAccelerationStructureCreateFlagBitsKHR)
...
[](#VUID-VkAccelerationStructureCreateInfo2KHR-pNext-pNext) VUID-VkAccelerationStructureCreateInfo2KHR-pNext-pNext
 ...
 `pNext` **must** be `NULL` or a pointer to a valid instance of [VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT)
...
This can be used at acceleration structure creation time in cases where the
actual acceleration structure type (top or bottom) is not yet known.
The actual acceleration structure type is determined when the acceleration
structure is constructed as
[VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR](#VkAccelerationStructureTypeNV) or
[VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR](#VkAccelerationStructureTypeNV).
For acceleration structures constructed by build commands, this type is
specified by the build parameters.
For acceleration structures constructed by acceleration structure copy
commands, this type is determined by the source acceleration structure or
serialized data, depending on the copy command. |
...
* 
[](#VUID-VkAccelerationStructureCreateInfoKHR-type-11600) VUID-VkAccelerationStructureCreateInfoKHR-type-11600
...
* 
[](#VUID-VkAccelerationStructureCreateInfoKHR-createFlags-11673) VUID-VkAccelerationStructureCreateInfoKHR-createFlags-11673
...
Any [VkDeviceOrHostAddressKHR](accelstructures.html#VkDeviceOrHostAddressKHR), [VkDeviceOrHostAddressConstKHR](accelstructures.html#VkDeviceOrHostAddressConstKHR), or
`VkDeviceAddress` members of `pBuildInfo` are ignored by this
...
For each element of either `pGeometries` or `ppGeometries` at a
given index, with a `geometryType` member equal to
[VK_GEOMETRY_TYPE_MICROMAP_KHR](#VkGeometryTypeNV), the sum of usage information in
either the `pUsageCounts` or `ppUsageCounts` members of the
[VkAccelerationStructureGeometryMicromapDataKHR](VK_KHR_opacity_micromap/micromaps.html#VkAccelerationStructureGeometryMicromapDataKHR) structure in its
`pNext` chain is equal to the sum of usage information in the
corresponding members of `pBuild` info.

* 
For each element of either `pGeometries` or `ppGeometries` at a
given index, with a `geometryType` member equal to
[VK_GEOMETRY_TYPE_TRIANGLES_KHR](#VkGeometryTypeNV), if the `pNext` chain contains
[VkAccelerationStructureTrianglesOpacityMicromapKHR](accelstructures.html#VkAccelerationStructureTrianglesOpacityMicromapKHR) the
corresponding member of `pBuildInfo` also contains
[VkAccelerationStructureTrianglesOpacityMicromapKHR](accelstructures.html#VkAccelerationStructureTrianglesOpacityMicromapKHR) and with an
equivalent `micromap`.
...
* 
[](#VUID-vkGetAccelerationStructureBuildSizesKHR-pMaxPrimitiveCounts-11612) VUID-vkGetAccelerationStructureBuildSizesKHR-pMaxPrimitiveCounts-11612

If `pBuildInfo->geometryCount` is not `0`
and `pBuildInfo->type` is not
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](#VkAccelerationStructureTypeNV)
, `pMaxPrimitiveCounts` **must** be a valid pointer to an array of
`pBuildInfo->geometryCount` `uint32_t` values

* 
[](#VUID-vkGetAccelerationStructureBuildSizesKHR-pMaxPrimitiveCounts-11613) VUID-vkGetAccelerationStructureBuildSizesKHR-pMaxPrimitiveCounts-11613
...
* 
[](#VUID-vkGetAccelerationStructureBuildSizesKHR-buildType-11614) VUID-vkGetAccelerationStructureBuildSizesKHR-buildType-11614

If `pBuildInfo->type` is
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](#VkAccelerationStructureTypeNV),
`buildType` **must** equal
[VK_ACCELERATION_STRUCTURE_BUILD_TYPE_DEVICE_KHR](#VkAccelerationStructureBuildTypeKHR)
...
[](#VUID-VkAccelerationStructureInfoNV-flags-parameter) VUID-VkAccelerationStructureInfoNV-flags-parameter
 ...
 `flags` **must** be a valid combination of [VkBuildAccelerationStructureFlagBitsKHR](#VkBuildAccelerationStructureFlagBitsKHR) values
...
[VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR](#VkAccelerationStructureTypeNV) is an acceleration
    ...
    time, but **must** be specified at build time as
micromap,
    top, or bottom.

* 
[VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR](#VkAccelerationStructureTypeNV) is a micromap
containing opacity information, which **can** be referenced by geometry in
bottom-level acceleration structures.
...
replay), see [VkOpaqueCaptureDescriptorDataCreateInfoEXT](descriptorbuffers.html#VkOpaqueCaptureDescriptorDataCreateInfoEXT) for more
detail.
...
* 
[VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_UPDATE_BIT_KHR](#VkBuildAccelerationStructureFlagBitsNV)
...
* 
[VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_KHR](#VkBuildAccelerationStructureFlagBitsNV)
specifies that the specified acceleration structure **may** be referenced
in an instance with
[VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR](accelstructures.html#VkGeometryInstanceFlagBitsNV) set.
...
* 
[VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](#VkBuildAccelerationStructureFlagBitsNV) specifies
that micromaps **can** be compressed with a lossy encoding as described in
[Ray Opacity Micromap](raytraversal.html#ray-opacity-micromap), which **may** support
...
* 
VK_GEOMETRY_TYPE_MICROMAP_KHR specifies a geometry type consisting of a
[micromap array](VK_KHR_opacity_micromap/micromaps.html#micromap).
...
Micromaps are represented by [VkAccelerationStructureKHR](#VkAccelerationStructureKHR) handles for
use with `[VK_KHR_opacity_micromap](../appendices/extensions.html#VK_KHR_opacity_micromap)` commands.

Micromaps are represented by `VkMicromapEXT` handles for use with
`[VK_EXT_opacity_micromap](../appendices/extensions.html#VK_EXT_opacity_micromap)` commands:
...
build or micromap copy commands such as [vkCmdBuildMicromapsEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdBuildMicromapsEXT),
[vkBuildMicromapsEXT](VK_KHR_opacity_micromap/micromaps.html#vkBuildMicromapsEXT), [vkCmdCopyMicromapEXT](VK_KHR_opacity_micromap/micromaps.html#vkCmdCopyMicromapEXT), and
[vkCopyMicromapEXT](VK_KHR_opacity_micromap/micromaps.html#vkCopyMicromapEXT).

|  | The expected usage for a trace capture/replay tool is that it will serialize
| --- | --- |
and later deserialize the micromap data using micromap copy commands.
During capture the tool will set
[VkCopyMicromapToMemoryInfoEXT](VK_KHR_opacity_micromap/micromaps.html#VkCopyMicromapToMemoryInfoEXT)::`mode` to
[VK_COPY_MICROMAP_MODE_SERIALIZE_EXT](VK_KHR_opacity_micromap/micromaps.html#VkCopyMicromapModeEXT), and during replay the tool will
set [VkCopyMemoryToMicromapInfoEXT](VK_KHR_opacity_micromap/micromaps.html#VkCopyMemoryToMicromapInfoEXT)::`mode` to
[VK_COPY_MICROMAP_MODE_DESERIALIZE_EXT](VK_KHR_opacity_micromap/micromaps.html#VkCopyMicromapModeEXT). |
...
The
[`VkPhysicalDeviceOpacityMicromapFeaturesEXT`::`micromap`](features.html#features-micromapEXT)
feature **must** be enabled
...
the
[`VkPhysicalDeviceOpacityMicromapFeaturesEXT`::`micromapCaptureReplay`](features.html#features-micromapCaptureReplayEXT)
...
[VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT](#VkBufferCreateFlagBits) flag and
[VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT](#VkBufferUsageFlagBits) to all buffers used as
storage for a micromap with
[VK_MICROMAP_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT](#VkMicromapCreateFlagBitsEXT) included in
`createFlags`.
This also means that the tool will need to add
[VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT](memory.html#VkMemoryAllocateFlagBitsKHR) to memory allocations to allow
the [VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT](#VkBufferUsageFlagBits) flag to be set where the
...
* 
[](#VUID-VkMicromapCreateInfoEXT-micromapCaptureReplay-11616) VUID-VkMicromapCreateInfoEXT-micromapCaptureReplay-11616
...
* 
[](#VUID-VkMicromapCreateInfoEXT-bufferDeviceAddressMultiDevice-11617) VUID-VkMicromapCreateInfoEXT-bufferDeviceAddressMultiDevice-11617

If `createFlags` includes
[VK_MICROMAP_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT_EXT](#VkMicromapCreateFlagBitsEXT) and
`device` was created with multiple physical devices, the
[    `bufferDeviceAddressMultiDevice`](features.html#features-bufferDeviceAddressMultiDevice) feature **must** be enabled
...
* 
`pBuildInfo` is a pointer to a [VkMicromapBuildInfoEXT](VK_KHR_opacity_micromap/micromaps.html#VkMicromapBuildInfoEXT)
...
The `dstMicromap`, `mode`, `data`, `scratchData`, and
`triangleArray` members of `pBuildInfo` are ignored by this command.

A micromap created with the `micromapSize` returned by this command
supports any build with a [VkMicromapBuildInfoEXT](VK_KHR_opacity_micromap/micromaps.html#VkMicromapBuildInfoEXT) structure subject to
...
* 
For [VkMicromapBuildInfoEXT](VK_KHR_opacity_micromap/micromaps.html#VkMicromapBuildInfoEXT):
...
specifying the [VK_BUILD_MICROMAP_MODE_BUILD_EXT](VK_KHR_opacity_micromap/micromaps.html#VkBuildMicromapModeEXT) `mode` under the
above conditions.

Valid Usage

* 
[](#VUID-vkGetMicromapBuildSizesEXT-micromap-11618) VUID-vkGetMicromapBuildSizesEXT-micromap-11618
...
If `device` was created with multiple physical devices, the
[    `bufferDeviceAddressMultiDevice`](features.html#features-bufferDeviceAddressMultiDevice) feature **must** be enabled
...
[](#VUID-vkGetMicromapBuildSizesEXT-pBuildInfo-parameter) VUID-vkGetMicromapBuildSizesEXT-pBuildInfo-parameter
 ...
 `pBuildInfo` **must** be a valid pointer to a valid [VkMicromapBuildInfoEXT](VK_KHR_opacity_micromap/micromaps.html#VkMicromapBuildInfoEXT) structure
...
by value into the acceleration structure, and the micromap **can** be
...
* 
[](#VUID-vkDestroyMicromapEXT-micromap-11619) VUID-vkDestroyMicromapEXT-micromap-11619
...
in the [VkImageCreateInfo](#VkImageCreateInfo) structure
, and the `imageTiling` member of the
[VkImageTilingControlCreateInfoEXT](#VkImageTilingControlCreateInfoEXT) structure if in the `pNext`
chain,
passed to [vkCreateImage](#vkCreateImage).
...
* 
[](#VUID-VkDeviceImageMemoryRequirements-pCreateInfo-12489) VUID-VkDeviceImageMemoryRequirements-pCreateInfo-12489

`pCreateInfo->tiling` **must** not be
[VK_IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT](#VkImageTiling).
...
* 
[](#VUID-VkDeviceImageMemoryRequirements-planeAspect-12399) VUID-VkDeviceImageMemoryRequirements-planeAspect-12399

If `planeAspect` is not 0,
`pCreateInfo->tiling` is not
[VK_IMAGE_TILING_DRM_FORMAT_MODIFIER_EXT](#VkImageTiling),
and `pCreateInfo->flags` does not have
[VK_IMAGE_CREATE_DISJOINT_BIT](#VkImageCreateFlagBits) set, `planeAspect` must be a
valid [VkImageAspectFlagBits](#VkImageAspectFlagBits) value
...
* 
`requiresDedicatedAllocation` will be [VK_TRUE](fundamentals.html#VK_TRUE) if the
[VkTensorDescriptionARM](#VkTensorDescriptionARM)::`tiling` provided via the
[VkTensorCreateInfoARM](#VkTensorCreateInfoARM) structure for the call to
[vkCreateTensorARM](#vkCreateTensorARM) used to create the tensor being queried was
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM](#VkTensorTilingARM).
...
* 
[](#VUID-VkTensorCreateInfoARM-maintenance11-13358) VUID-VkTensorCreateInfoARM-maintenance11-13358
...
[](#VUID-VkTensorCreateInfoARM-pNext-09833) VUID-VkTensorCreateInfoARM-pNext-09833

If a [VkTensorRollingBackingCreateInfoARM](#VkTensorRollingBackingCreateInfoARM) structure is present in
the `pNext` chain of [VkTensorCreateInfoARM](#VkTensorCreateInfoARM), then
`pDescription->tiling` **must** be [VK_TENSOR_TILING_LINEAR_ARM](#VkTensorTilingARM),
[VK_TENSOR_TILING_BRICK_16_WIDE_ARM](#VkTensorTilingARM),
[VK_TENSOR_TILING_BRICK_8_WIDE_ARM](#VkTensorTilingARM), or
[VK_TENSOR_TILING_BRICK_4_WIDE_ARM](#VkTensorTilingARM)

[](#VUID-VkTensorCreateInfoARM-pNext-09834) VUID-VkTensorCreateInfoARM-pNext-09834

If a [VkTensorRollingBackingCreateInfoARM](#VkTensorRollingBackingCreateInfoARM) structure is present in
the `pNext` chain of [VkTensorCreateInfoARM](#VkTensorCreateInfoARM), then
`pDescription->dimensionCount` **must** be less than or equal to `4`
...
a [VkTensorRollingBackingCreateInfoARM](#VkTensorRollingBackingCreateInfoARM) structure to the `pNext`
chain of the [VkTensorCreateInfoARM](#VkTensorCreateInfoARM) structure.

The [VkTensorRollingBackingCreateInfoARM](#VkTensorRollingBackingCreateInfoARM) structure is defined as:
...
[VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM](#VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM) 32-bit
...
[VkTensorRollingBackingCreateInfoARM](#VkTensorRollingBackingCreateInfoARM), these latter values are defined
once in this inset.
...
If [VkTensorDescriptionARM](#VkTensorDescriptionARM)::`tiling` is
[VK_TENSOR_TILING_BRICK_16_WIDE_ARM](#VkTensorTilingARM), then
`brickOuterSize` = 16.

* 
If [VkTensorDescriptionARM](#VkTensorDescriptionARM)::`tiling` is
[VK_TENSOR_TILING_BRICK_8_WIDE_ARM](#VkTensorTilingARM), then `brickOuterSize`
= 8.

* 
If [VkTensorDescriptionARM](#VkTensorDescriptionARM)::`tiling` is
[VK_TENSOR_TILING_BRICK_4_WIDE_ARM](#VkTensorTilingARM), then `brickOuterSize`
= 4.
...
[VkTensorDescriptionARM](#VkTensorDescriptionARM)::`pDimensions`[i]
...
[VkTensorDescriptionARM](#VkTensorDescriptionARM)::`pDimensions`[i] or **must** be less than
2^16
...
[VkTensorDescriptionARM](#VkTensorDescriptionARM)::`pDimensions`[i] and one element
...
If [VkTensorDescriptionARM](#VkTensorDescriptionARM)::`dimensionCount` is greater than 1,
then `wraps`[`dimensionCount` - 2] **must** be a multiple of
`brickOuterSize` or **must** be equal to
[VkTensorDescriptionARM](#VkTensorDescriptionARM)::`pDimensions`[`dimensionCount` -
2]
...
[](#VUID-VkTensorRollingBackingCreateInfoARM-sType-sType) VUID-VkTensorRollingBackingCreateInfoARM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_TENSOR_ROLLING_BACKING_CREATE_INFO_ARM](fundamentals.html#VkStructureType)
...
[VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM](#VK_MAX_TENSOR_CREATE_INFO_ROLLING_BACKING_WRAP_COUNT_ARM) is the
maximum number of tensor rolling backing wraps.
...
* 
[](#VUID-VkTensorDescriptionARM-tiling-09842) VUID-VkTensorDescriptionARM-tiling-09842

If `tiling` is [VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM](#VkTensorTilingARM) or
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM](#VkTensorTilingARM) then
`pDimensions`[`dimensionCount`-1] **must** be less than or equal to
`4`

* 
[](#VUID-VkTensorDescriptionARM-tiling-09843) VUID-VkTensorDescriptionARM-tiling-09843

If `tiling` is [VK_TENSOR_TILING_BRICK_16_WIDE_ARM](#VkTensorTilingARM),
[VK_TENSOR_TILING_BRICK_8_WIDE_ARM](#VkTensorTilingARM),
[VK_TENSOR_TILING_BRICK_4_WIDE_ARM](#VkTensorTilingARM),
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM](#VkTensorTilingARM), or
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM](#VkTensorTilingARM), then `pStrides`
**must** be `NULL`
...
`VkDescriptorSet` slot of type [VK_DESCRIPTOR_TYPE_TENSOR_ARM](descriptors.html#VkDescriptorType)
...
* 
[VK_TENSOR_TILING_BRICK_16_WIDE_ARM](#VkTensorTilingARM) specifies that the data is laid
out in 64-byte blocks of 16 x N elements where N depends on
the size of the elements in the tensor.

* 
[VK_TENSOR_TILING_BRICK_8_WIDE_ARM](#VkTensorTilingARM) specifies that the data is laid
out in 64-byte blocks of 8 x N elements where N depends on
the size of the elements in the tensor.

* 
[VK_TENSOR_TILING_BRICK_4_WIDE_ARM](#VkTensorTilingARM) specifies that the data is laid
out in 64-byte blocks of 4 x N elements where N depends on
the size of the elements in the tensor.

* 
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM](#VkTensorTilingARM) specifies that the data
is laid out using blocks of size 16 x 16 x C where C is the
size of the tensor along the innermost dimension.

* 
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM](#VkTensorTilingARM) specifies that the
...
* 
If the view’s tensor was created with
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM](#VkTensorTilingARM), then the tensor view’s
set of *format features* is the value of
[VkTensorExplicitTilingFormatPropertiesARM](formats.html#VkTensorExplicitTilingFormatPropertiesARM)::`blockUTilingTensorFeatures`
found by calling [vkGetPhysicalDeviceFormatProperties2](formats.html#vkGetPhysicalDeviceFormatProperties2) on the same
`format` as [VkTensorViewCreateInfoARM](#VkTensorViewCreateInfoARM)::`format`.

* 
If the view’s tensor was created with
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM](#VkTensorTilingARM), then the tensor
view’s set of *format features* is the value of
[VkTensorExplicitTilingFormatPropertiesARM](formats.html#VkTensorExplicitTilingFormatPropertiesARM)::`blockU64kTilingTensorFeatures`
found by calling [vkGetPhysicalDeviceFormatProperties2](formats.html#vkGetPhysicalDeviceFormatProperties2) on the same
`format` as [VkTensorViewCreateInfoARM](#VkTensorViewCreateInfoARM)::`format`.

* 
If the view’s tensor was created with
[VK_TENSOR_TILING_BRICK_4_WIDE_ARM](#VkTensorTilingARM), then the tensor view’s set of
*format features* is the value of
[VkTensorExplicitTilingFormatPropertiesARM](formats.html#VkTensorExplicitTilingFormatPropertiesARM)::`brick4TilingTensorFeatures`
found by calling [vkGetPhysicalDeviceFormatProperties2](formats.html#vkGetPhysicalDeviceFormatProperties2) on the same
`format` as [VkTensorViewCreateInfoARM](#VkTensorViewCreateInfoARM)::`format`.

* 
If the view’s tensor was created with
[VK_TENSOR_TILING_BRICK_8_WIDE_ARM](#VkTensorTilingARM), then the tensor view’s set of
*format features* is the value of
[VkTensorExplicitTilingFormatPropertiesARM](formats.html#VkTensorExplicitTilingFormatPropertiesARM)::`brick8TilingTensorFeatures`
found by calling [vkGetPhysicalDeviceFormatProperties2](formats.html#vkGetPhysicalDeviceFormatProperties2) on the same
`format` as [VkTensorViewCreateInfoARM](#VkTensorViewCreateInfoARM)::`format`.

* 
If the view’s tensor was created with
[VK_TENSOR_TILING_BRICK_16_WIDE_ARM](#VkTensorTilingARM), then the tensor view’s set of
*format features* is the value of
[VkTensorExplicitTilingFormatPropertiesARM](formats.html#VkTensorExplicitTilingFormatPropertiesARM)::`brick16TilingTensorFeatures`
found by calling [vkGetPhysicalDeviceFormatProperties2](formats.html#vkGetPhysicalDeviceFormatProperties2) on the same
`format` as [VkTensorViewCreateInfoARM](#VkTensorViewCreateInfoARM)::`format`.

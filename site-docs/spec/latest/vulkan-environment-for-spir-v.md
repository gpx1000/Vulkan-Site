...
- [Correct Result](#spirvenv-correct-result)
- [Correctly Rounded](#spirvenv-correctly-rounded)
- [Correctly Rounded with Implementation-Defined Rounding Mode](#spirvenv-correctly-rounded-impl-defined)
- [Correctly_Rounded_with_Implementation-Defined_Rounding_Mode](#spirvenv-correctly-rounded-impl-defined)
- [ULP](#spirvenv-ulp)
- [Inherited From …​](#spirvenv-inherited-from)
- [Inherited_From_…​](#spirvenv-inherited-from)
...
                [`VkPhysicalDeviceImageProcessing3FeaturesQCOM`::`imageGatherLinear`](../chapters/features.html#features-imageGatherLinear) |
| `ImageGatherExtendedModesQCOM`

                [`VkPhysicalDeviceImageProcessing3FeaturesQCOM`::`imageGatherExtendedModes`](../chapters/features.html#features-imageGatherExtendedModes) |
| `MeshShadingEXT`
...
                [`VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](../chapters/features.html#features-micromap) |
...
                [`VkPhysicalDeviceCooperativeMatrixDecodeVectorFeaturesNV`::`cooperativeMatrixDecodeVector`](../chapters/features.html#features-cooperativeMatrixDecodeVector) |
...
                [`VkPhysicalDeviceShaderSplitBarrierFeaturesEXT`::`shaderSplitBarrier`](../chapters/features.html#features-shaderSplitBarrier) |
| `MultipleWaitQueuesQCOM`

                [`VkPhysicalDeviceShaderMultipleWaitQueuesFeaturesQCOM`::`shaderMultipleWaitQueues`](../chapters/features.html#features-shaderMultipleWaitQueues) |
| `TensorsARM`
...
                [`VkPhysicalDeviceShaderOCPMicroscalingTypesFeaturesEXT`::`shaderFloat4`](../chapters/features.html#features-shaderFloat4) |
| `Float6EXT`

                [`VkPhysicalDeviceShaderOCPMicroscalingTypesFeaturesEXT`::`shaderFloat6`](../chapters/features.html#features-shaderFloat6) |
| `Float8UnsignedE8M0EXT`

                [`VkPhysicalDeviceShaderOCPMicroscalingTypesFeaturesEXT`::`shaderFloat8UnsignedE8M0`](../chapters/features.html#features-shaderFloat8UnsignedE8M0) |
| `MXInt8EXT`

                [`VkPhysicalDeviceShaderOCPMicroscalingTypesFeaturesEXT`::`shaderMXInt8`](../chapters/features.html#features-shaderMXInt8) |
| `BitcastExtractEXT`
...
                [`VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT`::`cooperativeMatrixReductions`](../chapters/features.html#features-cooperativeMatrixReductionsEXT) |
| `CooperativeMatrixConversionsEXT`

                [`VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT`::`cooperativeMatrixConversions`](../chapters/features.html#features-cooperativeMatrixConversionsEXT) |
| `CooperativeMatrixPerElementOperationsEXT`

                [`VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT`::`cooperativeMatrixPerElementOperations`](../chapters/features.html#features-cooperativeMatrixPerElementOperationsEXT) |
| `CooperativeMatrixGetCoordinateEXT`

                [`VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT`::`cooperativeMatrixGetCoordinate`](../chapters/features.html#features-cooperativeMatrixGetCoordinateEXT) |
...
                `[VK_QCOM_image_processing3](extensions.html#VK_QCOM_image_processing3)` |
...
                `[VK_QCOM_shader_multiple_wait_queues](extensions.html#VK_QCOM_shader_multiple_wait_queues)` |
| `SPV_EXT_mesh_shader`
...
                `[VK_KHR_opacity_micromap](extensions.html#VK_KHR_opacity_micromap)` |
| `SPV_KHR_opacity_micromap`

                `[VK_KHR_opacity_micromap](extensions.html#VK_KHR_opacity_micromap)` |
| `SPV_EXT_split_barrier`

                `[VK_EXT_shader_split_barrier](extensions.html#VK_EXT_shader_split_barrier)` |
...
                `[VK_NV_cooperative_matrix_decode_vector](extensions.html#VK_NV_cooperative_matrix_decode_vector)` |
...
                `[VK_EXT_shader_ocp_microscaling_types](extensions.html#VK_EXT_shader_ocp_microscaling_types)` |
| `SPV_EXT_cooperative_matrix_maintenance1`

                `[VK_EXT_cooperative_matrix_maintenance1](extensions.html#VK_EXT_cooperative_matrix_maintenance1)` |
...
* 
[](#VUID-StandaloneSpirv-MemorySemantics-13551) VUID-StandaloneSpirv-MemorySemantics-13551

`MemorySemantics` with `Volatile` bit set **must** not be used with
barrier instructions (`OpControlBarrier`,
`OpControlBarrierArriveEXT`, `OpControlBarrierWaitEXT`,
or `OpMemoryBarrier`)
...
[](#VUID-StandaloneSpirv-OpImageGather-04664) VUID-StandaloneSpirv-OpImageGather-04664
    ...
    The “Component” operand of `OpImageGather`,
`OpImageGatherQCOM`,
    and `OpImageSparseGather` **must** be the  of a constant instruction
...
[](#VUID-StandaloneSpirv-SplitBarrierEXT-13552) VUID-StandaloneSpirv-SplitBarrierEXT-13552

The `SplitBarrierEXT` capability **must** not be enabled in any stage
other than compute

[](#VUID-StandaloneSpirv-OpControlBarrierArriveEXT-13553) VUID-StandaloneSpirv-OpControlBarrierArriveEXT-13553

The execution Scope for `OpControlBarrierArriveEXT` and
`OpControlBarrierWaitEXT` **must** be `Workgroup` or `Subgroup`

[](#VUID-StandaloneSpirv-MemorySemantics-13556) VUID-StandaloneSpirv-MemorySemantics-13556

The `MemorySemantics` for `OpControlBarrierArriveEXT` **must** not
have any non-relaxed memory order set other than `Release`

[](#VUID-StandaloneSpirv-MemorySemantics-13557) VUID-StandaloneSpirv-MemorySemantics-13557

The `MemorySemantics` for `OpControlBarrierWaitEXT` **must** not have
any non-relaxed memory order set other than `Acquire`
...
`Offset` **must** also be decorated with `XfbBuffer` and
...
`Uniform` `Storage` `Class` **must** be decorated with either
`DescriptorSet` and `Binding`, or `BuiltIn` with
`SamplerHeapEXT` or `ResourceHeapEXT`
...
[](#VUID-StandaloneSpirv-MaximallyReconvergesKHR-09565) VUID-StandaloneSpirv-MaximallyReconvergesKHR-09565

The `MaximallyReconvergesKHR` `Execution` `Mode` **must** not be applied to
an entry point if an *invocation repack instruction* is statically used
...
[](#VUID-StandaloneSpirv-OpUndef-12464) VUID-StandaloneSpirv-OpUndef-12464

Any `OpUndef` instruction **must** not have a `Result` `Type` of
`OpTypeImage`, `OpTypeSampler`, `OpTypeSampledImage`,
`OpTypeAccelerationStructureKHR`, or `OpTypeTensorARM`

[](#VUID-StandaloneSpirv-OpConvertFToU-12465) VUID-StandaloneSpirv-OpConvertFToU-12465

Floating-point objects consumed or produced by `OpConvertFToU`,
`OpConvertFToS`, `OpConvertSToF`, or `OpConvertUToF` **must** not
have a `Float6E2M3EXT`, `Float6E3M2EXT`, `Float4E2M1EXT`,
`Float8UnsignedE8M0EXT`, or `MXInt8EXT` encoding

[](#VUID-StandaloneSpirv-OpFConvert-12466) VUID-StandaloneSpirv-OpFConvert-12466

Floating-point objects produced by `OpFConvert` **must** not have a
`Float6E2M3EXT`, `Float6E3M2EXT`, `Float4E2M1EXT`,
`Float8UnsignedE8M0EXT`, or `MXInt8EXT` encoding

[](#VUID-StandaloneSpirv-OpFConvert-12467) VUID-StandaloneSpirv-OpFConvert-12467

If the object consumed by `OpFConvert` has a `Float6E2M3EXT`,
`Float6E3M2EXT`, `Float4E2M1EXT`, `Float8UnsignedE8M0EXT`, or
`MXInt8EXT` encoding, then the `Result` `Type` **must** have an
[IEEE 754](../chapters/introduction.html#ieee-754), `Float8E4M3EXT`, `Float8E5M2EXT`, or
`BFloat16KHR` encoding

[](#VUID-StandaloneSpirv-Result-12468) VUID-StandaloneSpirv-Result-12468

The `Result` `Type` operand of `OpBitcastExtractEXT` **must** be
`OpTypeFloat` with a `Float6E2M3EXT`, `Float6E3M2EXT`, or
`Float4E2M1EXT` encoding

[](#VUID-StandaloneSpirv-Base-12469) VUID-StandaloneSpirv-Base-12469

The `Base` operand of `OpBitcastExtractEXT` **must** be a scalar or
vector integer type
...
if the [](../chapters/features.html#features-cooperativeMatrixProperties2EXT)[VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT](../chapters/features.html#VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT)::`cooperativeMatrixProperties2`
...
[](#VUID-RuntimeSpirv-cooperativeMatrixProperties2-13382) VUID-RuntimeSpirv-cooperativeMatrixProperties2-13382

For `OpTypeCooperativeMatrixKHR`, if the
[](../chapters/features.html#features-cooperativeMatrixProperties2EXT)[VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT](../chapters/features.html#VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT)::`cooperativeMatrixProperties2`
feature is enabled, the component type, scope, number of rows, and
number of columns **must** match either one of the matrices in one of the
supported [VkCooperativeMatrixPropertiesKHR](../chapters/shaders.html#VkCooperativeMatrixPropertiesKHR) as described above, or
one of the supported [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT) returned by
a query with [VkPhysicalDeviceCooperativeMatrixInfo2EXT](../chapters/shaders.html#VkPhysicalDeviceCooperativeMatrixInfo2EXT) specifying
the type’s scope and the shader’s subgroup size and number of
invocations where applicable, where

* 
for `MatrixA`, the number of rows **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`MGranularity` and the
number of columns **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`KGranularity` and the
type **must** match [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`AType`

* 
for `MatrixB`, the number of rows **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`KGranularity` and the
number of columns **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`NGranularity` and the
type **must** match [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`BType`
...
number of columns **must** be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`NGranularity` and the
type **must** match [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`CType`
or [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`ResultType`
...
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](../chapters/shaders.html#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`invocations`

* 
if the shader was created with
...
or [VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT](../chapters/shaders.html#VkShaderCreateFlagBitsEXT)
set, or if the SPIR-V module is version 1.6 or later and no structure
specifying a required subgroup size was chained,
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](../chapters/shaders.html#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`subgroupSize`
**must** be `0`

* 
if a structure specifying a required subgroup size was chained, or if
the SPIR-V module is less than version 1.6 and the shader was not
created with
[VK_PIPELINE_SHADER_STAGE_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT](../chapters/pipelines.html#VkPipelineShaderStageCreateFlagBits)
or [VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT](../chapters/shaders.html#VkShaderCreateFlagBitsEXT)
set,
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](../chapters/shaders.html#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`subgroupSize`
**must** equal the shader’s effective subgroup size

* 

if the [     `cooperativeMatrixFlexibleDimensions`](../chapters/features.html#features-cooperativeMatrixFlexibleDimensions) feature is not enabled, the
dimensions **must** match the granularities exactly

[](#VUID-RuntimeSpirv-cooperativeMatrixProperties2-13383) VUID-RuntimeSpirv-cooperativeMatrixProperties2-13383

For `OpCooperativeMatrixMulAddKHR`, if the
[](../chapters/features.html#features-cooperativeMatrixProperties2EXT)[VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT](../chapters/features.html#VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT)::`cooperativeMatrixProperties2`
feature is enabled, the operands **must** match either one of the supported
[VkCooperativeMatrixPropertiesKHR](../chapters/shaders.html#VkCooperativeMatrixPropertiesKHR) as described above, or one of the
supported [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT) returned by a query
with [VkPhysicalDeviceCooperativeMatrixInfo2EXT](../chapters/shaders.html#VkPhysicalDeviceCooperativeMatrixInfo2EXT) specifying the
type’s scope and the shader’s subgroup size and number of invocations
where applicable, where

* 
The type of `A` **must** have `Rows` be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`MGranularity`,
`Columns` be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`KGranularity`, `Use`
be `MatrixAKHR`, and `ComponentType` match
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`AType`

* 
The type of `B` **must** have `Rows` be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`KGranularity`,
`Columns` be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`NGranularity`, `Use`
be `MatrixBKHR`, and `ComponentType` match
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`BType`
...
`Columns` be a multiple of
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`NGranularity`, `Use`
be `MatrixAccumulatorKHR`, and `ComponentType` match
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`CType`
...
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`NGranularity`, `Use`
be `MatrixAccumulatorKHR`, and `ComponentType` match
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`ResultType`

* 
If and only if [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`AType` is
a signed integer type, `MatrixASignedComponents` **must** be used

* 
If and only if [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`BType` is
a signed integer type, `MatrixBSignedComponents` **must** be used

* 
If and only if [VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`CType` is
a signed integer type, `MatrixCSignedComponents` **must** be used

* 
If and only if
[VkCooperativeMatrixProperties2EXT](../chapters/shaders.html#VkCooperativeMatrixProperties2EXT)::`ResultType` is a signed
integer type, `MatrixResultSignedComponents` **must** be used

* 
If and only if
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](../chapters/shaders.html#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`flags` contains
[VK_COOPERATIVE_MATRIX_SATURATING_ACCUMULATION_BIT_EXT](../chapters/shaders.html#VkCooperativeMatrixFlagBitsEXT),
`SaturatingAccumulationKHR` **must** be used

* 
The scope of all cooperative matrix operands **must** match
[VkPhysicalDeviceCooperativeMatrixInfo2EXT](../chapters/shaders.html#VkPhysicalDeviceCooperativeMatrixInfo2EXT)::`scope`
...
[](#VUID-RuntimeSpirv-OpCooperativeMatrixLoadTensorNV-12429) VUID-RuntimeSpirv-OpCooperativeMatrixLoadTensorNV-12429

For each `OpCooperativeMatrixLoadTensorNV` instruction that includes
**DecodeVectorFunc** in **Tensor Addressing Operands**, the tensor block
size in the innermost dimension **must** be a multiple of the number of
components of the **DecodeVectorFunc** function’s return type.
...
[](#VUID-RuntimeSpirv-RayTracingOpacityMicromapKHR-11542) VUID-RuntimeSpirv-RayTracingOpacityMicromapKHR-11542

If the `RayTracingOpacityMicromapKHR` capability is not enabled, any
`Rayflags` operand provided to an instruction **must** not contain
`ForceOpacityMicromap2StateKHR`

[](#VUID-RuntimeSpirv-micromap-11630) VUID-RuntimeSpirv-micromap-11630

If the `OpacityMicromapIdKHR` execution mode is specified with its
specialization constant operand equal to [VK_TRUE](../chapters/fundamentals.html#VK_TRUE), the pipeline
**must** not have been created with
[VK_PIPELINE_CREATE_2_DISALLOW_OPACITY_MICROMAP_BIT_ARM](../chapters/pipelines.html#VkPipelineCreateFlagBits2KHR)
...
`OpTraceRayMotionNV`,
`OpHitObjectTraceRayNV`, `OpHitObjectExecuteShaderNV`,
`OpHitObjectTraceRayMotionNV`,
`OpHitObjectTraceRayEXT`, `OpHitObjectTraceReorderExecuteEXT`, `OpHitObjectExecuteShaderEXT`, `OpHitObjectReorderExecuteShaderEXT`,
`OpHitObjectTraceRayMotionEXT`, `OpHitObjectTraceMotionReorderExecuteEXT`,
or
    `OpTraceRayKHR` instructions that declare a variable in the
    `RayPayloadKHR` `Storage` `Class`, all shaders which may be invoked as
    part of that *shader call* **must** declare an identical variable in the
...
[](#VUID-RuntimeSpirv-OpImage-06376) VUID-RuntimeSpirv-OpImage-06376
    ...
    If an `OpImage*Gather`
or `OpImageGatherQCOM`
    operation has an image operand of `Offset`, `ConstOffset`, or
    `ConstOffsets` the offset value **must** be greater than or equal to
    [`minTexelGatherOffset`](../chapters/limits.html#limits-minTexelGatherOffset)
...
or `OpImageGatherQCOM`
    operation has an image operand of `Offset`, `ConstOffset`, or
    `ConstOffsets` the offset value **must** be less than or equal to
    [`maxTexelGatherOffset`](../chapters/limits.html#limits-maxTexelGatherOffset)
...
`target` `sampled` `image` **must** have been created using a
sampler object that included
...
[](#VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13558) VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13558

If a `OpControlBarrierArriveEXT` or `OpControlBarrierWaitEXT`
instruction is executed with an execution scope equal to `Workgroup`,
its execution **must** be inside *uniform control flow* within the
invocation group

[](#VUID-RuntimeSpirv-OpControlBarrierWaitEXT-13559) VUID-RuntimeSpirv-OpControlBarrierWaitEXT-13559

If a `OpControlBarrierWaitEXT` instruction is executed, a
`OpControlBarrierArriveEXT` instruction with the same execution scope
**must** have been executed previously

[](#VUID-RuntimeSpirv-OpControlBarrierWaitEXT-13560) VUID-RuntimeSpirv-OpControlBarrierWaitEXT-13560

If a `OpControlBarrierWaitEXT` instruction is executed, another
`OpControlBarrierWaitEXT` instruction with the same execution scope
**must** not have been previously executed prior to the last executed
`OpControlBarrierArriveEXT` instruction with the same execution scope

[](#VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13561) VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13561

If a `OpControlBarrierArriveEXT` instruction is executed, another
`OpControlBarrierArriveEXT` instruction with the same execution scope
**must** not have been previously executed unless a
`OpControlBarrierWaitEXT` instruction with the same execution scope
has been executed after it

[](#VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13562) VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13562

If the module uses `OpControlBarrierArriveEXT` or
`OpControlBarrierWaitEXT`, the sum of size in bytes for variables and
[padding](../chapters/shaders.html#workgroup-padding) in the `Workgroup` `Storage` `Class` in
the `GLCompute` `Execution` `Model` **must** be less than or equal to
[`maxComputeSharedMemorySize`](../chapters/limits.html#limits-maxComputeSharedMemorySize)
minus
[`splitBarrierReservedSharedMemory`](../chapters/limits.html#limits-splitBarrierReservedSharedMemory)

[](#VUID-RuntimeSpirv-maxShaderWaitQueues-12426) VUID-RuntimeSpirv-maxShaderWaitQueues-12426

The literal operand of the `MultipleWaitQueuesQCOM` Loop Control
**must** be less than or equal to
[VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM](../chapters/limits.html#VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM)::`maxShaderWaitQueues`
...
[Image Format and Type Matching Between    SPIR-V Image Formats and Vulkan Formats](#spirvenv-format-type-matching)
...
[](#VUID-RuntimeSpirv-maxPushDataSize-12455) VUID-RuntimeSpirv-maxPushDataSize-12455

The size of the `PushConstant` `Storage` `Class` block **must** be less
than or equal to [`maxPushDataSize`](../chapters/limits.html#limits-maxPushDataSize)
...
`Execution` `Mode` then for the affected instructions the denormalized
result and any denormalized operands **must** be preserved.
Denormalized values obtained via unpacking an integer into a vector of
values with smaller bit width and interpreting those values as
...
|  | The interpretation of objects with a `OpTypeFloat` type with
| --- | --- |
`MXInt8EXT` encoding that have the bit pattern 0x80 is **undefined**. |
...
| `OpTypeInt 8 0` | [VK_FORMAT_R8_UINT](../chapters/formats.html#VkFormat), [VK_FORMAT_R8_SINT](../chapters/formats.html#VkFormat) |
| `OpTypeInt 8 1` | [VK_FORMAT_R8_SINT](../chapters/formats.html#VkFormat) |
| `OpTypeInt 16 0` | [VK_FORMAT_R16_UINT](../chapters/formats.html#VkFormat), [VK_FORMAT_R16_SINT](../chapters/formats.html#VkFormat) |
| `OpTypeInt 16 1` | [VK_FORMAT_R16_SINT](../chapters/formats.html#VkFormat) |
| `OpTypeInt 32 0` | [VK_FORMAT_R32_UINT](../chapters/formats.html#VkFormat), [VK_FORMAT_R32_SINT](../chapters/formats.html#VkFormat) |
| `OpTypeInt 32 1` | [VK_FORMAT_R32_SINT](../chapters/formats.html#VkFormat) |
| `OpTypeInt 64 0` | [VK_FORMAT_R64_UINT](../chapters/formats.html#VkFormat), [VK_FORMAT_R64_SINT](../chapters/formats.html#VkFormat) |

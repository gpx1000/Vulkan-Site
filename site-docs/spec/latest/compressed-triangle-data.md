...
- **Component**: spec
- **Version**: latest
- **URL**: /spec/latest/chapters/VK_AMDX_dense_geometry_format/dense_geometry_format.html

## Table of Contents

- [Dense Geometry Format Version 1 (DGF1)](#dense-geometry-format)
- [Dense_Geometry_Format_Version_1_(DGF1)](#dense-geometry-format)
- [Block Layout](#_block_layout)
- [Vertex Position Encoding](#_vertex_position_encoding)
- [Vertex_Position_Encoding](#_vertex_position_encoding)
- [Handling Corner Cases](#_handling_corner_cases)
- [Handling_Corner_Cases](#_handling_corner_cases)
- [Topology Encoding](#_topology_encoding)
- [Topology Sections](#_topology_sections)
- [Primitive Index](#_primitive_index)
- [Geometry Index and Opaque Flag](#_geometry_index_and_opaque_flag)
- [Geometry_Index_and_Opaque_Flag](#_geometry_index_and_opaque_flag)
- [GeomID Palette](#_geomid_palette)
- [OMM Support](#_omm_support)
- [Opacity Micromap Palette](#_opacity_micromap_palette)
- [Opacity_Micromap_Palette](#_opacity_micromap_palette)
- [Optional UserData](#_optional_userdata)
...
![DGF block layout](../../_images/DGF_block_layout.svg)

Figure 1. DGF block layout
...
![DGF control values](../../_images/DGF_control_values.svg)

Figure 2. DGF control value behavior
...
![DGF indices](../../_images/DGF_indices.svg)

Figure 3. DGF Index buffer example

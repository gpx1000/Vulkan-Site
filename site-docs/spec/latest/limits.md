...
Descriptors with a type of [VK_DESCRIPTOR_TYPE_SAMPLER](descriptors.html#VkDescriptorType) or
[VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) count against this
limit.
...
See [Sampler](descriptors.html#descriptors-sampler) and [Combined Image Sampler](descriptors.html#descriptors-combinedimagesampler).
...
pipeline layout.
Descriptors with a type of [VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType) or
[VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC](descriptors.html#VkDescriptorType) count against this
limit.
Only descriptors in descriptor set layouts created without the
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
...
member of the `VkDescriptorSetLayoutBinding` structure has the bit
for that shader stage set.
See [Uniform Buffer](descriptors.html#descriptors-uniformbuffer) and
[Dynamic Uniform Buffer](descriptors.html#descriptors-uniformbufferdynamic).
...
pipeline layout.
Descriptors with a type of [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType) or
[VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC](descriptors.html#VkDescriptorType) count against this
limit.
Only descriptors in descriptor set layouts created without the
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
...
See [Storage Buffer](descriptors.html#descriptors-storagebuffer) and
[Dynamic Storage Buffer](descriptors.html#descriptors-storagebufferdynamic).
...
[VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER](descriptors.html#VkDescriptorType) count against this limit.
Only descriptors in descriptor set layouts created without the
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
A descriptor is accessible to a pipeline shader stage when the
`stageFlags` member of the `VkDescriptorSetLayoutBinding`
structure has the bit for that shader stage set.
See [Combined Image Sampler](descriptors.html#descriptors-combinedimagesampler), [Sampled Image](descriptors.html#descriptors-sampledimage),
and [Uniform Texel Buffer](descriptors.html#descriptors-uniformtexelbuffer).
...
pipeline layout.
Descriptors with a type of [VK_DESCRIPTOR_TYPE_STORAGE_IMAGE](descriptors.html#VkDescriptorType), or
[VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER](descriptors.html#VkDescriptorType) count against this limit.
Only descriptors in descriptor set layouts created without the
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
A descriptor is accessible to a pipeline shader stage when the
`stageFlags` member of the `VkDescriptorSetLayoutBinding`
structure has the bit for that shader stage set.
See [Storage Image](descriptors.html#descriptors-storageimage), and
[Storage Texel Buffer](descriptors.html#descriptors-storagetexelbuffer).
...
Descriptors with a type of [VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT](descriptors.html#VkDescriptorType)
count against this limit.
Only descriptors in descriptor set layouts created without the
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
...
See [Input Attachment](descriptors.html#descriptors-inputattachment).
...
[VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT](descriptors.html#VkDescriptorType) count against this limit.
Only descriptors in descriptor set layouts created without the
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
...
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
See [Dynamic Uniform Buffer](descriptors.html#descriptors-uniformbufferdynamic).
...
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
See [Dynamic Storage Buffer](descriptors.html#descriptors-storagebufferdynamic).
...
When a descriptor of type [VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType) or
[VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC](descriptors.html#VkDescriptorType) is updated, the
...
When a descriptor of type [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType) or
[VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC](descriptors.html#VkDescriptorType) is updated, the
`offset` **must** be an integer multiple of this limit.
...
* 
 `minTexelGatherOffset` is the
    ...
    `ConstOffsets` image operands of any of the `OpImage*Gather`
and `OpImageGatherQCOM`
    image instructions.
...
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit
set.
While an application **can** allocate dynamic uniform/storage buffer
descriptors from a pool created with the descriptors from a pool created
with [VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorPoolCreateFlagBits), and **can**
include dynamic uniform/storage buffer descriptors in descriptor set
...
[](#VUID-VkPhysicalDeviceShaderSplitBarrierPropertiesEXT-sType-sType) VUID-VkPhysicalDeviceShaderSplitBarrierPropertiesEXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SPLIT_BARRIER_PROPERTIES_EXT](fundamentals.html#VkStructureType)
...
Descriptor bindings with a descriptor type of
[VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR](descriptors.html#VkDescriptorType) count against this
limit.
Only descriptor bindings in descriptor set layouts created without the
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit set
count against this limit.
...
[VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) descriptors to be
...
indicates the size in bytes of a [VK_DESCRIPTOR_TYPE_SAMPLER](descriptors.html#VkDescriptorType)
descriptor.

* 

`combinedImageSamplerDescriptorSize` indicates the size in bytes of
a [VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) descriptor.

* 
 `sampledImageDescriptorSize`
indicates the size in bytes of a [VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE](descriptors.html#VkDescriptorType)
descriptor.

* 
 `storageImageDescriptorSize`
indicates the size in bytes of a [VK_DESCRIPTOR_TYPE_STORAGE_IMAGE](descriptors.html#VkDescriptorType)
descriptor.

* 

`uniformTexelBufferDescriptorSize` indicates the size in bytes of a
[VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER](descriptors.html#VkDescriptorType) descriptor if the
...
of a [VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER](descriptors.html#VkDescriptorType) descriptor if the
...
[VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER](descriptors.html#VkDescriptorType) descriptor if the
[`robustBufferAccess`](features.html#features-robustBufferAccess) feature is not
enabled.
...
of a [VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER](descriptors.html#VkDescriptorType) descriptor if the
[`robustBufferAccess`](features.html#features-robustBufferAccess) feature is
enabled.

* 
 `uniformBufferDescriptorSize`
indicates the size in bytes of a [VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType)
descriptor.

* 

`robustUniformBufferDescriptorSize` indicates the size in bytes of a
[VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER](descriptors.html#VkDescriptorType) descriptor if the
[`robustBufferAccess`](features.html#features-robustBufferAccess) feature is
enabled.

* 
 `storageBufferDescriptorSize`
indicates the size in bytes of a [VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType)
descriptor.

* 

`robustStorageBufferDescriptorSize` indicates the size in bytes of a
[VK_DESCRIPTOR_TYPE_STORAGE_BUFFER](descriptors.html#VkDescriptorType) descriptor if the
[`robustBufferAccess`](features.html#features-robustBufferAccess) feature is
enabled.
...
a [VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR](descriptors.html#VkDescriptorType) or
...
A descriptor binding with type [VK_DESCRIPTOR_TYPE_MUTABLE_EXT](descriptors.html#VkDescriptorType) has a
...
bytes of a [VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER](descriptors.html#VkDescriptorType) descriptor
...
[VK_DESCRIPTOR_TYPE_TENSOR_ARM](descriptors.html#VkDescriptorType) descriptor.
...
[VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT).

* 

`maxOpacity4StateSubdivisionLevel` is the maximum allowed
`subdivisionLevel` when `format` is
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT) and the micromap is not
built with [VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV).

* 

`maxOpacityLossy4StateSubdivisionLevel` is the maximum allowed
`subdivisionLevel` when `format` is
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT) and the micromap is built
with [VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR](resources.html#VkBuildAccelerationStructureFlagBitsNV).

* 
 `maxMicromapTriangles` limits the
number of triangles allowed to be specified when building a micromap
...
* 
[](#VUID-VkPhysicalDeviceOpacityMicromapPropertiesKHR-sType-sType) VUID-VkPhysicalDeviceOpacityMicromapPropertiesKHR-sType-sType

 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPACITY_MICROMAP_PROPERTIES_KHR](fundamentals.html#VkStructureType)
...
`maxOpacity4StateSubdivisionLevel` is the maximum allowed
`subdivisionLevel` when `format` is
[VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR](VK_KHR_opacity_micromap/micromaps.html#VkOpacityMicromapFormatEXT)
...
[](#VUID-VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM-sType-sType) VUID-VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MULTIPLE_WAIT_QUEUES_PROPERTIES_QCOM](fundamentals.html#VkStructureType)
...
number of instances of [VkDeviceFaultInfoKHR](debugging.html#VkDeviceFaultInfoKHR) that will be retained
...
[](#VUID-VkPhysicalDeviceFaultPropertiesKHR-sType-sType) VUID-VkPhysicalDeviceFaultPropertiesKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FAULT_PROPERTIES_KHR](fundamentals.html#VkStructureType)
...
Descriptors with a type of [VK_DESCRIPTOR_TYPE_TENSOR_ARM](descriptors.html#VkDescriptorType) count
against this limit.
...
* 
`supportedQueues` is a bitmask of [VkQueueFlagBits](devsandqueues.html#VkQueueFlagBits) indicating
the types of queues on which [setting perf    hints](devsandqueues.html#devsandqueues-perfhint) are supported.

If the [`queuePerfHint`](features.html#features-queuePerfHint) feature is supported
...
[](#VUID-VkPhysicalDeviceQueuePerfHintPropertiesQCOM-sType-sType) VUID-VkPhysicalDeviceQueuePerfHintPropertiesQCOM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_QUEUE_PERF_HINT_PROPERTIES_QCOM](fundamentals.html#VkStructureType)
...
specifies the required alignment of unformatted buffer descriptors
or acceleration structures
within a resource heap.
It must be a power-of-two value, and less than or equal to
...
It must be greater than or equal to [    maxPushConstantsSize](#limits-maxPushConstantsSize)
...
[VkGpaPerfBlockPropertiesAMD](#VkGpaPerfBlockPropertiesAMD) structures containing the available
performance blocks.
...
[vkGetPhysicalDeviceProperties2](devsandqueues.html#vkGetPhysicalDeviceProperties2) to be called twice to obtain the
...
[](#VUID-VkPhysicalDeviceGpaPropertiesAMD-sType-sType) VUID-VkPhysicalDeviceGpaPropertiesAMD-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GPA_PROPERTIES_AMD](fundamentals.html#VkStructureType)
...
* 
`blockType` is a [VkGpaPerfBlockAMD](gpa_interface.html#VkGpaPerfBlockAMD) specifying the performance
block type.
...
[](#VUID-VkGpaPerfBlockPropertiesAMD-blockType-parameter) VUID-VkGpaPerfBlockPropertiesAMD-blockType-parameter
 ...
 `blockType` **must** be a valid [VkGpaPerfBlockAMD](gpa_interface.html#VkGpaPerfBlockAMD) value
...
[](#VUID-VkPhysicalDeviceGpaProperties2AMD-sType-sType) VUID-VkPhysicalDeviceGpaProperties2AMD-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GPA_PROPERTIES_2_AMD](fundamentals.html#VkStructureType)
...
[](#VUID-VkPhysicalDeviceShaderAbortPropertiesKHR-sType-sType) VUID-VkPhysicalDeviceShaderAbortPropertiesKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ABORT_PROPERTIES_KHR](fundamentals.html#VkStructureType)
...
| `uint32_t` | `splitBarrierReservedSharedMemory` | `[shaderSplitBarrier`](features.html#features-shaderSplitBarrier) |
...
| `uint32_t` | [VkPhysicalDeviceOpacityMicromapPropertiesKHR](#VkPhysicalDeviceOpacityMicromapPropertiesKHR)::`maxOpacity2StateSubdivisionLevel` | `[VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](features.html#features-micromap) |
| `uint32_t` | `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxOpacity4StateSubdivisionLevel` | `[VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](features.html#features-micromap) |
| `uint32_t` | `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxOpacityLossy4StateSubdivisionLevel` | `[VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](features.html#features-micromap) |
| `uint64_t` | `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxMicromapTriangles` | `[VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](features.html#features-micromap) |
| `uint32_t` | [VkPhysicalDeviceOpacityMicromapPropertiesEXT](#VkPhysicalDeviceOpacityMicromapPropertiesEXT)::`maxOpacity2StateSubdivisionLevel` | `[VK_EXT_opacity_micromap](../appendices/extensions.html#VK_EXT_opacity_micromap)` |
| `uint32_t` | `VkPhysicalDeviceOpacityMicromapPropertiesEXT`::`maxOpacity4StateSubdivisionLevel` | `[VK_EXT_opacity_micromap](../appendices/extensions.html#VK_EXT_opacity_micromap)` |
...
| `VkBool32` | `cooperativeVectorTrainingFloat16Accumulation` | - |
| `VkBool32` | `cooperativeVectorTrainingFloat32Accumulation` | - |
| [VkQueueFlags](devsandqueues.html#VkQueueFlags) | [VkPhysicalDeviceQueuePerfHintPropertiesQCOM](#VkPhysicalDeviceQueuePerfHintPropertiesQCOM)::`supportedQueues` | `[queuePerfHint`](features.html#features-queuePerfHint) |
...
| `uint32_t` | `maxShaderWaitQueues` | `[shaderMultipleWaitQueues`](features.html#features-shaderMultipleWaitQueues) |
...
| `uint64_t` | `maxShaderAbortMessageSize` | [`shaderAbort`](features.html#features-shaderAbort) |
| `uint32_t` | `maxDeviceFaultCount` | `[VK_KHR_device_fault](../appendices/extensions.html#VK_KHR_device_fault)` |
| `uint32_t` | `maxTensorDimensionCount` | [`tensors`](features.html#features-tensors) |
| `uint64_t` | `maxTensorElements` | [`tensors`](features.html#features-tensors) |
| `uint64_t` | `maxPerDimensionTensorElements` | [`tensors`](features.html#features-tensors) |
| `int64_t` | `maxTensorStride` | [`tensors`](features.html#features-tensors) |
| `uint32_t` | `maxTensorShaderAccessArrayLength` | [`shaderTensorAccess`](features.html#features-shaderTensorAccess) |
| `uint32_t` | `maxTensorShaderAccessSize` | [`shaderTensorAccess`](features.html#features-shaderTensorAccess) |
| `uint32_t` | `maxDescriptorSetStorageTensors` | [`tensors`](features.html#features-tensors) |
| `uint32_t` | `maxPerStageDescriptorSetStorageTensors` | [`shaderTensorAccess`](features.html#features-shaderTensorAccess) |
| `uint32_t` | `maxDescriptorSetUpdateAfterBindStorageTensors` | [`descriptorBindingStorageTensorUpdateAfterBind`](features.html#features-descriptorBindingStorageTensorUpdateAfterBind) |
| `uint32_t` | `maxPerStageDescriptorUpdateAfterBindStorageTensors` | [`descriptorBindingStorageTensorUpdateAfterBind`](features.html#features-descriptorBindingStorageTensorUpdateAfterBind) and [`shaderTensorAccess`](features.html#features-shaderTensorAccess) |
| `VkBool32` | `shaderStorageTensorArrayNonUniformIndexingNative` | [`shaderStorageTensorArrayNonUniformIndexing`](features.html#features-shaderStorageTensorArrayNonUniformIndexing) |
| [VkShaderStageFlags](pipelines.html#VkShaderStageFlags) | `shaderTensorSupportedStages` | [`shaderTensorAccess`](features.html#features-shaderTensorAccess) |
...
| `maxPerStageDescriptorUpdateAfterBindSamplers` | - | 500000 9 | min |
| `maxPerStageDescriptorUpdateAfterBindUniformBuffers` | - | 12 9 | min |
| `maxPerStageDescriptorUpdateAfterBindStorageBuffers` | - | 500000 9 | min |
| `maxPerStageDescriptorUpdateAfterBindSampledImages` | - | 500000 9 | min |
| `maxPerStageDescriptorUpdateAfterBindStorageImages` | - | 500000 9 | min |
| `maxPerStageDescriptorUpdateAfterBindInputAttachments` | - | 4 (Vulkan Core)

                                                                     7 (Vulkan Roadmap 2022) 14 | min |
| `maxPerStageUpdateAfterBindResources` | - | 500000 | min |
| `maxDescriptorSetUpdateAfterBindSamplers` | - | 500000 9 | min |
| `maxDescriptorSetUpdateAfterBindUniformBuffers` | - | 72 8 9 | min, *n* × PerStage |
| `maxDescriptorSetUpdateAfterBindUniformBuffersDynamic` | - | 8 13 | min |
| `maxDescriptorSetUpdateAfterBindStorageBuffers` | - | 500000 9 | min |
| `maxDescriptorSetUpdateAfterBindStorageBuffersDynamic` | - | 4 13 | min |
| `maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic` | - | `maxDescriptorSetUpdateAfterBindUniformBuffersDynamic` 13 | min |
| `maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic` | - | `maxDescriptorSetUpdateAfterBindStorageBuffersDynamic` 13 | min |
| `maxDescriptorSetUpdateAfterBindTotalBuffersDynamic` | - | `maxDescriptorSetUpdateAfterBindUniformBuffersDynamic` +  `maxDescriptorSetUpdateAfterBindStorageBuffersDynamic` 13 | min |
| `maxDescriptorSetUpdateAfterBindSampledImages` | - | 500000 9 | min |
| `maxDescriptorSetUpdateAfterBindStorageImages` | - | 500000 9 | min |
| `maxDescriptorSetUpdateAfterBindInputAttachments` | - | 4 14 | min |
| `maxInlineUniformBlockSize` | - | 256 | min |
| `maxPerStageDescriptorInlineUniformBlocks` | - | 4 | min |
| `maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks` | - | 4 9 | min |
| `maxDescriptorSetInlineUniformBlocks` | - | 4 | min |
| `maxDescriptorSetUpdateAfterBindInlineUniformBlocks` | - | 4 9 | min |
...
| `splitBarrierReservedSharedMemory` | - | 8 | max |
...
| [VkPhysicalDeviceOpacityMicromapPropertiesKHR](#VkPhysicalDeviceOpacityMicromapPropertiesKHR)::`maxOpacity2StateSubdivisionLevel` | - | 3 | min |
| `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxOpacity4StateSubdivisionLevel` | - | 3 | min |
| `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxOpacityLossy4StateSubdivisionLevel` | - | 3 | min |
| `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxMicromapTriangles` | - | 227 | min |
| [VkPhysicalDeviceOpacityMicromapPropertiesEXT](#VkPhysicalDeviceOpacityMicromapPropertiesEXT)::`maxOpacity2StateSubdivisionLevel` | - | 3 | min |
| `VkPhysicalDeviceOpacityMicromapPropertiesEXT`::`maxOpacity4StateSubdivisionLevel` | - | 3 | min |
...
| [VkPhysicalDeviceQueuePerfHintPropertiesQCOM](#VkPhysicalDeviceQueuePerfHintPropertiesQCOM)::`supportedQueues` | - | [VK_QUEUE_GRAPHICS_BIT](devsandqueues.html#VkQueueFlagBits) \|

                                                                                 [VK_QUEUE_COMPUTE_BIT](devsandqueues.html#VkQueueFlagBits) | bitfield |
| `maxApronSize` | - | 1 | min |
| `preferNonCoherent` | - | - | implementation-dependent |
| `tileGranularity` | - | (16,16) | min |
| `maxTileShadingRate` | - | (8,8) | min |
| `maxShaderWaitQueues` | - | 2 | min |
| `maxTensorDimensionCount` | 0 | 4 | min |
| `maxTensorElements` | 0 | 65536 | min |
| `maxPerDimensionTensorElements` | 0 | 65536 | min |
| `maxTensorStride` | 0 | 65536 | min |
| `maxTensorSize` | 0 | 65536 | min |
| `maxTensorShaderAccessArrayLength` | 0 | 4 | min |
| `maxTensorShaderAccessSize` | 0 | 4 | min |
| `maxDescriptorSetStorageTensors` | 0 | 16 | min |
| `maxPerStageDescriptorSetStorageTensors` | 0 | 16 | min |
| `maxDescriptorSetUpdateAfterBindStorageTensors` | 0 | 500000 9 | min |
| `maxPerStageDescriptorUpdateAfterBindStorageTensors` | 0 | 500000 9 | min |
| `shaderTensorSupportedStages` | 0 | [VK_SHADER_STAGE_COMPUTE_BIT](pipelines.html#VkShaderStageFlagBits) | bitfield |
...
This `UpdateAfterBind` descriptor limit **must** be greater than or
equal to the corresponding `non`-UpdateAfterBind limit if the
corresponding `UpdateAfterBind` feature is supported.
...
This `UpdateAfterBind` descriptor limit exists and is defined to
have a non-zero supported limit for historical reasons.
As [VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorBindingFlagBitsEXT) **must** not be used
with the corresponding descriptor type, and descriptors of this type
**must** not be included in any descriptor set layout that includes
bindings created with [VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorBindingFlagBitsEXT),
the limit has no practical effect and **may** be zero.

14

As [VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorBindingFlagBitsEXT) **must** not be used
with the corresponding descriptor type, this limit only exists to allow
implementations exposing a higher limit for descriptors of this type in
a pipeline layout including any descriptor set layouts created with
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) than in
a pipeline layout not including any descriptor set layouts created with
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) and
**may** be zero to indicate that only the corresponding
`non`-UpdateAfterBind limit applies.

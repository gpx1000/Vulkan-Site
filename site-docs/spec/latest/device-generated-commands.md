...
* 
Retrieve device addresses for setting buffers on the device.
...
[Pipeline Layout Compatibility](../descriptorsets.html#descriptors-compatibility)
...
and
   ...
   [compatible](../descriptorsets.html#descriptors-compatibility) with the push constant range
...
or [VK_FORMAT_FEATURE_2_BLOCK_MATCHING_SXD_BIT_QCOM](../formats.html#VkFormatFeatureFlagBits2KHR)

* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-OpImageBlockMatchSADQCOM-12420) VUID-vkCmdExecuteGeneratedCommandsNV-OpImageBlockMatchSADQCOM-12420
...
and the
[blockMatchExtendedClampToEdge](../features.html#features-blockMatchExtendedClampToEdge)
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-OpImageBlockMatchWindow-12421) VUID-vkCmdExecuteGeneratedCommandsNV-OpImageBlockMatchWindow-12421

If a `OpImageBlockMatchWindow*QCOM` or
`OpImageBlockMatchGather*QCOM` instruction uses a [VkSampler](../samplers.html#VkSampler) as
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-addressModeU-12422) VUID-vkCmdExecuteGeneratedCommandsNV-addressModeU-12422

If a `OpImageBlockMatchWindow*QCOM` or
`OpImageBlockMatchGather*QCOM` instruction uses a [VkSampler](../samplers.html#VkSampler) as
a result of this command, and the *input* sampler was created with
either `addressModeU` or `addressModeV` equal to
[VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE](../samplers.html#VkSamplerAddressMode), then the sampler **must** have
been created with both `addressModeU` and `addressModeV` equal
to [VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE](../samplers.html#VkSamplerAddressMode)
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-micromap-11636) VUID-vkCmdExecuteGeneratedCommandsNV-micromap-11636

If an acceleration structure is accessed as a result of this command
through an `OpRayQueryProceedKHR` operation
, the `[VK_EXT_opacity_micromap](../../appendices/extensions.html#VK_EXT_opacity_micromap)` extension is not enabled,
and the acceleration structure is built using geometry with a
[VkAccelerationStructureTrianglesOpacityMicromapKHR](../accelstructures.html#VkAccelerationStructureTrianglesOpacityMicromapKHR) structure
included in its `pNext` chain, the shader **must** have specified a
`OpacityMicromapIdKHR` execution mode with its specialization
constant operand equal to [VK_TRUE](../fundamentals.html#VK_TRUE)

* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-micromap-11637) VUID-vkCmdExecuteGeneratedCommandsNV-micromap-11637
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-micromap-11638) VUID-vkCmdExecuteGeneratedCommandsNV-micromap-11638

If an acceleration structure is accessed as a result of this command and
the acceleration structure is built using geometry with an
`indexBuffer` containing both [VkOpacityMicromapSpecialIndexKHR](../accelstructures.html#VkOpacityMicromapSpecialIndexKHR)
values and indices into an associated micromap array, any
[VkPipeline](../pipelines.html#VkPipeline) bound to the pipeline bind point used by this command
**must** not have been created with `flags` that includes
[VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR](../pipelines.html#VkPipelineCreateFlagBits2KHR)

* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-micromap-11639) VUID-vkCmdExecuteGeneratedCommandsNV-micromap-11639

If an acceleration structure is accessed as a result of this command and
the acceleration structure is built using geometry with an
`indexBuffer` containing both [VkOpacityMicromapSpecialIndexKHR](../accelstructures.html#VkOpacityMicromapSpecialIndexKHR)
values and indices into an associated micromap array, any
[VkShaderEXT](../shaders.html#VkShaderEXT) that accessed the descriptor **must** not have been
created with `flags` that includes
[VK_SHADER_CREATE_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_EXT](../shaders.html#VkShaderCreateFlagBitsEXT)
...
[bound tile memory object](../memory.html#memory-bind-tile-memory) in
`commandBuffer`
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-OpTensorReadARM-12462) VUID-vkCmdExecuteGeneratedCommandsNV-OpTensorReadARM-12462

If a [VK_DESCRIPTOR_TYPE_TENSOR_ARM](../descriptors.html#VkDescriptorType) descriptor is accessed as a
result of this command, using `OpTensorReadARM` or
`OpTensorWriteARM`, and the underlying [VkTensorARM](../resources.html#VkTensorARM) object was
created with a [VK_TENSOR_TILING_BRICK_16_WIDE_ARM](../resources.html#VkTensorTilingARM),
[VK_TENSOR_TILING_BRICK_8_WIDE_ARM](../resources.html#VkTensorTilingARM),
[VK_TENSOR_TILING_BRICK_4_WIDE_ARM](../resources.html#VkTensorTilingARM),
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_ARM](../resources.html#VkTensorTilingARM), or
[VK_TENSOR_TILING_BLOCK_U_INTERLEAVED_64K_ARM](../resources.html#VkTensorTilingARM)
[VkTensorTilingARM](../resources.html#VkTensorTilingARM), and the object read or written is an array,
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-pNext-12463) VUID-vkCmdExecuteGeneratedCommandsNV-pNext-12463

If a [VK_DESCRIPTOR_TYPE_TENSOR_ARM](../descriptors.html#VkDescriptorType) descriptor is accessed as a
result of this command and the corresponding [VkTensorARM](../resources.html#VkTensorARM) object
was created with a [VkTensorRollingBackingCreateInfoARM](../resources.html#VkTensorRollingBackingCreateInfoARM) structure
in the `pNext` chain of [VkTensorCreateInfoARM](../resources.html#VkTensorCreateInfoARM), then the number
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsNV-None-12472) VUID-vkCmdExecuteGeneratedCommandsNV-None-12472
...
and it was created with a [descriptor    mapping](../descriptorheaps.html#descriptorheaps-bindings) using [VK_DESCRIPTOR_MAPPING_SOURCE_PUSH_ADDRESS_EXT](../descriptorheaps.html#VkDescriptorMappingSourceEXT),
[VK_DESCRIPTOR_MAPPING_SOURCE_SHADER_RECORD_ADDRESS_EXT](../descriptorheaps.html#VkDescriptorMappingSourceEXT),
[VK_DESCRIPTOR_MAPPING_SOURCE_INDIRECT_ADDRESS_EXT](../descriptorheaps.html#VkDescriptorMappingSourceEXT), or
[VK_DESCRIPTOR_MAPPING_SOURCE_RESOURCE_HEAP_DATA_EXT](../descriptorheaps.html#VkDescriptorMappingSourceEXT) and a shader
accesses a uniform buffer using that mapping, the address that the
...
[effective rasterization input    topology](../drawing.html#drawing-rasterization-input-topology) is in the line topology class, then [vkCmdSetLineWidth](../primsrast.html#vkCmdSetLineWidth)
...
mode, then the last call to [vkCmdSetColorBlendEnableEXT](../framebuffer.html#vkCmdSetColorBlendEnableEXT) **must** have
set the blend enable to [VK_FALSE](../fundamentals.html#VK_FALSE) prior to this drawing command
...
the current render pass instance was begun with
[vkCmdBeginRendering](../renderpass.html#vkCmdBeginRendering), and it includes a color attachment that uses
the [VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID](../renderpass.html#VkResolveModeFlagBitsKHR) resolve
mode, then the last call to [vkCmdSetRasterizationSamplesEXT](../primsrast.html#vkCmdSetRasterizationSamplesEXT) **must**
have set `rasterizationSamples` to [VK_SAMPLE_COUNT_1_BIT](../limits.html#VkSampleCountFlagBits) prior
...
[vkCmdBeginRendering](../renderpass.html#vkCmdBeginRendering), and it includes a color attachment that uses
the [VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID](../renderpass.html#VkResolveModeFlagBitsKHR) resolve
mode, then the last call to [vkCmdSetFragmentShadingRateKHR](../primsrast.html#vkCmdSetFragmentShadingRateKHR) **must**
...
[effective rasterization input    topology](../drawing.html#drawing-rasterization-input-topology) is in the line or point topology class, then the
[current value](../pipelines.html#dynamic-state-current-value) of
...
or
    ...
    and the [current value](../pipelines.html#dynamic-state-current-value) of
    `rasterizerDiscardEnable` is [VK_FALSE](../fundamentals.html#VK_FALSE), and the
    [effective rasterization input    topology](../drawing.html#drawing-rasterization-input-topology) is in the line topology class, then
...
a graphics pipeline is bound which was created with the
[VK_DYNAMIC_STATE_LINE_RASTERIZATION_MODE_EXT](../pipelines.html#VkDynamicState) dynamic state
enabled, the [effective    rasterization input topology](../drawing.html#drawing-rasterization-input-topology) is in the line topology class, and the
...
or
    ...
    **must** either include all of [VK_COLOR_COMPONENT_R_BIT](../framebuffer.html#VkColorComponentFlagBits),
    [VK_COLOR_COMPONENT_G_BIT](../framebuffer.html#VkColorComponentFlagBits), [VK_COLOR_COMPONENT_B_BIT](../framebuffer.html#VkColorComponentFlagBits), and
    [VK_COLOR_COMPONENT_A_BIT](../framebuffer.html#VkColorComponentFlagBits), or none of them
...
[](#VUID-vkCmdExecuteGeneratedCommandsNV-flags-13361) VUID-vkCmdExecuteGeneratedCommandsNV-flags-13361

If there are any shader objects bound that were created with `flags`
that includes the [VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](../shaders.html#VkShaderCreateFlagBitsEXT) bit,
then all bound shader objects **must** have been created with the
[VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](../shaders.html#VkShaderCreateFlagBitsEXT) bit

[](#VUID-vkCmdExecuteGeneratedCommandsNV-flags-13362) VUID-vkCmdExecuteGeneratedCommandsNV-flags-13362
...
[VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT](../descriptorsets.html#VkPipelineLayoutCreateFlagBits) set

[](#VUID-vkCmdExecuteGeneratedCommandsNV-flags-12491) VUID-vkCmdExecuteGeneratedCommandsNV-flags-12491
...
[](#VUID-vkCmdExecuteGeneratedCommandsNV-flags-13363) VUID-vkCmdExecuteGeneratedCommandsNV-flags-13363
...
[VkDescriptorSetLayoutBinding](../descriptorsets.html#VkDescriptorSetLayoutBinding)::`stageFlags` set with
[VK_SHADER_STAGE_VERTEX_BIT](../pipelines.html#VkShaderStageFlagBits),
[VK_SHADER_STAGE_TESSELLATION_CONTROL_BIT](../pipelines.html#VkShaderStageFlagBits),
[VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT](../pipelines.html#VkShaderStageFlagBits) or
[VK_SHADER_STAGE_GEOMETRY_BIT](../pipelines.html#VkShaderStageFlagBits), then there **must** be no binding with
[VkDescriptorSetLayoutBinding](../descriptorsets.html#VkDescriptorSetLayoutBinding)::`stageFlags` set with
...
[](#VUID-vkCmdExecuteGeneratedCommandsNV-flags-13364) VUID-vkCmdExecuteGeneratedCommandsNV-flags-13364

If there are any shader objects bound that were created with `flags`
that includes both the [VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](../shaders.html#VkShaderCreateFlagBitsEXT)
and [VK_SHADER_CREATE_NO_TASK_SHADER_BIT_EXT](../shaders.html#VkShaderCreateFlagBitsEXT) bits, the pipeline
layout of the bound descriptor sets **must** have been created with
[VK_PIPELINE_LAYOUT_CREATE_NO_TASK_SHADER_BIT_KHR](../descriptorsets.html#VkPipelineLayoutCreateFlagBits) set

[](#VUID-vkCmdExecuteGeneratedCommandsNV-flags-13365) VUID-vkCmdExecuteGeneratedCommandsNV-flags-13365

If there are any shader objects bound that were created with `flags`
that includes both the [VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](../shaders.html#VkShaderCreateFlagBitsEXT)
and [VK_SHADER_CREATE_NO_TASK_SHADER_BIT_EXT](../shaders.html#VkShaderCreateFlagBitsEXT) bits, there **must** be
no shader object bound to the [VK_SHADER_STAGE_TASK_BIT_EXT](../pipelines.html#VkShaderStageFlagBits) stage
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-OpImageBlockMatchSADQCOM-12420) VUID-vkCmdExecuteGeneratedCommandsEXT-OpImageBlockMatchSADQCOM-12420
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-OpImageBlockMatchWindow-12421) VUID-vkCmdExecuteGeneratedCommandsEXT-OpImageBlockMatchWindow-12421
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-addressModeU-12422) VUID-vkCmdExecuteGeneratedCommandsEXT-addressModeU-12422
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-micromap-11636) VUID-vkCmdExecuteGeneratedCommandsEXT-micromap-11636
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-micromap-11637) VUID-vkCmdExecuteGeneratedCommandsEXT-micromap-11637
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-micromap-11638) VUID-vkCmdExecuteGeneratedCommandsEXT-micromap-11638
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-micromap-11639) VUID-vkCmdExecuteGeneratedCommandsEXT-micromap-11639
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-OpTensorReadARM-12462) VUID-vkCmdExecuteGeneratedCommandsEXT-OpTensorReadARM-12462
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-pNext-12463) VUID-vkCmdExecuteGeneratedCommandsEXT-pNext-12463
...
* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-None-12472) VUID-vkCmdExecuteGeneratedCommandsEXT-None-12472
...
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13361) VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13361
...
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13362) VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13362
...
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-flags-12491) VUID-vkCmdExecuteGeneratedCommandsEXT-flags-12491
...
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13363) VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13363
...
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13364) VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13364
...
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13365) VUID-vkCmdExecuteGeneratedCommandsEXT-flags-13365
...
If a rendering pass is currently active, either the view mask **must** be
`0` or `indirectExecutionSet` **must** be [VK_NULL_HANDLE](../../appendices/boilerplate.html#VK_NULL_HANDLE)
...
* 
[](#VUID-VkGeneratedCommandsInfoEXT-indirectAddress-12407) VUID-VkGeneratedCommandsInfoEXT-indirectAddress-12407

The underlying buffer for `indirectAddress` **must** have the
[VK_BUFFER_USAGE_2_INDIRECT_BUFFER_BIT_KHR](../resources.html#VkBufferUsageFlagBits2KHR) bit set in its usage
flag

...
- [Queue Performance Hints](#devsandqueues-perfhint)
- [Queue_Performance_Hints](#devsandqueues-perfhint)
...
from a pool created with
[VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorPoolCreateFlagBits), and **can** include
dynamic uniform buffer descriptors in descriptor set layouts created
with [VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits),
...
Therefore this limit has no practical effect and **may** be zero.
...
from a pool created with
[VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorPoolCreateFlagBits), and **can** include
dynamic storage buffer descriptors in descriptor set layouts created
with [VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits),
bindings for these descriptors **must** not be present in any descriptor
set layout that includes bindings created with
[VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorBindingFlagBitsEXT).
...
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) bit
set.
While an application **can** allocate input attachment descriptors from a
pool created with [VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorPoolCreateFlagBits),
and **can** include dynamic uniform buffer descriptors in descriptor set
...
bindings for these descriptors **must** not be created with
[VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT](descriptorsets.html#VkDescriptorBindingFlagBitsEXT).
Therefore this limit only exists to allow implementations exposing a
higher limit for input attachment descriptors in a pipeline layout
including any descriptor set layouts created with
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) than in
a pipeline layout not including any descriptor set layouts created with
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](descriptorsets.html#VkDescriptorSetLayoutCreateFlagBits) and
**may** be zero to indicate that only the
`maxDescriptorSetInputAttachments` applies.
...
[inline uniform block](descriptors.html#descriptors-inlineuniformblock) binding.
...
[VK_DESCRIPTOR_TYPE_INLINE_UNIFORM_BLOCK](descriptors.html#VkDescriptorType) count against this limit.
...
* 
[VK_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_DISPATCH_PARAMETERS_ARM](#VkPhysicalDeviceSchedulingControlsFlagBitsARM)
specifies that a [vkCmdSetDispatchParametersARM](dispatch.html#vkCmdSetDispatchParametersARM) command **may** be
recorded in a command buffer and that properties returned in
[VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM](#VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM)
are valid.
...
using [VkDispatchParametersARM](dispatch.html#VkDispatchParametersARM)::`workGroupBatchSize`.
...
[VkPhysicalDeviceSchedulingControlsPropertiesARM](#VkPhysicalDeviceSchedulingControlsPropertiesARM)::`schedulingControlsFlags`
does not contain
[VK_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_DISPATCH_PARAMETERS_ARM](#VkPhysicalDeviceSchedulingControlsFlagBitsARM) then
...
[](#VUID-VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM-sType-sType) VUID-VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_DISPATCH_PARAMETERS_PROPERTIES_ARM](fundamentals.html#VkStructureType)
...
and/or, if the [`maintenance11`](features.html#features-maintenance11) feature is
supported, transfer
operations, **must** report (1,1,1) in `minImageTransferGranularity`,
meaning that there are no additional restrictions on the granularity of
image transfer operations for these queues.
...
If the [`maintenance11`](features.html#features-maintenance11) feature is supported,
[VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR](#VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR)::`optimalImageTransferGranularity`
...
[](#VUID-VkQueueFamilyProperties2-pNext-pNext) VUID-VkQueueFamilyProperties2-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkQueueFamilyCheckpointProperties2NV](#VkQueueFamilyCheckpointProperties2NV), [VkQueueFamilyCheckpointPropertiesNV](#VkQueueFamilyCheckpointPropertiesNV), [VkQueueFamilyGlobalPriorityProperties](#VkQueueFamilyGlobalPriorityProperties), [VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR](#VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR), [VkQueueFamilyOwnershipTransferPropertiesKHR](#VkQueueFamilyOwnershipTransferPropertiesKHR), [VkQueueFamilyQueryResultStatusPropertiesKHR](#VkQueueFamilyQueryResultStatusPropertiesKHR), or [VkQueueFamilyVideoPropertiesKHR](#VkQueueFamilyVideoPropertiesKHR)
...
The [VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR](#VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR)
structure is defined as:
...
The `x`, `y`, and `z` members of a [VkOffset3D](fundamentals.html#VkOffset3D) are
zero.

* 
The `width`, `height`, and `depth` members of a
[VkExtent3D](fundamentals.html#VkExtent3D) parameter match the width, height, and depth of the
...
* 
`width` of a [VkExtent3D](fundamentals.html#VkExtent3D) parameter is an integer multiple of
Ax, or else `x` +  `width` equals the width
of the image subresource corresponding to the parameter.

* 
`height` of a [VkExtent3D](fundamentals.html#VkExtent3D) parameter is an integer multiple of
Ay, or else `y` +  `height` equals the height
of the image subresource corresponding to the parameter.

* 
`depth` of a [VkExtent3D](fundamentals.html#VkExtent3D) parameter is an integer multiple of
...
[](#VUID-VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR-sType-sType) VUID-VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_QUEUE_FAMILY_OPTIMAL_IMAGE_TRANSFER_GRANULARITY_PROPERTIES_KHR](fundamentals.html#VkStructureType)
...
* 
`enabledLayerCount` is legacy and not used.
Implementations **must** not access this parameter.
It **must** be 0.
...
* 
[](#VUID-VkDeviceCreateInfo-enabledLayerCount-12384) VUID-VkDeviceCreateInfo-enabledLayerCount-12384

`enabledLayerCount` **must** be 0

* 
[](#VUID-VkDeviceCreateInfo-ppEnabledLayerNames-12385) VUID-VkDeviceCreateInfo-ppEnabledLayerNames-12385
...
an external memory object imported via
[VK_EXTERNAL_MEMORY_HANDLE_TYPE_ANDROID_HARDWARE_BUFFER_BIT_ANDROID](capabilities.html#VkExternalMemoryHandleTypeFlagBitsKHR),
`memoryObjectId` **must** be unique system wide.
...
See [Pipelines](pipelines.html#pipelines) and [Resource Descriptors](descriptors.html#descriptors),
...
Each queue has performance hint state, which defaults to
[VK_PERF_HINT_TYPE_DEFAULT_QCOM](#VkPerfHintTypeQCOM) when creating them with device.

Applications **can** set a performance hint on the queue to influence the power
and performance settings for the operation of the device while the queue is
active.
This state persists for the lifetime of the queue object and resets when the
queue is destroyed or replaced when another performance hint is set on
queue.

Determination of whether or not a queue is active is
implementation-dependent.
Submitting commands to an inactive queue reapplies the queue’s current
performance hint state to device.

To set a performance hint on a [VkQueue](#VkQueue) object, call:
...
* 
`pPerfHintInfo` is a pointer to a [VkPerfHintInfoQCOM](#VkPerfHintInfoQCOM)
...
The [`queuePerfHint`](features.html#features-queuePerfHint) feature **must** be
enabled
...
[VkPhysicalDeviceQueuePerfHintPropertiesQCOM](limits.html#VkPhysicalDeviceQueuePerfHintPropertiesQCOM)::`supportedQueues`
...
[](#VUID-vkQueueSetPerfHintQCOM-queue-parameter) VUID-vkQueueSetPerfHintQCOM-queue-parameter
 ...
 `queue` **must** be a valid [VkQueue](#VkQueue) handle

* 
[](#VUID-vkQueueSetPerfHintQCOM-pPerfHintInfo-parameter) VUID-vkQueueSetPerfHintQCOM-pPerfHintInfo-parameter

 `pPerfHintInfo` **must** be a valid pointer to a valid [VkPerfHintInfoQCOM](#VkPerfHintInfoQCOM) structure
...
Command Properties
| [Command Buffer Levels](cmdbuffers.html#VkCommandBufferLevel) | [Render Pass Scope](renderpass.html#vkCmdBeginRenderPass) | [Video Coding Scope](videocoding.html#vkCmdBeginVideoCodingKHR) | [Supported Queue Types](#VkQueueFlagBits) | [Command Type](fundamentals.html#fundamentals-queueoperation-command-types) |
| --- | --- | --- | --- | --- |
| - | - | - | Any | - |
...
* 
`type` is a [VkPerfHintTypeQCOM](#VkPerfHintTypeQCOM) value indicating the type of
...
can be influenced by the [VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM](#VkPerfHintTypeQCOM),
[VK_PERF_HINT_TYPE_FREQUENCY_MAX_QCOM](#VkPerfHintTypeQCOM), and
[VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM](#VkPerfHintTypeQCOM) performance hints.
...
[VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM](#VkPerfHintTypeQCOM) is calculated with the
following:
...
* 
[VK_PERF_HINT_TYPE_FREQUENCY_MAX_QCOM](#VkPerfHintTypeQCOM)

* 
[VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM](#VkPerfHintTypeQCOM) and `scale` equal to
`100`
...
* 
[VK_PERF_HINT_TYPE_DEFAULT_QCOM](#VkPerfHintTypeQCOM)

* 
[VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM](#VkPerfHintTypeQCOM)

|  | This means that [VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM](#VkPerfHintTypeQCOM) only takes effect
| --- | --- |
if all of the device’s other active queues running on the host also have the
[VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM](#VkPerfHintTypeQCOM) hint applied.

If any queue is active that never had a performance hint applied and
therefore is in the [VK_PERF_HINT_TYPE_DEFAULT_QCOM](#VkPerfHintTypeQCOM) state, it will
...
If `type` is not [VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM](#VkPerfHintTypeQCOM),
`scale` **must** equal `0`
...
[](#VUID-VkPerfHintInfoQCOM-sType-sType) VUID-VkPerfHintInfoQCOM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PERF_HINT_INFO_QCOM](fundamentals.html#VkStructureType)
...
[](#VUID-VkPerfHintInfoQCOM-type-parameter) VUID-VkPerfHintInfoQCOM-type-parameter
 ...
 `type` **must** be a valid [VkPerfHintTypeQCOM](#VkPerfHintTypeQCOM) value

Possible values of [VkPerfHintInfoQCOM](#VkPerfHintInfoQCOM)::`type`, specifying the type
...
* 
[VK_PERF_HINT_TYPE_DEFAULT_QCOM](#VkPerfHintTypeQCOM) resets the performance hint state
back to default for the queue.

* 
[VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM](#VkPerfHintTypeQCOM) specifies the queue **should**
prioritize power and sets the frequency constraints `fmin` and
`fmax` to `Fmin`.

* 
[VK_PERF_HINT_TYPE_FREQUENCY_MAX_QCOM](#VkPerfHintTypeQCOM) specifies the queue **should**
prioritize performance and sets the frequency constraints `fmin` and
`fmax` to `Fmax`.

* 
[VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM](#VkPerfHintTypeQCOM) specifies the queue

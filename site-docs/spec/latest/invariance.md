...
- **Component**: spec
- **Version**: latest
- **URL**: /spec/latest/appendices/invariance.html

## Table of Contents

- [Repeatability](#_repeatability)
- [Multi-Pass Algorithms](#_multi_pass_algorithms)
- [Invariance Rules](#_invariance_rules)
- [Tessellation Invariance](#_tessellation_invariance)
...
The wording “Identical pipelines” means [VkPipeline](../chapters/pipelines.html#VkPipeline) objects that have

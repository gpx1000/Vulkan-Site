...
[`geometryShader`](#features-geometryShader) features.
 ...
 `shaderImageGatherExtended`
    ...
    If this feature is not enabled, the `OpImage*Gather`
and `OpImageGatherQCOM`
    instructions do not support the `Offset` and `ConstOffsets`
    operands.
    The `OpImageGatherQCOM` instruction does not support the
    `ConstOffsets` operand regardless of the value of this feature.
    This also specifies whether shader modules **can** declare the
...
`ShaderRecordBufferKHR`,
    ...
    objects unless the [    `storageBuffer8BitAccess`](#features-storageBuffer8BitAccess) or
    [    `uniformAndStorageBuffer8BitAccess`](#features-uniformAndStorageBuffer8BitAccess) features are enabled or they
    are accessed in 32-bit multiples if the
    [`shaderUntypedPointers`](#features-shaderUntypedPointers) feature
    is enabled.
    This also specifies whether shader modules **can** declare the
...
accessed in 32-bit multiples if the [    `shaderUntypedPointers`](#features-shaderUntypedPointers) feature is enabled.
This also specifies whether shader modules **can** declare the
...
objects unless the [    `storagePushConstant8`](#features-storagePushConstant8) feature is enabled or they are accessed in
32-bit multiples if the [    `shaderUntypedPointers`](#features-shaderUntypedPointers) feature is enabled.
This also specifies whether shader modules **can** declare the
...
`ShaderRecordBufferKHR`,
    ...
    in such
    objects unless the [    `shaderUntypedPointer`](#features-shaderUntypedPointers) feature is enabled and they are accessed in
    32-bit multiples or 16-bit multiples if the
    [    `storageBuffer16BitAccess`](#features-storageBuffer16BitAccess) feature is enabled.
...
If this feature is not enabled, 8-bit integer members **must** not be used
in such
objects unless the [    `shaderUntypedPointers`](#features-shaderUntypedPointers) feature is enabled and they are accessed
in 32-bit multiples or 16-bit multiples if the
[    `uniformAndStorageBuffer16BitAccess`](#features-uniformAndStorageBuffer16BitAccess) feature is enabled.
This also indicates whether shader modules **can** declare the
...
objects unless the [    `shaderUntypedPointers`](#features-shaderUntypedPointers) feature is enabled and they are accessed
in 32-bit multiples or 16-bit multiples if the
[    `storagePushConstant16`](#features-storagePushConstant16) feature is enabled.
This also indicates whether shader modules **can** declare the
...
value for [VkVertexInputBindingDivisorDescription](fxvertex.html#VkVertexInputBindingDivisorDescription)::`divisor` is
supported.
...
`ShaderRecordBufferKHR`,
    ...
    objects unless the [    `shaderUntypedPointer`](#features-shaderUntypedPointers) feature is enabled and they are accessed in
    32-bit multiples or 16-bit multiples if the
    [    `storageBuffer16BitAccess`](#extension-features-storageBuffer16BitAccess) feature is enabled.
    This also indicates whether shader modules **can** declare the
    `StorageBuffer8BitAccess` capability.
...
objects unless the [    `shaderUntypedPointers`](#features-shaderUntypedPointers) feature is enabled and they are accessed
in 32-bit multiples or 16-bit multiples if the
[    `uniformAndStorageBuffer16BitAccess`](#extension-features-uniformAndStorageBuffer16BitAccess) feature is enabled.
This also indicates whether shader modules **can** declare the
`UniformAndStorageBuffer8BitAccess` capability.
...
objects unless the [    `shaderUntypedPointers`](#features-shaderUntypedPointers) feature is enabled and they are accessed
in 32-bit multiples or 16-bit multiples if the
[    `storagePushConstant16`](#extension-features-storagePushConstant16) feature is enabled.
This also indicates whether shader modules **can** declare the
`StoragePushConstant8` capability.
...
`ShaderRecordBufferKHR`,
    ...
    If this feature is not enabled, 16-bit integer or 16-bit floating-point
    members **must** not be used in such
    objects unless the [    `storageBuffer8BitAccess`](#extension-features-storageBuffer8BitAccess) or
    [    `uniformAndStorageBuffer8BitAccess`](#extension-features-uniformAndStorageBuffer8BitAccess) features are enabled or they
    are accessed in 32-bit multiples if the
    [`shaderUntypedPointers`](#features-shaderUntypedPointers) feature
    is enabled.
    This also specifies whether shader modules **can** declare the
...
If this feature is not enabled, 16-bit integer or floating-point members
**must** not be used in such
objects unless the [    `storagePushConstant8`](#extension-features-storagePushConstant8) feature is enabled or they are accessed in
32-bit multiples if the [    `shaderUntypedPointers`](#features-shaderUntypedPointers) feature is enabled.
This also specifies whether shader modules **can** declare the
`StoragePushConstant16` capability.
...
the implementation supports [VK_QUERY_TYPE_TIME_ELAPSED_QCOM](queries.html#VkQueryType)
queries.
...
[](#VUID-VkPhysicalDeviceElapsedTimerQueryFeaturesQCOM-sType-sType) VUID-VkPhysicalDeviceElapsedTimerQueryFeaturesQCOM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ELAPSED_TIMER_QUERY_FEATURES_QCOM](fundamentals.html#VkStructureType)
...
[](#VUID-VkPhysicalDeviceCooperativeMatrixDecodeVectorFeaturesNV-sType-sType) VUID-VkPhysicalDeviceCooperativeMatrixDecodeVectorFeaturesNV-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_DECODE_VECTOR_FEATURES_NV](fundamentals.html#VkStructureType)
...
supports the [vkGetPhysicalDeviceCooperativeMatrixProperties2EXT](shaders.html#vkGetPhysicalDeviceCooperativeMatrixProperties2EXT)
command.
...
[](#VUID-VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT-sType-sType) VUID-VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_MAINTENANCE_1_FEATURES_EXT](fundamentals.html#VkStructureType)
...
[per picture partition    feedback](queries.html#queries-video-encode-per-partition-feedback) and the following additional
[video encode feedback flags](queries.html#queries-video-encode-feedback), as
reported in [VkVideoEncodeFeedback2CapabilitiesKHR](videocoding.html#VkVideoEncodeFeedback2CapabilitiesKHR) and/or
[VkVideoEncodeCapabilitiesKHR](videocoding.html#VkVideoEncodeCapabilitiesKHR)::`supportedEncodeFeedbackFlags`,
respectively:

[VK_VIDEO_ENCODE_FEEDBACK_AVERAGE_QUANTIZATION_BIT_KHR](queries.html#VkVideoEncodeFeedbackFlagBitsKHR).

* 
[VK_VIDEO_ENCODE_FEEDBACK_MIN_QUANTIZATION_BIT_KHR](queries.html#VkVideoEncodeFeedbackFlagBitsKHR).

* 
[VK_VIDEO_ENCODE_FEEDBACK_MAX_QUANTIZATION_BIT_KHR](queries.html#VkVideoEncodeFeedbackFlagBitsKHR).

* 
[VK_VIDEO_ENCODE_FEEDBACK_INTRA_PIXELS_BIT_KHR](queries.html#VkVideoEncodeFeedbackFlagBitsKHR).

* 
[VK_VIDEO_ENCODE_FEEDBACK_INTER_PIXELS_BIT_KHR](queries.html#VkVideoEncodeFeedbackFlagBitsKHR).

* 
[VK_VIDEO_ENCODE_FEEDBACK_SKIPPED_PIXELS_BIT_KHR](queries.html#VkVideoEncodeFeedbackFlagBitsKHR).

* 
[VK_VIDEO_ENCODE_FEEDBACK_PICTURE_PARTITION_COUNT_BIT_KHR](queries.html#VkVideoEncodeFeedbackFlagBitsKHR).
...
[](#VUID-VkPhysicalDeviceVideoEncodeFeedback2FeaturesKHR-sType-sType) VUID-VkPhysicalDeviceVideoEncodeFeedback2FeaturesKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_FEEDBACK_2_FEATURES_KHR](fundamentals.html#VkStructureType)
...
* 
[VkFormatProperties4KHR](formats.html#VkFormatProperties4KHR), extending [VkFormatProperties2](formats.html#VkFormatProperties2), and
corresponding [VkFormatFeatureFlagBits4KHR](formats.html#VkFormatFeatureFlagBits4KHR) and
[VkFormatFeatureFlags4KHR](formats.html#VkFormatFeatureFlags4KHR) types providing up to 64 new format
feature flags.

* 
[VkImageCreateFlags2CreateInfoKHR](resources.html#VkImageCreateFlags2CreateInfoKHR), extending structures passed to
image create and query functions, and corresponding
[VkImageCreateFlagBits2KHR](resources.html#VkImageCreateFlagBits2KHR) and [VkImageCreateFlags2KHR](resources.html#VkImageCreateFlags2KHR) types
providing up to 32 new image create flags.

* 
[VkImageUsageFlags2CreateInfoKHR](resources.html#VkImageUsageFlags2CreateInfoKHR), extending structures passed to
image create and query functions, and corresponding
[VkImageUsageFlagBits2KHR](resources.html#VkImageUsageFlagBits2KHR) and [VkImageUsageFlags2KHR](resources.html#VkImageUsageFlags2KHR) types
providing up to 32 new image usage flags.

* 
The [VkPipelineCreateFlags2CreateInfoKHR](pipelines.html#VkPipelineCreateFlags2CreateInfoKHR),
[VkPipelineCreateFlags2KHR](pipelines.html#VkPipelineCreateFlags2KHR), [VkPipelineCreateFlagBits2KHR](pipelines.html#VkPipelineCreateFlagBits2KHR),
[VkBufferUsageFlags2CreateInfoKHR](resources.html#VkBufferUsageFlags2CreateInfoKHR), [VkBufferUsageFlags2KHR](resources.html#VkBufferUsageFlags2KHR),
and [VkBufferUsageFlagBits2KHR](resources.html#VkBufferUsageFlagBits2KHR) types originally introduced by
...
[](#VUID-VkPhysicalDeviceExtendedFlagsFeaturesKHR-sType-sType) VUID-VkPhysicalDeviceExtendedFlagsFeaturesKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_FLAGS_FEATURES_KHR](fundamentals.html#VkStructureType)
...
`InterpolateAtSample` from the `GLSL.std.450` extended instruction
set.
...
[](#VUID-VkPhysicalDeviceOpacityMicromapFeaturesKHR-sType-sType) VUID-VkPhysicalDeviceOpacityMicromapFeaturesKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPACITY_MICROMAP_FEATURES_KHR](fundamentals.html#VkStructureType)
...
indicates whether the implementation supports capture and replay of
addresses for micromap arrays.

* 
 `micromapHostCommands`
indicates whether the implementation supports host side micromap array
commands.
...
* 
Allow `dstCache` in [vkMergePipelineCaches](pipelines.html#vkMergePipelineCaches) to be implicitly
synchronized.
...
* 
Support `Offset` (as an alternative to `ConstOffset`) image
operand in texture sampling and fetch operations
...
[VkMemoryBarrier2](synchronization.html#VkMemoryBarrier2), [VkBufferMemoryBarrier2](synchronization.html#VkBufferMemoryBarrier2), and
...
[vkCmdResolveImage2](copies.html#vkCmdResolveImage2) to bring it in-line with render pass
attachment resolves
...
[VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR](resources.html#VkImageCreateFlagBits)

* 
The depth clipping state of the pipeline is well defined when the
pipeline is created without
[VK_DYNAMIC_STATE_DEPTH_CLIP_ENABLE_EXT](pipelines.html#VkDynamicState) being set
and the [VkPipelineRasterizationDepthClipStateCreateInfoEXT](primsrast.html#VkPipelineRasterizationDepthClipStateCreateInfoEXT)
structure is not present

* 
[VK_SHADER_CREATE_INDEPENDENT_SETS_BIT_KHR](shaders.html#VkShaderCreateFlagBitsEXT)

* 
Allow `queueFamilyIndexCount` of 1 in [VkBufferCreateInfo](resources.html#VkBufferCreateInfo),
...
[VkTensorCreateInfoARM](resources.html#VkTensorCreateInfoARM)
     when `sharingMode` is [VK_SHARING_MODE_CONCURRENT](resources.html#VkSharingMode)
...
[](#VUID-VkPhysicalDeviceMaintenance11FeaturesKHR-sType-sType) VUID-VkPhysicalDeviceMaintenance11FeaturesKHR-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_11_FEATURES_KHR](fundamentals.html#VkStructureType)
...
[](#VUID-VkPhysicalDeviceMultisampledRenderToSwapchainFeaturesEXT-sType-sType) VUID-VkPhysicalDeviceMultisampledRenderToSwapchainFeaturesEXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTISAMPLED_RENDER_TO_SWAPCHAIN_FEATURES_EXT](fundamentals.html#VkStructureType)
...
extends support for [VK_SAMPLER_ADDRESS_MODE_CLAMP_TO_EDGE](samplers.html#VkSamplerAddressMode) to both
input images of all [block matching operations](textures.html#textures-blockmatch).
...
[](#VUID-VkPhysicalDeviceImageProcessing3FeaturesQCOM-sType-sType) VUID-VkPhysicalDeviceImageProcessing3FeaturesQCOM-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_PROCESSING_3_FEATURES_QCOM](fundamentals.html#VkStructureType)
...
The `VkPhysicalDeviceShaderMultipleWaitQueuesFeaturesQCOM` structure is
defined as:
...
indicates that the implementation supports SPIR-V modules declaring the
`MultipleWaitQueuesQCOM` capability.

If the `VkPhysicalDeviceShaderMultipleWaitQueuesFeaturesQCOM` structure is included in the `pNext` chain of the
[VkPhysicalDeviceFeatures2](#VkPhysicalDeviceFeatures2) structure passed to
[vkGetPhysicalDeviceFeatures2](#vkGetPhysicalDeviceFeatures2), it is filled in to indicate whether each
corresponding feature is supported.
If the application wishes to use a [VkDevice](devsandqueues.html#VkDevice) with any features
described by `VkPhysicalDeviceShaderMultipleWaitQueuesFeaturesQCOM`, it **must** add an instance of the structure,
with the desired feature members set to [VK_TRUE](fundamentals.html#VK_TRUE), to the `pNext`
chain of [VkDeviceCreateInfo](devsandqueues.html#VkDeviceCreateInfo) when creating the [VkDevice](devsandqueues.html#VkDevice).
...
* 
[](#VUID-VkPhysicalDeviceShaderMultipleWaitQueuesFeaturesQCOM-sType-sType) VUID-VkPhysicalDeviceShaderMultipleWaitQueuesFeaturesQCOM-sType-sType

 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MULTIPLE_WAIT_QUEUES_FEATURES_QCOM](fundamentals.html#VkStructureType)
...
The `VkPhysicalDeviceShaderSplitBarrierFeaturesEXT` structure is defined
as:
...
* 
 `shaderSplitBarrier` indicates that
the implementation supports the `SplitBarrierEXT` SPIR-V capability.

If the `VkPhysicalDeviceShaderSplitBarrierFeaturesEXT` structure is included in the `pNext` chain of the
[VkPhysicalDeviceFeatures2](#VkPhysicalDeviceFeatures2) structure passed to
[vkGetPhysicalDeviceFeatures2](#vkGetPhysicalDeviceFeatures2), it is filled in to indicate whether each
corresponding feature is supported.
If the application wishes to use a [VkDevice](devsandqueues.html#VkDevice) with any features
described by `VkPhysicalDeviceShaderSplitBarrierFeaturesEXT`, it **must** add an instance of the structure,
with the desired feature members set to [VK_TRUE](fundamentals.html#VK_TRUE), to the `pNext`
chain of [VkDeviceCreateInfo](devsandqueues.html#VkDeviceCreateInfo) when creating the [VkDevice](devsandqueues.html#VkDevice).
...
* 
[](#VUID-VkPhysicalDeviceShaderSplitBarrierFeaturesEXT-sType-sType) VUID-VkPhysicalDeviceShaderSplitBarrierFeaturesEXT-sType-sType

 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SPLIT_BARRIER_FEATURES_EXT](fundamentals.html#VkStructureType)
...
[](#VUID-VkPhysicalDeviceGpaFeaturesAMD-sType-sType) VUID-VkPhysicalDeviceGpaFeaturesAMD-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GPA_FEATURES_AMD](fundamentals.html#VkStructureType)
...
The `VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM`
structure is defined as:
...
`dataGraphNeuralAcceleratorStatistics` indicates that the
implementation supports gathering neural accelerator statistics for data
graphs.

If the `VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM` structure is included in the `pNext` chain of the
[VkPhysicalDeviceFeatures2](#VkPhysicalDeviceFeatures2) structure passed to
[vkGetPhysicalDeviceFeatures2](#vkGetPhysicalDeviceFeatures2), it is filled in to indicate whether each
corresponding feature is supported.
If the application wishes to use a [VkDevice](devsandqueues.html#VkDevice) with any features
described by `VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM`, it **must** add an instance of the structure,
with the desired feature members set to [VK_TRUE](fundamentals.html#VK_TRUE), to the `pNext`
chain of [VkDeviceCreateInfo](devsandqueues.html#VkDeviceCreateInfo) when creating the [VkDevice](devsandqueues.html#VkDevice).
...
* 
[](#VUID-VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM-sType-sType) VUID-VkPhysicalDeviceDataGraphNeuralAcceleratorStatisticsFeaturesARM-sType-sType

 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DATA_GRAPH_NEURAL_ACCELERATOR_STATISTICS_FEATURES_ARM](fundamentals.html#VkStructureType)
...
[](#VUID-VkPhysicalDeviceImageTilingControlFeaturesEXT-sType-sType) VUID-VkPhysicalDeviceImageTilingControlFeaturesEXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_TILING_CONTROL_FEATURES_EXT](fundamentals.html#VkStructureType)
...
[](#VUID-VkPhysicalDeviceShaderOCPMicroscalingTypesFeaturesEXT-sType-sType) VUID-VkPhysicalDeviceShaderOCPMicroscalingTypesFeaturesEXT-sType-sType
 ...
 `sType` **must** be [VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_OCP_MICROSCALING_TYPES_FEATURES_EXT](fundamentals.html#VkStructureType)
...
If `[VK_KHR_video_encode_feedback2](../appendices/extensions.html#VK_KHR_video_encode_feedback2)` is supported,
[`videoEncodeFeedback2`](#features-videoEncodeFeedback2) **must** be supported
...
If `[VK_KHR_opacity_micromap](../appendices/extensions.html#VK_KHR_opacity_micromap)` is supported,
...
If `[VK_KHR_maintenance11](../appendices/extensions.html#VK_KHR_maintenance11)` is supported,
[`maintenance11`](#features-maintenance11) **must** be supported

If `[VK_KHR_extended_flags](../appendices/extensions.html#VK_KHR_extended_flags)` is supported,
[`extendedFlags`](#features-extendedFlags) **must** be supported
...
If `[VK_AMD_gpa_interface](../appendices/extensions.html#VK_AMD_gpa_interface)` is supported,
at least one of [`perfCounters`](#features-perfCounters), [`streamingPerfCounters`](#features-streamingPerfCounters), [`sqThreadTracing`](#features-sqThreadTracing), or [`clockModes`](#features-clockModes) **must** be supported
...
If `[VK_QCOM_elapsed_timer_query](../appendices/extensions.html#VK_QCOM_elapsed_timer_query)` is supported,
[`elapsedTimerQuery`](#features-elapsedTimerQuery) **must** be supported
...
If `[VK_QCOM_image_processing3](../appendices/extensions.html#VK_QCOM_image_processing3)` is supported,
[`imageGatherLinear`](#features-imageGatherLinear) **must** be supported

If `[VK_QCOM_shader_multiple_wait_queues](../appendices/extensions.html#VK_QCOM_shader_multiple_wait_queues)` is supported,
[`shaderMultipleWaitQueues`](#features-shaderMultipleWaitQueues) **must** be supported

If `[VK_EXT_shader_split_barrier](../appendices/extensions.html#VK_EXT_shader_split_barrier)` is supported,
[`shaderSplitBarrier`](#features-shaderSplitBarrier) **must** be supported
...
If `[VK_EXT_multisampled_render_to_swapchain](../appendices/extensions.html#VK_EXT_multisampled_render_to_swapchain)` is supported,
[`multisampledRenderToSwapchain`](#features-multisampledRenderToSwapchain) **must** be supported
...
If `[VK_EXT_cooperative_matrix_maintenance1](../appendices/extensions.html#VK_EXT_cooperative_matrix_maintenance1)` is supported,
[`VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT`::`cooperativeMatrixProperties2`](#features-cooperativeMatrixProperties2EXT) **must** be supported
...
If `[VK_EXT_shader_ocp_microscaling_types](../appendices/extensions.html#VK_EXT_shader_ocp_microscaling_types)` is supported,
at least one of [`shaderFloat4`](#features-shaderFloat4), [`shaderFloat6`](#features-shaderFloat6), [`shaderFloat8UnsignedE8M0`](#features-shaderFloat8UnsignedE8M0), or [`shaderMXInt8`](#features-shaderMXInt8) **must** be supported
...
If `[VK_SEC_throttle_hint](../appendices/extensions.html#VK_SEC_throttle_hint)` is supported,
[`throttleHint`](../appendices/extensions.html#features-throttleHint) **must** be supported

If `[VK_ARM_data_graph_neural_accelerator_statistics](../appendices/extensions.html#VK_ARM_data_graph_neural_accelerator_statistics)` is supported,
[`dataGraphNeuralAcceleratorStatistics`](#features-dataGraphNeuralAcceleratorStatistics) **must** be supported
...
If `[VK_EXT_image_tiling_control](../appendices/extensions.html#VK_EXT_image_tiling_control)` is supported,
[`imageTilingControl`](#features-imageTilingControl) **must** be supported

If `[VK_NV_cooperative_matrix_decode_vector](../appendices/extensions.html#VK_NV_cooperative_matrix_decode_vector)` is supported,
the following features **must** be supported:

* 
[`cooperativeMatrixDecodeVector`](#features-cooperativeMatrixDecodeVector)

* 
[`cooperativeMatrixBlockLoads`](#features-cooperativeMatrixBlockLoads)

...
[This site](https://docs.vulkan.org/) gathers together several key Vulkan
...
(with all registered extensions), generated on 2025-05-22 10:07:34Z from git branch: main commit: 112aee75d162412a4623e7d22a3de52e0233cbf5.
...
[This site](https://docs.vulkan.org/) is generated using the
[Antora](https://docs.antora.org/) static site generator.

If you need to report a problem or build the site yourself, start with the
[Vulkan-Site](https://github.com/KhronosGroup/Vulkan-Site/) repository on
GitHub.

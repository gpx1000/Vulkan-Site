...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_frame_boundary.html

## Table of Contents

- [Problem Statement](#_problem_statement)
- [Graphics applications bypassing the Khronos swapchain](#_graphics_applications_bypassing_the_khronos_swapchain)
- [Graphics_applications_bypassing_the_Khronos_swapchain](#_graphics_applications_bypassing_the_khronos_swapchain)
- [Compute-only applications](#_compute_only_applications)
- [Overlapping frames](#_overlapping_frames)
- [Solution Space](#_solution_space)
- [Proposal](#_proposal)
- [Overview](#_overview)
- [The VkFrameBoundaryEXT type](#_the_vkframeboundaryext_type)
- [The_VkFrameBoundaryEXT_type](#_the_vkframeboundaryext_type)
- [Validation](#_validation)
- [Examples](#_examples)
- [Compute-only](#_compute_only)
- [Graphics, sequential frames, not using the KHR swapchain](#_graphics_sequential_frames_not_using_the_khr_swapchain)
- [Graphics,_sequential_frames,_not_using_the_KHR_swapchain](#_graphics_sequential_frames_not_using_the_khr_swapchain)
- [Overlapping frames with wait-after-signal](#_overlapping_frames_with_wait_after_signal)
- [Overlapping_frames_with_wait-after-signal](#_overlapping_frames_with_wait_after_signal)
- [Issues](#_issues)
- [RESOLVED: What should this extension be named?](#_resolved_what_should_this_extension_be_named)
- [RESOLVED:_What_should_this_extension_be_named?](#_resolved_what_should_this_extension_be_named)
- [RESOLVED: What information should be included in VkFrameBoundaryEXT?](#_resolved_what_information_should_be_included_in_vkframeboundaryext)
- [RESOLVED:_What_information_should_be_included_in_VkFrameBoundaryEXT?](#_resolved_what_information_should_be_included_in_vkframeboundaryext)
- [RESOLVED: How should frame identifiers be validated?](#_resolved_how_should_frame_identifiers_be_validated)
- [RESOLVED:_How_should_frame_identifiers_be_validated?](#_resolved_how_should_frame_identifiers_be_validated)
...
See also the discussion in [https://gitlab.khronos.org/vulkan/vulkan/-/issues/2436](https://gitlab.khronos.org/vulkan/vulkan/-/issues/2436)

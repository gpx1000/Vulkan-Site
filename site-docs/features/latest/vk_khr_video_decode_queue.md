...
- [5. Issues](#_issues)
- [5.1. RESOLVED: Why is there no VK_PIPELINE_STAGE_VIDEO_DECODE_BIT_KHR?](#_resolved_why_is_there_no_vk_pipeline_stage_video_decode_bit_khr)
- [5.1._RESOLVED:_Why_is_there_no_VK_PIPELINE_STAGE_VIDEO_DECODE_BIT_KHR?](#_resolved_why_is_there_no_vk_pipeline_stage_video_decode_bit_khr)
- [5.2. RESOLVED: Are the decode output picture data and reconstructed picture data used to activate a DPB slot written to the same resource?](#_resolved_are_the_decode_output_picture_data_and_reconstructed_picture_data_used_to_activate_a_dpb_slot_written_to_the_same_resource)
- [5.2._RESOLVED:_Are_the_decode_output_picture_data_and_reconstructed_picture_data_used_to_activate_a_DPB_slot_written_to_the_same_resource?](#_resolved_are_the_decode_output_picture_data_and_reconstructed_picture_data_used_to_activate_a_dpb_slot_written_to_the_same_resource)
- [5.3. RESOLVED: How can layered codec-specific decode extensions enable applications to provide the necessary codec-specific picture information, parameter sets, etc. that may be needed to perform the video coding operations?](#_resolved_how_can_layered_codec_specific_decode_extensions_enable_applications_to_provide_the_necessary_codec_specific_picture_information_parameter_sets_etc_that_may_be_needed_to_perform_the_video_coding_operations)
- [5.3._RESOLVED:_How_can_layered_codec-specific_decode_extensions_enable_applications_to_provide_the_necessary_codec-specific_picture_information,_parameter_sets,_etc._that_may_be_needed_to_perform_the_video_coding_operations?](#_resolved_how_can_layered_codec_specific_decode_extensions_enable_applications_to_provide_the_necessary_codec_specific_picture_information_parameter_sets_etc_that_may_be_needed_to_perform_the_video_coding_operations)
- [5.4. RESOLVED: Can vkCmdVideoDecodeKHR only decode frames? What about field decoding, slice decoding, etc.?](#_resolved_can_vkcmdvideodecodekhr_only_decode_frames_what_about_field_decoding_slice_decoding_etc)
- [5.4._RESOLVED:_Can_vkCmdVideoDecodeKHR_only_decode_frames?_What_about_field_decoding,_slice_decoding,_etc.?](#_resolved_can_vkcmdvideodecodekhr_only_decode_frames_what_about_field_decoding_slice_decoding_etc)
- [5.5. RESOLVED: What is the effect of the flags provided in VkVideoDecodeUsageInfoKHR::videoUsageHints?](#_resolved_what_is_the_effect_of_the_flags_provided_in_vkvideodecodeusageinfokhrvideousagehints)
- [5.5._RESOLVED:_What_is_the_effect_of_the_flags_provided_in_VkVideoDecodeUsageInfoKHR::videoUsageHints?](#_resolved_what_is_the_effect_of_the_flags_provided_in_vkvideodecodeusageinfokhrvideousagehints)
- [5.6. RESOLVED: When is it mandatory to specify reconstructed picture information in VkVideoDecodeInfoKHR::pSetupReferenceSlot?](#_resolved_when_is_it_mandatory_to_specify_reconstructed_picture_information_in_vkvideodecodeinfokhrpsetupreferenceslot)
- [5.6._RESOLVED:_When_is_it_mandatory_to_specify_reconstructed_picture_information_in_VkVideoDecodeInfoKHR::pSetupReferenceSlot?](#_resolved_when_is_it_mandatory_to_specify_reconstructed_picture_information_in_vkvideodecodeinfokhrpsetupreferenceslot)
- [5.7. RESOLVED: Does always requiring the specification of reconstructed picture information in VkVideoDecodeInfoKHR::pSetupReferenceSlot have any undesired performance consequences?](#_resolved_does_always_requiring_the_specification_of_reconstructed_picture_information_in_vkvideodecodeinfokhrpsetupreferenceslot_have_any_undesired_performance_consequences)
- [5.7._RESOLVED:_Does_always_requiring_the_specification_of_reconstructed_picture_information_in_VkVideoDecodeInfoKHR::pSetupReferenceSlot_have_any_undesired_performance_consequences?](#_resolved_does_always_requiring_the_specification_of_reconstructed_picture_information_in_vkvideodecodeinfokhrpsetupreferenceslot_have_any_undesired_performance_consequences)

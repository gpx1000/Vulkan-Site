...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_EXT_host_image_copy.html
...
- [2.1. Querying support](#_querying_support)
- [2.1._Querying_support](#_querying_support)
- [2.2. Required formats](#_required_formats)
- [2.2._Required_formats](#_required_formats)
- [2.3. Limitations](#_limitations)

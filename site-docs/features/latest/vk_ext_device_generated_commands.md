...
- [5.2. RESOLVED: Should additional state be included?](#_resolved_should_additional_state_be_included)
- [5.2._RESOLVED:_Should_additional_state_be_included?](#_resolved_should_additional_state_be_included)
- [5.3. RESOLVED: What shader stages or pipeline states should be allowed to change?](#_resolved_what_shader_stages_or_pipeline_states_should_be_allowed_to_change)
- [5.3._RESOLVED:_What_shader_stages_or_pipeline_states_should_be_allowed_to_change?](#_resolved_what_shader_stages_or_pipeline_states_should_be_allowed_to_change)
...
- [5.5. RESOLVED: Should additional alignment properties be added?](#_resolved_should_additional_alignment_properties_be_added)
- [5.5._RESOLVED:_Should_additional_alignment_properties_be_added?](#_resolved_should_additional_alignment_properties_be_added)
- [5.6. RESOLVED: Should index type values be remappable?](#_resolved_should_index_type_values_be_remappable)
- [5.6._RESOLVED:_Should_index_type_values_be_remappable?](#_resolved_should_index_type_values_be_remappable)
- [5.7. RESOLVED: Should indirect buffers be reusable?](#_resolved_should_indirect_buffers_be_reusable)
- [5.7._RESOLVED:_Should_indirect_buffers_be_reusable?](#_resolved_should_indirect_buffers_be_reusable)
- [5.8. RESOLVED: How should commands with less than 32-bits of data be handled?](#_resolved_how_should_commands_with_less_than_32_bits_of_data_be_handled)
- [5.8._RESOLVED:_How_should_commands_with_less_than_32-bits_of_data_be_handled?](#_resolved_how_should_commands_with_less_than_32_bits_of_data_be_handled)
- [5.9. RESOLVED: How should applications provide data to the preprocess command in order for drivers to optimize indirect execution?](#_resolved_how_should_applications_provide_data_to_the_preprocess_command_in_order_for_drivers_to_optimize_indirect_execution)
- [5.9._RESOLVED:_How_should_applications_provide_data_to_the_preprocess_command_in_order_for_drivers_to_optimize_indirect_execution?](#_resolved_how_should_applications_provide_data_to_the_preprocess_command_in_order_for_drivers_to_optimize_indirect_execution)

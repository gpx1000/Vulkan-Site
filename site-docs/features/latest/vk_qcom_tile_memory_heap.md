...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_QCOM_tile_memory_heap.html
...
- [3.1. Tile Memory Heap](#_tile_memory_heap)
- [3.1._Tile_Memory_Heap](#_tile_memory_heap)
- [3.2. Properties](#_properties)
- [3.3. Binding Tile Memory](#_binding_tile_memory)
- [3.3._Binding_Tile_Memory](#_binding_tile_memory)
- [3.4. VkImages](#_vkimages)
- [3.5. VkBuffers](#_vkbuffers)
- [3.6. Tile memory Requirements](#_tile_memory_requirements)
- [3.6._Tile_memory_Requirements](#_tile_memory_requirements)
- [3.7. Allocating and aliasing tile memory](#_allocating_and_aliasing_tile_memory)
- [3.7._Allocating_and_aliasing_tile_memory](#_allocating_and_aliasing_tile_memory)
- [3.8. Interactions with VK_QCOM_tile_properties](#_interactions_with_vk_qcom_tile_properties)
- [3.8._Interactions_with_VK_QCOM_tile_properties](#_interactions_with_vk_qcom_tile_properties)
- [3.9. Interactions with VK_QCOM_tile_shading](#_interactions_with_vk_qcom_tile_shading)
- [3.9._Interactions_with_VK_QCOM_tile_shading](#_interactions_with_vk_qcom_tile_shading)
- [3.10. Forbidden Usage](#_forbidden_usage)
- [3.10._Forbidden_Usage](#_forbidden_usage)
- [4. Examples](#_examples)
- [4.1. Creating a tile memory VkImage](#_creating_a_tile_memory_vkimage)
- [4.1._Creating_a_tile_memory_VkImage](#_creating_a_tile_memory_vkimage)

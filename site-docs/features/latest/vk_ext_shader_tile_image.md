...
- [7. Issues](#_issues)
- [7.1. 1. RESOLVED: Should we allow early fragment tests?](#_1_resolved_should_we_allow_early_fragment_tests)
- [7.1._1._RESOLVED:_Should_we_allow_early_fragment_tests?](#_1_resolved_should_we_allow_early_fragment_tests)
- [7.2. 2. RESOLVED: Should depth / stencil fetch be a separate extension?](#_2_resolved_should_depth_stencil_fetch_be_a_separate_extension)
- [7.2._2._RESOLVED:_Should_depth_/_stencil_fetch_be_a_separate_extension?](#_2_resolved_should_depth_stencil_fetch_be_a_separate_extension)
- [7.3. 3. RESOLVED: What should we name these variables? What should the extension be named?](#_3_resolved_what_should_we_name_these_variables_what_should_the_extension_be_named)
- [7.3._3._RESOLVED:_What_should_we_name_these_variables?_What_should_the_extension_be_named?](#_3_resolved_what_should_we_name_these_variables_what_should_the_extension_be_named)
- [7.4. 4. RESOLVED: Are there any non-obvious interactions with the suspend/resume functionality in VK_KHR_dynamic_rendering?](#_4_resolved_are_there_any_non_obvious_interactions_with_the_suspendresume_functionality_in_vk_khr_dynamic_rendering)
- [7.4._4._RESOLVED:_Are_there_any_non-obvious_interactions_with_the_suspend/resume_functionality_in_VK_KHR_dynamic_rendering?](#_4_resolved_are_there_any_non_obvious_interactions_with_the_suspendresume_functionality_in_vk_khr_dynamic_rendering)
- [7.5. 5. RESOLVED: Enable / Disable raster order access](#_5_resolved_enable_disable_raster_order_access)
- [7.5._5._RESOLVED:_Enable_/_Disable_raster_order_access](#_5_resolved_enable_disable_raster_order_access)
- [7.6. 7. RESOLVED: Should this extension reuse OpTypeImage, or introduce a new type for declaring tile images?](#_7_resolved_should_this_extension_reuse_optypeimage_or_introduce_a_new_type_for_declaring_tile_images)
- [7.6._7._RESOLVED:_Should_this_extension_reuse_OpTypeImage,_or_introduce_a_new_type_for_declaring_tile_images?](#_7_resolved_should_this_extension_reuse_optypeimage_or_introduce_a_new_type_for_declaring_tile_images)
- [7.7. 8. RESOLVED: Should Color, Depth, and Stencil reads use the same SPIR-V opcode?](#_8_resolved_should_color_depth_and_stencil_reads_use_the_same_spir_v_opcode)
- [7.7._8._RESOLVED:_Should_Color,_Depth,_and_Stencil_reads_use_the_same_SPIR-V_opcode?](#_8_resolved_should_color_depth_and_stencil_reads_use_the_same_spir_v_opcode)
- [7.8. 9. RESOLVED: Should Depth and Stencil read opcodes consume an image operand specifying the attachment, or should it be implicit?](#_9_resolved_should_depth_and_stencil_read_opcodes_consume_an_image_operand_specifying_the_attachment_or_should_it_be_implicit)
- [7.8._9._RESOLVED:_Should_Depth_and_Stencil_read_opcodes_consume_an_image_operand_specifying_the_attachment,_or_should_it_be_implicit?](#_9_resolved_should_depth_and_stencil_read_opcodes_consume_an_image_operand_specifying_the_attachment_or_should_it_be_implicit)
- [7.9. 10. RESOLVED: Should this extension reuse the image Dim SubpassData or introduce a new Dim?](#_10_resolved_should_this_extension_reuse_the_image_dim_subpassdata_or_introduce_a_new_dim)
- [7.9._10._RESOLVED:_Should_this_extension_reuse_the_image_Dim_SubpassData_or_introduce_a_new_Dim?](#_10_resolved_should_this_extension_reuse_the_image_dim_subpassdata_or_introduce_a_new_dim)
- [7.10. 11. RESOLVED: Should this extension require applications to create and bind descriptors for tile images?](#_11_resolved_should_this_extension_require_applications_to_create_and_bind_descriptors_for_tile_images)
- [7.10._11._RESOLVED:_Should_this_extension_require_applications_to_create_and_bind_descriptors_for_tile_images?](#_11_resolved_should_this_extension_require_applications_to_create_and_bind_descriptors_for_tile_images)
- [7.11. 12. RESOLVED: What does 'undefined value' mean for tile image reads?](#_12_resolved_what_does_undefined_value_mean_for_tile_image_reads)
- [7.11._12._RESOLVED:_What_does_'undefined_value'_mean_for_tile_image_reads?](#_12_resolved_what_does_undefined_value_mean_for_tile_image_reads)

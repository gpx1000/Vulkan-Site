...
- **Component**: features
- **Version**: latest
- **URL**: /features/latest/features/proposals/VK_KHR_pipeline_binary.html
...
- [3.1.1. Obtaining and Using Key/Data Pairs](#_obtaining_and_using_keydata_pairs)
- [3.1.1._Obtaining_and_Using_Key/Data_Pairs](#_obtaining_and_using_keydata_pairs)
- [3.1.2. Features](#_features)
- [3.1.3. Properties](#properties)
- [pipelineBinaryInternalCache](#pipelineBinaryInternalCache)
- [pipelineBinaryInternalCacheControl](#_pipelinebinaryinternalcachecontrol)
- [pipelineBinaryPrefersInternalCache](#_pipelinebinaryprefersinternalcache)
- [pipelineBinaryPrecompiledInternalCache](#_pipelinebinaryprecompiledinternalcache)
- [pipelineBinaryCompressedData](#_pipelinebinarycompresseddata)
- [4. Examples](#_examples)
- [4.1. Retrieving the global key](#_retrieving_the_global_key)
- [4.1._Retrieving_the_global_key](#_retrieving_the_global_key)
- [4.2. Retrieving the key for a PipelineCreateInfo](#_retrieving_the_key_for_a_pipelinecreateinfo)
- [4.2._Retrieving_the_key_for_a_PipelineCreateInfo](#_retrieving_the_key_for_a_pipelinecreateinfo)
- [4.3. Create pipeline allowing for future binary creation](#_create_pipeline_allowing_for_future_binary_creation)
- [4.3._Create_pipeline_allowing_for_future_binary_creation](#_create_pipeline_allowing_for_future_binary_creation)
- [4.4. Get new binaries and store to application cache](#_get_new_binaries_and_store_to_application_cache)
- [4.4._Get_new_binaries_and_store_to_application_cache](#_get_new_binaries_and_store_to_application_cache)
- [4.5. Get binaries from application cache](#_get_binaries_from_application_cache)
- [4.5._Get_binaries_from_application_cache](#_get_binaries_from_application_cache)
- [4.6. Create binaries from application cache for a pipeline create info](#_create_binaries_from_application_cache_for_a_pipeline_create_info)
- [4.6._Create_binaries_from_application_cache_for_a_pipeline_create_info](#_create_binaries_from_application_cache_for_a_pipeline_create_info)
- [4.7. Create pipeline from binaries](#_create_pipeline_from_binaries)
- [4.7._Create_pipeline_from_binaries](#_create_pipeline_from_binaries)
- [4.8. Read internal cache for the pipeline binaries](#_read_internal_cache_for_the_pipeline_binaries)
- [4.8._Read_internal_cache_for_the_pipeline_binaries](#_read_internal_cache_for_the_pipeline_binaries)
...
`vkGetPipelineKeyKHR` works on any existing pipeline creation info structure (via `pNext` in `VkPipelineCreateInfoKHR`), allowing an application to obtain a pipeline key *before* creating a pipeline.
...
A new [VkResult](https://docs.vulkan.org/spec/latest/chapters/fundamentals.html#VkResult) value is added so that `vkCreatePipelineBinariesKHR` can indicate that an implementation supporting `pipelineBinaryInternalCache` [Properties](#properties) does not have a binary in its internal cache:

VK_PIPELINE_BINARY_MISSING_KHR = 1000483000

A new [VkResult](https://docs.vulkan.org/spec/latest/chapters/fundamentals.html#VkResult) value is added so that `vkGetPipelineBinaryDataKHR` can indicate that the application has not provided enough storage to write pipeline binary data into:

VK_ERROR_NOT_ENOUGH_SPACE_KHR = -1000483000

A new [VkPipelineCreateFlagBits2KHR](https://docs.vulkan.org/spec/latest/chapters/pipelines.html#VkPipelineCreateFlagBits2KHR) value is required to be able to obtain binary data from a pipeline object via this extension after creation:

...
- [5. Issues](#_issues)
- [5.1. RESOLVED: Why is there no VK_PIPELINE_STAGE_VIDEO_ENCODE_BIT_KHR?](#_resolved_why_is_there_no_vk_pipeline_stage_video_encode_bit_khr)
- [5.1._RESOLVED:_Why_is_there_no_VK_PIPELINE_STAGE_VIDEO_ENCODE_BIT_KHR?](#_resolved_why_is_there_no_vk_pipeline_stage_video_encode_bit_khr)
- [5.2. RESOLVED: How can layered codec-specific encode extensions enable applications to provide the necessary codec-specific picture information, parameter sets, etc. that may be needed to perform the video coding operations?](#_resolved_how_can_layered_codec_specific_encode_extensions_enable_applications_to_provide_the_necessary_codec_specific_picture_information_parameter_sets_etc_that_may_be_needed_to_perform_the_video_coding_operations)
- [5.2._RESOLVED:_How_can_layered_codec-specific_encode_extensions_enable_applications_to_provide_the_necessary_codec-specific_picture_information,_parameter_sets,_etc._that_may_be_needed_to_perform_the_video_coding_operations?](#_resolved_how_can_layered_codec_specific_encode_extensions_enable_applications_to_provide_the_necessary_codec_specific_picture_information_parameter_sets_etc_that_may_be_needed_to_perform_the_video_coding_operations)
- [5.3. RESOLVED: Can vkCmdVideoEncodeKHR only encode frames? What about field encoding, slice encoding, etc.?](#_resolved_can_vkcmdvideoencodekhr_only_encode_frames_what_about_field_encoding_slice_encoding_etc)
- [5.3._RESOLVED:_Can_vkCmdVideoEncodeKHR_only_encode_frames?_What_about_field_encoding,_slice_encoding,_etc.?](#_resolved_can_vkcmdvideoencodekhr_only_encode_frames_what_about_field_encoding_slice_encoding_etc)
- [5.4. RESOLVED: What is the effect of the flags provided in VkVideoEncodeUsageInfoKHR::videoUsageHints and VkVideoEncodeUsageInfoKHR::videoContentHints?](#_resolved_what_is_the_effect_of_the_flags_provided_in_vkvideoencodeusageinfokhrvideousagehints_and_vkvideoencodeusageinfokhrvideocontenthints)
- [5.4._RESOLVED:_What_is_the_effect_of_the_flags_provided_in_VkVideoEncodeUsageInfoKHR::videoUsageHints_and_VkVideoEncodeUsageInfoKHR::videoContentHints?](#_resolved_what_is_the_effect_of_the_flags_provided_in_vkvideoencodeusageinfokhrvideousagehints_and_vkvideoencodeusageinfokhrvideocontenthints)
- [5.5. RESOLVED: What is the effect of the tuning mode provided in VkVideoEncodeUsageInfoKHR::tuningMode?](#_resolved_what_is_the_effect_of_the_tuning_mode_provided_in_vkvideoencodeusageinfokhrtuningmode)
- [5.5._RESOLVED:_What_is_the_effect_of_the_tuning_mode_provided_in_VkVideoEncodeUsageInfoKHR::tuningMode?](#_resolved_what_is_the_effect_of_the_tuning_mode_provided_in_vkvideoencodeusageinfokhrtuningmode)
- [5.6. RESOLVED: How should we expose video encoding feedback values (e.g. encoded bitstream size)?](#_resolved_how_should_we_expose_video_encoding_feedback_values_e_g_encoded_bitstream_size)
- [5.6._RESOLVED:_How_should_we_expose_video_encoding_feedback_values_(e.g._encoded_bitstream_size)?](#_resolved_how_should_we_expose_video_encoding_feedback_values_e_g_encoded_bitstream_size)
- [5.7. RESOLVED: Do result status queries need to be used in conjunction with video encode feedback queries?](#_resolved_do_result_status_queries_need_to_be_used_in_conjunction_with_video_encode_feedback_queries)
- [5.7._RESOLVED:_Do_result_status_queries_need_to_be_used_in_conjunction_with_video_encode_feedback_queries?](#_resolved_do_result_status_queries_need_to_be_used_in_conjunction_with_video_encode_feedback_queries)
- [5.8. RESOLVED: Why is there a need to allow implementations to override codec-specific parameters?](#_resolved_why_is_there_a_need_to_allow_implementations_to_override_codec_specific_parameters)
- [5.8._RESOLVED:_Why_is_there_a_need_to_allow_implementations_to_override_codec-specific_parameters?](#_resolved_why_is_there_a_need_to_allow_implementations_to_override_codec_specific_parameters)
- [5.9. RESOLVED: Can the application disable all implementation overrides?](#_resolved_can_the_application_disable_all_implementation_overrides)
- [5.9._RESOLVED:_Can_the_application_disable_all_implementation_overrides?](#_resolved_can_the_application_disable_all_implementation_overrides)
- [5.10. RESOLVED: Can implementations override any codec-specific parameter?](#_resolved_can_implementations_override_any_codec_specific_parameter)
- [5.10._RESOLVED:_Can_implementations_override_any_codec-specific_parameter?](#_resolved_can_implementations_override_any_codec_specific_parameter)
- [5.11. RESOLVED: Do all implementations have to implement the same rate control algorithms corresponding to the rate control modes defined by this proposal?](#_resolved_do_all_implementations_have_to_implement_the_same_rate_control_algorithms_corresponding_to_the_rate_control_modes_defined_by_this_proposal)
- [5.11._RESOLVED:_Do_all_implementations_have_to_implement_the_same_rate_control_algorithms_corresponding_to_the_rate_control_modes_defined_by_this_proposal?](#_resolved_do_all_implementations_have_to_implement_the_same_rate_control_algorithms_corresponding_to_the_rate_control_modes_defined_by_this_proposal)
- [5.12. RESOLVED: Do rate control implementations guarantee to respect the average/max bitrates, or frame sizes configured for the video session?](#_resolved_do_rate_control_implementations_guarantee_to_respect_the_averagemax_bitrates_or_frame_sizes_configured_for_the_video_session)
- [5.12._RESOLVED:_Do_rate_control_implementations_guarantee_to_respect_the_average/max_bitrates,_or_frame_sizes_configured_for_the_video_session?](#_resolved_do_rate_control_implementations_guarantee_to_respect_the_averagemax_bitrates_or_frame_sizes_configured_for_the_video_session)
- [5.13. RESOLVED: Are video session parameters objects dependent on the used video encode quality level?](#_resolved_are_video_session_parameters_objects_dependent_on_the_used_video_encode_quality_level)
- [5.13._RESOLVED:_Are_video_session_parameters_objects_dependent_on_the_used_video_encode_quality_level?](#_resolved_are_video_session_parameters_objects_dependent_on_the_used_video_encode_quality_level)
- [5.14. RESOLVED: Are video encode quality levels and rate control mutually exclusive?](#_resolved_are_video_encode_quality_levels_and_rate_control_mutually_exclusive)
- [5.14._RESOLVED:_Are_video_encode_quality_levels_and_rate_control_mutually_exclusive?](#_resolved_are_video_encode_quality_levels_and_rate_control_mutually_exclusive)
- [5.15. RESOLVED: Does specifying VkVideoEncodeRateControlInfoKHR in the pNext chain of the pBeginCodingInfo parameter of vkCmdBeginVideoCodingKHR change the current rate control configuration?](#_resolved_does_specifying_vkvideoencoderatecontrolinfokhr_in_the_pnext_chain_of_the_pbegincodinginfo_parameter_of_vkcmdbeginvideocodingkhr_change_the_current_rate_control_configuration)
- [5.15._RESOLVED:_Does_specifying_VkVideoEncodeRateControlInfoKHR_in_the_pNext_chain_of_the_pBeginCodingInfo_parameter_of_vkCmdBeginVideoCodingKHR_change_the_current_rate_control_configuration?](#_resolved_does_specifying_vkvideoencoderatecontrolinfokhr_in_the_pnext_chain_of_the_pbegincodinginfo_parameter_of_vkcmdbeginvideocodingkhr_change_the_current_rate_control_configuration)
- [5.16. RESOLVED: When is it mandatory to specify reconstructed picture information in VkVideoEncodeInfoKHR::pSetupReferenceSlot?](#_resolved_when_is_it_mandatory_to_specify_reconstructed_picture_information_in_vkvideoencodeinfokhrpsetupreferenceslot)
- [5.16._RESOLVED:_When_is_it_mandatory_to_specify_reconstructed_picture_information_in_VkVideoEncodeInfoKHR::pSetupReferenceSlot?](#_resolved_when_is_it_mandatory_to_specify_reconstructed_picture_information_in_vkvideoencodeinfokhrpsetupreferenceslot)

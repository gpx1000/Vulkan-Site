...
- [Acquiring an image from the swap chain](#_acquiring_an_image_from_the_swap_chain)
- [Acquiring_an_image_from_the_swap_chain](#_acquiring_an_image_from_the_swap_chain)
...
[C++ code](../../_attachments/15_hello_triangle.cpp) / [Vertex shader](../../_attachments/09_shader_base.vert) / [Fragment shader](../../_attachments/09_shader_base.frag)

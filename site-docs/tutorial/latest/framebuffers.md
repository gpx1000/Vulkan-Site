...
In the [next chapter](01_Command_buffers.html) we’re going to write the first actual drawing commands.

[C++ code](../../_attachments/13_framebuffers.cpp) / [Vertex shader](../../_attachments/09_shader_base.vert) / [Fragment shader](../../_attachments/09_shader_base.frag)

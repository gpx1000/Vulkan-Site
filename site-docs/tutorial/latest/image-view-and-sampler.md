...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/06_Texture_mapping/01_Image_view_and_sampler.html

## Table of Contents

- [Texture image view](#_texture_image_view)
- [Texture_image_view](#_texture_image_view)
- [Samplers](#_samplers)
- [Anisotropy device feature](#_anisotropy_device_feature)
- [Anisotropy_device_feature](#_anisotropy_device_feature)
...
![anisotropic filtering](../_images/images/anisotropic_filtering.png)

As shown in the left image, the texture turns into a blurry mess in the distance.
The solution to this is [anisotropic filtering](https://en.wikipedia.org/wiki/Anisotropic_filtering), which can also be applied automatically by a sampler.
...
We will look at mipmapping in a [later chapter](/Generating_Mipmaps), but basically it’s another type of filter that can be applied.
...
![validation layer anisotropy](../_images/images/validation_layer_anisotropy.png)

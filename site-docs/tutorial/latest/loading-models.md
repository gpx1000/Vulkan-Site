...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/08_Loading_models.html

## Table of Contents

- [Introduction](#_introduction)
- [Library](#_library)
- [Sample mesh](#_sample_mesh)
- [Loading vertices and indices](#_loading_vertices_and_indices)
- [Loading_vertices_and_indices](#_loading_vertices_and_indices)
- [Vertex deduplication](#_vertex_deduplication)
...
![inverted texture coordinates](_images/images/inverted_texture_coordinates.png)
...
![drawing model](_images/images/drawing_model.png)
...
A hash function for `Vertex` is implemented by specifying a template specialization for `std::hash`.
Hash functions are a complex topic, but [cppreference.com recommends](https://en.cppreference.com/w/cpp/utility/hash) the following approach combining the fields of a struct to create a decent quality hash function:

...
vk::ShaderModuleCreateInfo createInfo{ .codeSize = code.size() * sizeof(char), .pCode = reinterpret_cast(code.data()) };
...
[C++ code](../../_attachments/09_shader_modules.cpp) /

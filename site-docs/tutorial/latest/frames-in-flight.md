...
In the [next chapter](../04_Swap_chain_recreation.html) we’ll deal with one more small thing that is required for a well-behaved Vulkan program.

[C++ code](../../_attachments/16_frames_in_flight.cpp) / [Vertex shader](../../_attachments/09_shader_base.vert) / [Fragment shader](../../_attachments/09_shader_base.frag)

...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/03_Drawing_a_triangle/02_Graphics_pipeline_basics/00_Introduction.html
...
![vulkan simplified pipeline](../../_images/images/vulkan_simplified_pipeline.svg)
...
If you are only interested in depth values then you can disable the fragment shader stage, which is useful for [shadow map](https://en.wikipedia.org/wiki/Shadow_mapping) generation.
...
The [next chapter](01_Shader_modules.html) will talk about shader modules required to actually put something on the screen.

[C++ code](../../_attachments/08_graphics_pipeline.cpp)

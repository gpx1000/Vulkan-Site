...
The requirements for compatibility are described [here](https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/chap8.html#renderpass-compatibility), but we won’t be using that feature in this tutorial.
...
In the [next couple of chapters](../03_Drawing/00_Framebuffers.html) we’ll set up the actual framebuffers from the swap chain images and prepare the drawing commands.

[C++ code](../../_attachments/12_graphics_pipeline_complete.cpp) / [Vertex shader](../../_attachments/09_shader_base.vert) / [Fragment shader](../../_attachments/09_shader_base.frag)

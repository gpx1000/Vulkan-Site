...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/04_Vertex_buffers/02_Staging_buffer.html

## Table of Contents

- [Introduction](#_introduction)
- [Transfer queue](#_transfer_queue)
- [Abstracting buffer creation](#_abstracting_buffer_creation)
- [Abstracting_buffer_creation](#_abstracting_buffer_creation)
- [Using a staging buffer](#_using_a_staging_buffer)
- [Using_a_staging_buffer](#_using_a_staging_buffer)
...
[C++ code](../_attachments/20_staging_buffer.cpp) / [Vertex shader](../_attachments/18_shader_vertexbuffer.vert) / [Fragment shader](../_attachments/18_shader_vertexbuffer.frag)

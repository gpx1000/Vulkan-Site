...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/03_Drawing_a_triangle/02_Graphics_pipeline_basics/03_Render_passes.html

## Table of Contents

- [Setup](#_setup)
- [Attachment description](#_attachment_description)
- [Subpasses and attachment references](#_subpasses_and_attachment_references)
- [Subpasses_and_attachment_references](#_subpasses_and_attachment_references)
- [Render pass](#_render_pass)
...
That was a lot of work, but in the [next chapter](04_Conclusion.html) it all comes together to finally create the graphics pipeline object!

[C++ code](../../_attachments/11_render_passes.cpp) / [Vertex shader](../../_attachments/09_shader_base.vert) / [Fragment shader](../../_attachments/09_shader_base.frag)

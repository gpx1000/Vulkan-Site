...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/03_Drawing_a_triangle/02_Graphics_pipeline_basics/02_Fixed_functions.html

## Table of Contents

- [Dynamic state](#_dynamic_state)
- [Vertex input](#_vertex_input)
- [Input assembly](#_input_assembly)
- [Viewports and scissors](#_viewports_and_scissors)
- [Viewports_and_scissors](#_viewports_and_scissors)
- [Rasterizer](#_rasterizer)
- [Multisampling](#_multisampling)
- [Depth and stencil testing](#_depth_and_stencil_testing)
- [Depth_and_stencil_testing](#_depth_and_stencil_testing)
- [Color blending](#_color_blending)
...
![viewports scissors](../../_images/images/viewports_scissors.png)
...
The `VkPipelineMultisampleStateCreateInfo` struct configures multisampling, which is one of the ways to perform [anti-aliasing](https://en.wikipedia.org/wiki/Multisample_anti-aliasing).
...
The structure also specifies *push constants*, which are another way of passing dynamic values to shaders that we may get into in a future chapter.
...
There is however one more object to create before we can finally create the graphics pipeline and that is a [render pass](03_Render_passes.html).

[C++ code](../../_attachments/10_fixed_functions.cpp) / [Vertex shader](../../_attachments/09_shader_base.vert) / [Fragment shader](../../_attachments/09_shader_base.frag)

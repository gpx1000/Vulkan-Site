...
- **Component**: tutorial
- **Version**: latest
- **URL**: /tutorial/latest/03_Drawing_a_triangle/00_Setup/02_Validation_layers.html

## Table of Contents

- [What are validation layers?](#_what_are_validation_layers)
...
- [Debugging instance creation and destruction](#_debugging_instance_creation_and_destruction)
- [Debugging_instance_creation_and_destruction](#_debugging_instance_creation_and_destruction)
- [Testing](#_testing)
...
They’re also completely [open source](https://github.com/KhronosGroup/Vulkan-ValidationLayers), so you can check which kind of mistakes they check for and contribute.
...
Its usage is identical to that of `vkEnumerateInstanceExtensionProperties` which was discussed in the instance creation chapter. Next, check if all of the layers in `validationLayers` exist in the `availableLayers` list. You may need to include `` for `strcmp`.
...
Such a callback is part of a *debug messenger* and you can have as many of them as you want.
...
See the [extension specification](https://www.khronos.org/registry/vulkan/specs/1.3-extensions/html/chap50.html#VK_EXT_debug_utils) for more info about the possibilities.
...
However, if you closely read the [extension documentation](https://github.com/KhronosGroup/Vulkan-Docs/blob/main/appendices/VK_EXT_debug_utils.adoc#examples), you’ll see that there is a way to create a separate debug utils messenger specifically for those two function calls.
...
![validation layer test](../../_images/images/validation_layer_test.png)

> 

If you don’t see any messages then [check your installation](https://vulkan.lunarg.com/doc/view/1.3.280.0/windows/getting_started.html#user-content-verify-the-installation).
...
Now it’s time to look at [Vulkan devices in the system](03_Physical_devices_and_queue_families.html).

[C++ code](../../_attachments/02_validation_layers.cpp)

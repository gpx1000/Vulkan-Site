...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/conditional_rendering/README.html

## Table of Contents

- [Overview](#_overview)
- [Conditional buffer](#_conditional_buffer)
- [Conditional execution](#_conditional_execution)
...
![Buffer mapping](../../../_images/samples/extensions/conditional_rendering/images/conditional-buffer-mapping.png)
...
for (auto &node : linear_scene_nodes)
{
    ...
    auto mat = dynamic_cast(node.sub_mesh->get_material());

...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/mesh_shader_culling/README.html

## Table of Contents

- [Overview](#_overview)
- [Contents](#_contents)
- [Enabling mesh shading](#_enabling_mesh_shading)
- [Enabling_mesh_shading](#_enabling_mesh_shading)
- [Pipeline Creation](#_pipeline_creation)
- [Linking resources](#_linking_resources)
- [Task Shader](#_task_shader)
- [Mesh Shader](#_mesh_shader)
- [Per-primitive culling](#_per_primitive_culling)
...
The only time one wouldn’t use them is for  very simplistic scenes such as rendering a single triangle found in the [mesh shader sample](../mesh_shading).
...
[Mesh Shading For Vulkan](https://www.khronos.org/blog/mesh-shading-for-vulkan) [Introduction to Turing Mesh Shaders](https://developer.nvidia.com/blog/introduction-turing-mesh-shaders/)

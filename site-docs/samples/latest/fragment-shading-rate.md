...
![Rendered image](../../../_images/samples/extensions/fragment_shading_rate_dynamic/rendered.png)
...
![Frequency information](../../../_images/samples/extensions/fragment_shading_rate_dynamic/frequency.png)

Shading rates are encoded using 8-bit unsigned integers.
For instance, the lowest shading rate of a 4x4 texel is given by: `(4>>1) | (4>1)|(rate_y
...
![Shading rate image](../../../_images/samples/extensions/fragment_shading_rate_dynamic/shading_rate.png)
...
uint rate_code = uint(optimal_rate_x >> 1) | (optimal_rate_y 
...
![Diagram of renderpass](../../../_images/samples/extensions/fragment_shading_rate_dynamic/diagram.png)

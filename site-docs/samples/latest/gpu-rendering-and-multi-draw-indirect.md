...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/performance/multi_draw_indirect/README.html

## Table of Contents

- [Draw Call Generation](#_draw_call_generation)
- [Draw_Call_Generation](#_draw_call_generation)
- [CPU vs. GPU Call Generation](#_cpu_vs_gpu_call_generation)
- [CPU_vs._GPU_Call_Generation](#_cpu_vs_gpu_call_generation)
- [Texture / Resource Access](#_texture_resource_access)
- [Texture_/_Resource_Access](#_texture_resource_access)
...
{
    for (size_t j = 0; j get_handle(), j * sizeof(cpu_commands[0]), 1, sizeof(cpu_commands[0]));
    }
}

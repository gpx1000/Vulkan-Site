...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/host_image_copy/README.html
...
- [Checking for image format support](#_checking_for_image_format_support)
- [Checking_for_image_format_support](#_checking_for_image_format_support)
- [Setting up the image](#_setting_up_the_image)
- [Setting_up_the_image](#_setting_up_the_image)
- [Simplified image layout transitions](#_simplified_image_layout_transitions)
- [Simplified_image_layout_transitions](#_simplified_image_layout_transitions)
- [Copy image data from host to image](#_copy_image_data_from_host_to_image)
- [Copy_image_data_from_host_to_image](#_copy_image_data_from_host_to_image)
...
copy_memory_info.regionCount    = static_cast(memory_to_image_copies.size());
...
* 
[Copying Images on the Host in Vulkan](https://www.khronos.org/blog/copying-images-on-the-host-in-vulkan)

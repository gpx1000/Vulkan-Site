...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/dynamic_primitive_clipping/README.html

## Table of Contents

- [Overview](#_overview)
- [What is primitive clipping](#_what_is_primitive_clipping)
- [What_is_primitive_clipping](#_what_is_primitive_clipping)
- [What is depth clipping](#_what_is_depth_clipping)
- [What_is_depth_clipping](#_what_is_depth_clipping)
- [How to apply primitive clipping in Vulkan](#_how_to_apply_primitive_clipping_in_vulkan)
- [How_to_apply_primitive_clipping_in_Vulkan](#_how_to_apply_primitive_clipping_in_vulkan)
- [How to apply depth clipping in Vulkan](#_how_to_apply_depth_clipping_in_vulkan)
- [How_to_apply_depth_clipping_in_Vulkan](#_how_to_apply_depth_clipping_in_vulkan)
- [Potential applications](#_potential_applications)

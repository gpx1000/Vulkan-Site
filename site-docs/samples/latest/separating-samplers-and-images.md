...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/api/separate_image_sampler/README.html
...
vkUpdateDescriptorSets(get_device().get_handle(), static_cast(write_descriptor_sets.size()), write_descriptor_sets.data(), 0, nullptr);

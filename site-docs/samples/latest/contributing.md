...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/CONTRIBUTING.html

## Table of Contents

- [Quality Checks](#_quality_checks)
- [Repository Structure](#_repository_structure)
- [Creating a sample](#_creating_a_sample)
- [Creating_a_sample](#_creating_a_sample)
- [General Requirements](#_general_requirements)
- [Copyright Notice and License Template](#_copyright_notice_and_license_template)
- [Copyright_Notice_and_License_Template](#_copyright_notice_and_license_template)
- [Code Style](#_code_style)
- [Procedure for Contributing](#_procedure_for_contributing)
- [Procedure_for_Contributing](#_procedure_for_contributing)
- [Code Reviews](#_code_reviews)
...
To make this process as painless for contributors as possible we use [pre-commit](#https://pre-commit.com/). To install pre-commit and the hooks for this repository, run the following commands:
...
A common code style like, for instance, the one described by the [Google C++ Style Guide](https://google.github.io/styleguide/cppguide.html) is recommended.

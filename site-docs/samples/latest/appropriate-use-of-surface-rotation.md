...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/performance/surface_rotation/README.html

## Table of Contents

- [Overview](#_overview)
- [Pre-rotation](#_pre_rotation)
- [Demo application](#_demo_application)
- [Rotation in Android](#_rotation_in_android)
- [Rotation_in_Android](#_rotation_in_android)
- [Swapchain re-creation](#_swapchain_re_creation)
- [Rotating the scene](#_rotating_the_scene)
- [Rotating_the_scene](#_rotating_the_scene)
...
![Pre-rotation](../../../_images/samples/performance/surface_rotation/images/rotation_cases.jpg)
...
{
	auto platform = reinterpret_cast(app->userData);
...
void on_content_rect_changed(ANativeActivity *activity, const ARect *rect)
{
	...
	struct android_app *app = reinterpret_cast(activity->instance);
...
swapchain = std::make_unique(*swapchain, VkExtent2D{width, height}, transform);
...
![Android compositor handling the rotation](../../../_images/samples/performance/surface_rotation/images/android_compositor.jpg)

Compare this to the same scene rendered using pre-rotation:

![Pre-rotating the scene](../../../_images/samples/performance/surface_rotation/images/android_prerotation.jpg)

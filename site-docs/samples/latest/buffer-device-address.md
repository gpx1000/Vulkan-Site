...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/buffer_device_address/README.html

## Table of Contents

- [Overview](#_overview)
- [Creating a buffer](#_creating_a_buffer)
- [Creating_a_buffer](#_creating_a_buffer)
- [Vulkan GLSL](#_vulkan_glsl)
- [Lack of robustness](#_lack_of_robustness)
- [Lack_of_robustness](#_lack_of_robustness)
- [SPIR-V](#_spir_v)
- [Addressing mode](#_addressing_mode)
- [Alignment tags](#_alignment_tags)
- [Casting pointers](#_casting_pointers)
- [Casting to and from integers, pointer arithmetic](#_casting_to_and_from_integers_pointer_arithmetic)
- [Casting_to_and_from_integers,_pointer_arithmetic](#_casting_to_and_from_integers_pointer_arithmetic)
- [The sample](#_the_sample)
- [Debugging notes](#_debugging_notes)
...
![Sample](../../../_images/samples/extensions/buffer_device_address/images/sample.png)

...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/logic_op_dynamic_state/README.html

## Table of Contents

- [Overview](#_overview)
- [Surface format setting](#_surface_format_setting)
- [Surface_format_setting](#_surface_format_setting)
- [Enabling logical operations in pipeline creation](#_enabling_logical_operations_in_pipeline_creation)
- [Enabling_logical_operations_in_pipeline_creation](#_enabling_logical_operations_in_pipeline_creation)
- [Logical operation dynamic setting in command buffer creation](#_logical_operation_dynamic_setting_in_command_buffer_creation)
- [Logical_operation_dynamic_setting_in_command_buffer_creation](#_logical_operation_dynamic_setting_in_command_buffer_creation)
- [Enabling the required extensions](#_enabling_the_required_extensions)
- [Enabling_the_required_extensions](#_enabling_the_required_extensions)
...
auto surface_priority_list = std::vector{
...
std::vector dynamic_state_enables_background = {
    VK_DYNAMIC_STATE_VIEWPORT,
    VK_DYNAMIC_STATE_SCISSOR,
};
...
vkCmdSetLogicOpEXT(draw_cmd_buffer, static_cast(gui_settings.selected_operation));
...
auto &requested_extended_dynamic_state2_features =
	gpu.request_extension_features(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_2_FEATURES_EXT);
...
auto &requested_extended_dynamic_state_feature =
	gpu.request_extension_features(VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT);

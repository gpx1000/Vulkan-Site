...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/performance/descriptor_management/README.html

## Table of Contents

- [Overview](#_overview)
- [The problem](#_the_problem)
- [Caching descriptor sets](#_caching_descriptor_sets)
- [Caching_descriptor_sets](#_caching_descriptor_sets)
...
In the worst cases, for example calling [vkUpdateDescriptorSets()](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/vkUpdateDescriptorSets.html) for each draw call, the time it takes to update descriptors can be longer than the time of the draws themselves.

![Basic descriptor set management](../../../_images/samples/performance/descriptor_management/images/bonza_no_caching_multiple_buf.jpg)
...
Instead of calling [vkResetDescriptorPool()](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/vkResetDescriptorPool.html) every frame, the app will keep the `VkDescriptorSet` handles stored with some caching mechanism to access them.
...
![Descriptor set caching](../../../_images/samples/performance/descriptor_management/images/bonza_caching_multiple_buf.jpg)
...
![Streamline analysis](../../../_images/samples/performance/descriptor_management/images/streamline_desc_caching.png)
...
The [subpasses sample](../subpasses/README.html) uses this approach when it re-creates the G-buffer images.
...
![Using one large VkBuffer](../../../_images/samples/performance/descriptor_management/images/bonza_no_caching_single_buf.jpg)
...
* 
The time spent in [vkUpdateDescriptorSets()](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/vkUpdateDescriptorSets.html) can be checked with a CPU profiler.

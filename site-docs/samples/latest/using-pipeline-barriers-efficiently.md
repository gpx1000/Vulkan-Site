...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/performance/pipeline_barriers/README.html

## Table of Contents

- [Overview](#_overview)
- [Tile-based rendering](#_tile_based_rendering)
- [Choosing pipeline stages](#_choosing_pipeline_stages)
- [Choosing_pipeline_stages](#_choosing_pipeline_stages)
...
![Traditional Approach](../../../_images/samples/performance/pipeline_barriers/images/immediate_mode_rendering.png)
...
![Tile-based Approach](../../../_images/samples/performance/pipeline_barriers/images/tile_based_rendering.png)
...
![Mali’s three stage pipeline](../../../_images/samples/performance/pipeline_barriers/images/mali_three_stage_pipeline.png)
...
see [the subpasses tutorial](../subpasses/README.html) for more detail.
...
![Sample - Bottom to Top](../../../_images/samples/performance/pipeline_barriers/images/sample_bot_to_top.jpg)
...
![Sample - Frag to vert](../../../_images/samples/performance/pipeline_barriers/images/sample_frag_to_vert.jpg)
...
![Sample - Frag to frag](../../../_images/samples/performance/pipeline_barriers/images/sample_frag_to_frag.jpg)
...
* 
If on a Mali GPU, use [Streamline Performance Analyzer](https://developer.arm.com/tools-and-software/embedded/arm-development-studio/components/streamline-performance-analyzer) to visualize the Arm CPU and GPU activity on both GPU hardware slots.

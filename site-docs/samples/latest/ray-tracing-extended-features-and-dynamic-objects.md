...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/ray_tracing_extended/README.html

## Table of Contents

- [Acceleration structures](#_acceleration_structures)
- [Objects: Static, moving, and changing](#_objects_static_moving_and_changing)
- [Objects:_Static,_moving,_and_changing](#_objects_static_moving_and_changing)
- [Reference Object Data from a Closest-Hit Shader](#_reference_object_data_from_a_closest_hit_shader)
- [Reference_Object_Data_from_a_Closest-Hit_Shader](#_reference_object_data_from_a_closest_hit_shader)
- [Texture Binding and Shaders](#_texture_binding_and_shaders)
- [Texture_Binding_and_Shaders](#_texture_binding_and_shaders)
- [Ambient Occlusion and Ray-Traced Shadows](#_ambient_occlusion_and_ray_traced_shadows)
- [Ambient_Occlusion_and_Ray-Traced_Shadows](#_ambient_occlusion_and_ray_traced_shadows)
...
*Per-primitive level*  In this sample, each vertex is encoded with a per-vertex normal and texture coordinate, though other applications may wish to provide other information at the per-vertex level.

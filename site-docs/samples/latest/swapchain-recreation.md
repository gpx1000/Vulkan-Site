...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/api/swapchain_recreation/README.html

## Table of Contents

- [Swapchain recreation](#_swapchain_recreation)
- [VK_EXT_swapchain_maintenance1](#_vk_ext_swapchain_maintenance1)
...
In this sample, a workaround is implemented where a fence signaled by vkAcquireNextImageKHR is used to determine when the *previous* present job involving the same image index has been completed.

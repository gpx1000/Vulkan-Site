...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/performance/16bit_arithmetic/README.html

## Table of Contents

- [Overview](#_overview)
- [Enable 16-bit floating-point arithmetic support](#_enable_16_bit_floating_point_arithmetic_support)
- [Enable_16-bit_floating-point_arithmetic_support](#_enable_16_bit_floating_point_arithmetic_support)
- [8-bit arithmetic?](#_8_bit_arithmetic)
- [16-bit integers?](#_16_bit_integers)
- [Enable 16-bit storage support](#_enable_16_bit_storage_support)
- [Enable_16-bit_storage_support](#_enable_16_bit_storage_support)
- [The 16-bit arithmetic sample](#_the_16_bit_arithmetic_sample)
- [The_16-bit_arithmetic_sample](#_the_16_bit_arithmetic_sample)
- [Explicit 16-bit arithmetic vs. mediump / RelaxedPrecision](#_explicit_16_bit_arithmetic_vs_mediump_relaxedprecision)
- [Explicit_16-bit_arithmetic_vs._mediump_/_RelaxedPrecision](#_explicit_16_bit_arithmetic_vs_mediump_relaxedprecision)
- [The hidden benefit of FP16, reducing register pressure](#_the_hidden_benefit_of_fp16_reducing_register_pressure)
- [The_hidden_benefit_of_FP16,_reducing_register_pressure](#_the_hidden_benefit_of_fp16_reducing_register_pressure)
...
![32-bit arithmetic](../../../_images/samples/performance/16bit_arithmetic/images/blobs_result_fp32.jpg)
...
![16-bit arithmetic](../../../_images/samples/performance/16bit_arithmetic/images/blobs_result_fp16.jpg)

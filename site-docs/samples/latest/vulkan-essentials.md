...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/vulkan_basics.html

## Table of Contents

- [Low level graphics for power users](#_low_level_graphics_for_power_users)
- [Low_level_graphics_for_power_users](#_low_level_graphics_for_power_users)
- [OpenGL ES vs. Vulkan](#_opengl_es_vs_vulkan)
- [OpenGL_ES_vs._Vulkan](#_opengl_es_vs_vulkan)
- [State management](#_state_management)
- [API execution model](#_api_execution_model)
- [API_execution_model](#_api_execution_model)
- [API threading model](#_api_threading_model)
- [API_threading_model](#_api_threading_model)
- [API error checking](#_api_error_checking)
- [API_error_checking](#_api_error_checking)
- [Render pass abstraction](#_render_pass_abstraction)
- [Render_pass_abstraction](#_render_pass_abstraction)

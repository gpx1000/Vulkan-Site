...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/open_cl_interop_arm/README.html

## Table of Contents

- [Overview](#_overview)
- [Data sharing](#_data_sharing)
- [Android Hardware Buffers](#_android_hardware_buffers)
- [Android_Hardware_Buffers](#_android_hardware_buffers)
- [Support by Vulkan API](#_support_by_vulkan_api)
- [Support_by_Vulkan_API](#_support_by_vulkan_api)
- [Export from Vulkan API](#_export_from_vulkan_api)
- [Export_from_Vulkan_API](#_export_from_vulkan_api)
- [Import to Vulkan API](#_import_to_vulkan_api)
- [Import_to_Vulkan_API](#_import_to_vulkan_api)
- [Support by OpenCL](#_support_by_opencl)
- [Support_by_OpenCL](#_support_by_opencl)
...
![Sample](../../../_images/samples/extensions/open_cl_interop_arm/images/sample.png)

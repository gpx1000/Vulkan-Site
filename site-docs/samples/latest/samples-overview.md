...
- [Swapchain present timing](#_swapchain_present_timing)
- [Swapchain_present_timing](#_swapchain_present_timing)
...
- [Shader Relaxed Extended Instruction](#_shader_relaxed_extended_instruction)
- [Shader_Relaxed_Extended_Instruction](#_shader_relaxed_extended_instruction)
...
- [Descriptor buffer](#_descriptor_buffer)
- [Descriptor heap](#_descriptor_heap)
...
- [Shader quad control](#_shader_quad_control)
- [Shader_quad_control](#_shader_quad_control)
- [Compute shader derivatives](#_compute_shader_derivatives)
- [Compute_shader_derivatives](#_compute_shader_derivatives)
...
**Extension**: [`VK_KHR_shader_relaxed_extended_instruction`](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_KHR_shader_relaxed_extended_instruction)
...
**Extension**: [`VK_KHR_pipeline_binaries`](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_KHR_pipeline_binary)
...
**Extension**: [`VK_EXT_descriptor_heap`](https://www.khronos.org/registry/vulkan/specs/latest/html/vkspec.html#VK_ext_descriptor_heap)
...
[tensor_image_aliasing](extensions/tensor_and_data_graph/tensor_image_aliasing/README.html)

* 
Explains how to implement zero-copy data exchange between tensors and images through aliasing.

[postprocessing_with_vgf](extensions/tensor_and_data_graph/postprocessing_with_vgf/README.html)
...
**Extension**: [`VK_KHR_shader_quad_control`](https://registry.khronos.org/vulkan/specs/1.3-extensions/man/html/VK_KHR_shader_quad_control.html)
...
**Extension**: [`VK_KHR_compute_shader_derivatives`](https://docs.vulkan.org/features/latest/features/proposals/VK_KHR_compute_shader_derivatives.html)

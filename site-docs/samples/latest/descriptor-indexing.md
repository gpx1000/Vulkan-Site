...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/extensions/descriptor_indexing/README.html

## Table of Contents

- [Overview](#_overview)
- [Use cases](#_use_cases)
- [Update-After-Bind, streaming descriptors concurrently](#_update_after_bind_streaming_descriptors_concurrently)
- [Update-After-Bind,_streaming_descriptors_concurrently](#_update_after_bind_streaming_descriptors_concurrently)
- [Concurrent updates](#_concurrent_updates)
- [Descriptor flags](#_descriptor_flags)
- [Non-uniform indexing, enabling advanced algorithms](#_non_uniform_indexing_enabling_advanced_algorithms)
- [Non-uniform_indexing,_enabling_advanced_algorithms](#_non_uniform_indexing_enabling_advanced_algorithms)
- [The different levels of indexing resources](#_the_different_levels_of_indexing_resources)
- [The_different_levels_of_indexing_resources](#_the_different_levels_of_indexing_resources)
- [Constant indexing](#_constant_indexing)
- [Dynamic indexing](#_dynamic_indexing)
- [Non-uniform indexing](#_non_uniform_indexing)
- [Non-uniform indexing vs. texture atlas vs. texture array](#_non_uniform_indexing_vs_texture_atlas_vs_texture_array)
- [Non-uniform_indexing_vs._texture_atlas_vs._texture_array](#_non_uniform_indexing_vs_texture_atlas_vs_texture_array)
- [Not just textures](#_not_just_textures)
- [Not_just_textures](#_not_just_textures)
- [When to use non-uniform indexing qualifier](#_when_to_use_non_uniform_indexing_qualifier)
- [When_to_use_non-uniform_indexing_qualifier](#_when_to_use_non_uniform_indexing_qualifier)
- [The invocation group](#_the_invocation_group)
- [The_invocation_group](#_the_invocation_group)
- [How do subgroups interact here?](#_how_do_subgroups_interact_here)
- [How_do_subgroups_interact_here?](#_how_do_subgroups_interact_here)
- [Vulkan GLSL examples](#_vulkan_glsl_examples)
- [Vulkan_GLSL_examples](#_vulkan_glsl_examples)
- [HLSL examples](#_hlsl_examples)
- [What to look for in SPIR-V](#_what_to_look_for_in_spir_v)
- [What_to_look_for_in_SPIR-V](#_what_to_look_for_in_spir_v)
- [The sample](#_the_sample)
- [Debugging descriptor indexing](#_debugging_descriptor_indexing)
- [Debugging_descriptor_indexing](#_debugging_descriptor_indexing)
- [RenderDoc](#_renderdoc)
- [GPU assisted validation](#_gpu_assisted_validation)
- [GPU_assisted_validation](#_gpu_assisted_validation)
...
ConstantBuffer CBV[] : register(b0, space2);
RWStructuredBuffer SSBO[] : register(u0, space3);
RWTexture2D Img[] : register(u0, space4);
...
![Sample](../../../_images/samples/extensions/descriptor_indexing/images/sample.png)
...
![non-uniform-draw](../../../_images/samples/extensions/descriptor_indexing/images/non-uniform-draw.png)
...
![non-uniform-usage](../../../_images/samples/extensions/descriptor_indexing/images/non-uniform-usage.png)
...
![update-after-bind](../../../_images/samples/extensions/descriptor_indexing/images/update-after-bind.png)
...
std::vector available_layer_instance_extensions(layer_instance_extension_count);

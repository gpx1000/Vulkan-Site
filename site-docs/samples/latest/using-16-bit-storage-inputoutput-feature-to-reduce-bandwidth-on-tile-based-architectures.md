...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/performance/16bit_storage_input_output/README.html

## Table of Contents

- [Overview](#_overview)
- [Enabling the 16-bit storage extension](#_enabling_the_16_bit_storage_extension)
- [Enabling_the_16-bit_storage_extension](#_enabling_the_16_bit_storage_extension)
- [Difference between storage and arithmetic support](#_difference_between_storage_and_arithmetic_support)
- [Difference_between_storage_and_arithmetic_support](#_difference_between_storage_and_arithmetic_support)
- [The 16-bit InputOutput storage sample](#_the_16_bit_inputoutput_storage_sample)
- [The_16-bit_InputOutput_storage_sample](#_the_16_bit_inputoutput_storage_sample)
- [Alternative implementation: mediump](#_alternative_implementation_mediump)
- [Alternative_implementation:_mediump](#_alternative_implementation_mediump)
- [Considering precision](#_considering_precision)
...
![16bit-storage InputOutput off](../../../_images/samples/performance/16bit_storage_input_output/images/fp16_input_output_disable.jpg)
...
![16bit-storage InputOutput on](../../../_images/samples/performance/16bit_storage_input_output/images/fp16_input_output_enable.jpg)

...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/performance/afbc/README.html

## Table of Contents

- [Overview](#_overview)
- [Enabling AFBC](#_enabling_afbc)
- [The AFBC Sample](#_the_afbc_sample)
- [The_AFBC_Sample](#_the_afbc_sample)
- [Format Support](#_format_support)
...
To find out your GPU and driver version, open the [debug window](../../../docs/misc.adoc#Debug-Window) or follow the steps in this [article](../../../docs/misc.adoc#Driver-Version).
...
![Sponza AFBC off](../../../_images/samples/performance/afbc/images/afbc_disabled.jpg)
...
![Sponza AFBC on](../../../_images/samples/performance/afbc/images/afbc_enabled.jpg)
...
![Streamline AFBC Off](../../../_images/samples/performance/afbc/images/streamline_disabled.png) ![Streamline AFBC On](../../../_images/samples/performance/afbc/images/streamline_enabled.png)
...
* 
You may also use the extension [`VK_EXT_image_compression_control`](https://docs.vulkan.org/spec/latest/appendices/extensions.html#VK_EXT_image_compression_control) to query if AFBC is enabled.
See the [Image Compression Control sample](../image_compression_control/README.html) for more details.

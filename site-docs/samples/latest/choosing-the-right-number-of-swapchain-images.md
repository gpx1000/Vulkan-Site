...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/performance/swapchain_images/README.html

## Table of Contents

- [Overview](#_overview)
- [Choosing a number of images](#_choosing_a_number_of_images)
- [Choosing_a_number_of_images](#_choosing_a_number_of_images)
- [Choosing a present mode](#_choosing_a_present_mode)
- [Choosing_a_present_mode](#_choosing_a_present_mode)
- [Double buffering or triple buffering?](#_double_buffering_or_triple_buffering)
- [Double_buffering_or_triple_buffering?](#_double_buffering_or_triple_buffering)
...
The application can ask for a minimum number of images by setting the `minImageCount` parameter in [vkCreateSwapchainKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/vkCreateSwapchainKHR.html).
The exact number of images created can then be polled via [vkGetSwapchainImagesKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/vkGetSwapchainImagesKHR.html).
...
![Double buffering at 60 FPS](../../../_images/samples/performance/swapchain_images/images/swapchain_double_buffering.png)
...
![Triple buffering at 60 FPS](../../../_images/samples/performance/swapchain_images/images/swapchain_triple_buffering.png)
...
![Sponza with triple buffering](../../../_images/samples/performance/swapchain_images/images/sponza_triple_buffering.jpg)
...
![Sponza with double buffering](../../../_images/samples/performance/swapchain_images/images/sponza_double_buffering.jpg)
...
![Streamline analysis](../../../_images/samples/performance/swapchain_images/images/streamline_swapchain_marker.png)
...
* 
It is possible to check how many images are created via [vkGetSwapchainImagesKHR](https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/vkGetSwapchainImagesKHR.html).

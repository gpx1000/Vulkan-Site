...
- **Component**: samples
- **Version**: latest
- **URL**: /samples/latest/samples/api/hello_triangle_1_3/README.html

## Table of Contents

- [Overview](#_overview)
- [Key Features](#_key_features)
- [1. Dynamic Rendering](#_1_dynamic_rendering)
- [1._Dynamic_Rendering](#_1_dynamic_rendering)
- [2. Synchronization2](#_2_synchronization2)
- [3. Extended Dynamic State](#_3_extended_dynamic_state)
- [3._Extended_Dynamic_State](#_3_extended_dynamic_state)
- [4. Vertex Buffers](#_4_vertex_buffers)
- [4._Vertex_Buffers](#_4_vertex_buffers)
- [How the Sample Works](#_how_the_sample_works)
- [How_the_Sample_Works](#_how_the_sample_works)
- [Dependencies and Requirements](#_dependencies_and_requirements)
- [Dependencies_and_Requirements](#_dependencies_and_requirements)

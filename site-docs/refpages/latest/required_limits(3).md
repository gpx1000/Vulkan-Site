...
| `uint32_t` | `splitBarrierReservedSharedMemory` | `[shaderSplitBarrier`](../../../../spec/latest/chapters/features.html#features-shaderSplitBarrier) |
...
| `uint32_t` | [VkPhysicalDeviceOpacityMicromapPropertiesKHR](VkPhysicalDeviceOpacityMicromapPropertiesKHR.html)::`maxOpacity2StateSubdivisionLevel` | `[VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](../../../../spec/latest/chapters/features.html#features-micromap) |
| `uint32_t` | `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxOpacity4StateSubdivisionLevel` | `[VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](../../../../spec/latest/chapters/features.html#features-micromap) |
| `uint32_t` | `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxOpacityLossy4StateSubdivisionLevel` | `[VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](../../../../spec/latest/chapters/features.html#features-micromap) |
| `uint64_t` | `VkPhysicalDeviceOpacityMicromapPropertiesKHR`::`maxMicromapTriangles` | `[VkPhysicalDeviceOpacityMicromapFeaturesKHR`::`micromap`](../../../../spec/latest/chapters/features.html#features-micromap) |
| `uint32_t` | [VkPhysicalDeviceOpacityMicromapPropertiesEXT](VkPhysicalDeviceOpacityMicromapPropertiesEXT.html)::`maxOpacity2StateSubdivisionLevel` | `[VK_EXT_opacity_micromap](VK_EXT_opacity_micromap.html)` |
| `uint32_t` | `VkPhysicalDeviceOpacityMicromapPropertiesEXT`::`maxOpacity4StateSubdivisionLevel` | `[VK_EXT_opacity_micromap](VK_EXT_opacity_micromap.html)` |
...
| [VkQueueFlags](VkQueueFlags.html) | [VkPhysicalDeviceQueuePerfHintPropertiesQCOM](VkPhysicalDeviceQueuePerfHintPropertiesQCOM.html)::`supportedQueues` | `[queuePerfHint`](../../../../spec/latest/chapters/features.html#features-queuePerfHint) |
...
| `uint32_t` | `maxShaderWaitQueues` | `[shaderMultipleWaitQueues`](../../../../spec/latest/chapters/features.html#features-shaderMultipleWaitQueues) |
...
| `uint64_t` | `maxShaderAbortMessageSize` | [`shaderAbort`](../../../../spec/latest/chapters/features.html#features-shaderAbort) |
| `uint32_t` | `maxDeviceFaultCount` | `[VK_KHR_device_fault](../../../../spec/latest/appendices/extensions.html#VK_KHR_device_fault)` |
| `uint32_t` | `maxTensorDimensionCount` | [`tensors`](../../../../spec/latest/chapters/features.html#features-tensors) |
| `uint64_t` | `maxTensorElements` | [`tensors`](../../../../spec/latest/chapters/features.html#features-tensors) |
| `uint64_t` | `maxPerDimensionTensorElements` | [`tensors`](../../../../spec/latest/chapters/features.html#features-tensors) |
| `int64_t` | `maxTensorStride` | [`tensors`](../../../../spec/latest/chapters/features.html#features-tensors) |
| `uint32_t` | `maxTensorShaderAccessArrayLength` | [`shaderTensorAccess`](../../../../spec/latest/chapters/features.html#features-shaderTensorAccess) |
| `uint32_t` | `maxTensorShaderAccessSize` | [`shaderTensorAccess`](../../../../spec/latest/chapters/features.html#features-shaderTensorAccess) |
| `uint32_t` | `maxDescriptorSetStorageTensors` | [`tensors`](../../../../spec/latest/chapters/features.html#features-tensors) |
| `uint32_t` | `maxPerStageDescriptorSetStorageTensors` | [`shaderTensorAccess`](../../../../spec/latest/chapters/features.html#features-shaderTensorAccess) |
| `uint32_t` | `maxDescriptorSetUpdateAfterBindStorageTensors` | [`descriptorBindingStorageTensorUpdateAfterBind`](../../../../spec/latest/chapters/features.html#features-descriptorBindingStorageTensorUpdateAfterBind) |
| `uint32_t` | `maxPerStageDescriptorUpdateAfterBindStorageTensors` | [`descriptorBindingStorageTensorUpdateAfterBind`](../../../../spec/latest/chapters/features.html#features-descriptorBindingStorageTensorUpdateAfterBind) and [`shaderTensorAccess`](../../../../spec/latest/chapters/features.html#features-shaderTensorAccess) |
| `VkBool32` | `shaderStorageTensorArrayNonUniformIndexingNative` | [`shaderStorageTensorArrayNonUniformIndexing`](../../../../spec/latest/chapters/features.html#features-shaderStorageTensorArrayNonUniformIndexing) |
| [VkShaderStageFlags](VkShaderStageFlags.html) | `shaderTensorSupportedStages` | [`shaderTensorAccess`](../../../../spec/latest/chapters/features.html#features-shaderTensorAccess) |
...
| [VkPhysicalDeviceOpacityMicromapPropertiesKHR](VkPhysicalDeviceOpacityMicromapPropertiesKHR.html)::`maxOpacity2StateSubdivisionLevel` | - | 3 | min |
...
| [VkPhysicalDeviceOpacityMicromapPropertiesEXT](VkPhysicalDeviceOpacityMicromapPropertiesEXT.html)::`maxOpacity2StateSubdivisionLevel` | - | 3 | min |
...
| [VkPhysicalDeviceQueuePerfHintPropertiesQCOM](VkPhysicalDeviceQueuePerfHintPropertiesQCOM.html)::`supportedQueues` | - | [VK_QUEUE_GRAPHICS_BIT](VkQueueFlagBits.html) \|

                                                                                 [VK_QUEUE_COMPUTE_BIT](VkQueueFlagBits.html) | bitfield |
| `maxApronSize` | - | 1 | min |
...
| `shaderTensorSupportedStages` | 0 | [VK_SHADER_STAGE_COMPUTE_BIT](VkShaderStageFlagBits.html) | bitfield |
...
As [VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT](VkDescriptorBindingFlagBits.html) **must** not be used
...
bindings created with [VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT](VkDescriptorBindingFlagBits.html),
...
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](VkDescriptorSetLayoutCreateFlagBits.html) than in
a pipeline layout not including any descriptor set layouts created with
[VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT](VkDescriptorSetLayoutCreateFlagBits.html) and

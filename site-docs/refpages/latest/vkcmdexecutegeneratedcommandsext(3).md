# vkCmdExecuteGeneratedCommandsEXT(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/vkCmdExecuteGeneratedCommandsEXT.html
...
With `[VK_EXT_device_generated_commands](VK_EXT_device_generated_commands.html)`, the actual generation of
...
If it is [VK_FALSE](VK_FALSE.html) this command will implicitly trigger the
...
If the [VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_BIT_EXT](VkIndirectCommandsLayoutUsageFlagBitsEXT.html)
flag was used to create the
[VkGeneratedCommandsInfoEXT](VkGeneratedCommandsInfoEXT.html)::`indirectCommandsLayout` then the
...
| --- | --- |
| [VK_INDIRECT_COMMANDS_TOKEN_TYPE_EXECUTION_SET_EXT](VkIndirectCommandsTokenTypeEXT.html) | Bound shaders and pipelines |
| [VK_INDIRECT_COMMANDS_TOKEN_TYPE_PUSH_CONSTANT_EXT](VkIndirectCommandsTokenTypeEXT.html) | Push constant data |
| [VK_INDIRECT_COMMANDS_TOKEN_TYPE_SEQUENCE_INDEX_EXT](VkIndirectCommandsTokenTypeEXT.html) | Push constant data |
| [VK_INDIRECT_COMMANDS_TOKEN_TYPE_PUSH_DATA_EXT](VkIndirectCommandsTokenTypeEXT.html) | Push data |
| [VK_INDIRECT_COMMANDS_TOKEN_TYPE_PUSH_DATA_SEQUENCE_INDEX_EXT](VkIndirectCommandsTokenTypeEXT.html) | Push data |
| [VK_INDIRECT_COMMANDS_TOKEN_TYPE_INDEX_BUFFER_EXT](VkIndirectCommandsTokenTypeEXT.html) | Index buffer |
| [VK_INDIRECT_COMMANDS_TOKEN_TYPE_VERTEX_BUFFER_EXT](VkIndirectCommandsTokenTypeEXT.html) | Vertex buffer |
...
If `isPreprocessed` is [VK_TRUE](VK_TRUE.html) and
[vkGetGeneratedCommandsMemoryRequirementsEXT](vkGetGeneratedCommandsMemoryRequirementsEXT.html) did not return a
required size of zero then [vkCmdPreprocessGeneratedCommandsEXT](vkCmdPreprocessGeneratedCommandsEXT.html)
...
[VkGeneratedCommandsInfoEXT](VkGeneratedCommandsInfoEXT.html)::`preprocessAddress`)

* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-isPreprocessed-11047) VUID-vkCmdExecuteGeneratedCommandsEXT-isPreprocessed-11047

If `isPreprocessed` is [VK_TRUE](VK_TRUE.html) then the
...
[VK_INDIRECT_COMMANDS_LAYOUT_USAGE_EXPLICIT_PREPROCESS_BIT_EXT](VkIndirectCommandsLayoutUsageFlagBitsEXT.html) bit
set, then `isPreprocessed` **must** be [VK_TRUE](VK_TRUE.html)
...
record another [vkCmdExecuteGeneratedCommandsEXT](#)

* 
[](#VUID-vkCmdExecuteGeneratedCommandsEXT-isPreprocessed-11048) VUID-vkCmdExecuteGeneratedCommandsEXT-isPreprocessed-11048

If `isPreprocessed` is [VK_TRUE](VK_TRUE.html) then the bound descriptor sets
...
If `isPreprocessed` is [VK_TRUE](VK_TRUE.html) then the conditional render
...
If `isPreprocessed` is [VK_TRUE](VK_TRUE.html) and the
`indirectCommandsLayout` member of `pGeneratedCommandsInfo`
...
If `isPreprocessed` is [VK_TRUE](VK_TRUE.html), then the queue family index of
...
[VK_INDIRECT_EXECUTION_SET_INFO_TYPE_SHADER_OBJECTS_EXT](VkIndirectExecutionSetInfoTypeEXT.html), every
executed [VK_INDIRECT_COMMANDS_TOKEN_TYPE_EXECUTION_SET_EXT](VkIndirectCommandsTokenTypeEXT.html) token
...
If `isPreprocessed` is [VK_TRUE](VK_TRUE.html) and the token sequence of the
passed [VkGeneratedCommandsInfoEXT](VkGeneratedCommandsInfoEXT.html)::`indirectCommandsLayout`
contains a [VK_INDIRECT_COMMANDS_TOKEN_TYPE_EXECUTION_SET_EXT](VkIndirectCommandsTokenTypeEXT.html)
token, the members of
[VkGeneratedCommandsInfoEXT](VkGeneratedCommandsInfoEXT.html)::`indirectExecutionSet` accessed by
...
If
[`deviceGeneratedCommandsTransformFeedback`](../../../../spec/latest/chapters/limits.html#limits-deviceGeneratedCommandsTransformFeedback)
...
`0` or `indirectExecutionSet` **must** be [VK_NULL_HANDLE](VK_NULL_HANDLE.html)
...
vkCmdExecuteGeneratedCommandsEXT is affected by [conditional rendering](../../../../spec/latest/chapters/drawing.html#drawing-conditional-rendering)

[VK_EXT_device_generated_commands](VK_EXT_device_generated_commands.html), `VkBool32`, [VkCommandBuffer](VkCommandBuffer.html), [VkGeneratedCommandsInfoEXT](VkGeneratedCommandsInfoEXT.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/device_generated_commands/generatedcommands.html#vkCmdExecuteGeneratedCommandsEXT).

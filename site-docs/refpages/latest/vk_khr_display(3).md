...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_KHR_display.html
...
* 
[vkCreateDisplayModeKHR](vkCreateDisplayModeKHR.html)

* 
[vkCreateDisplayPlaneSurfaceKHR](vkCreateDisplayPlaneSurfaceKHR.html)

* 
[vkGetDisplayModePropertiesKHR](vkGetDisplayModePropertiesKHR.html)

* 
[vkGetDisplayPlaneCapabilitiesKHR](vkGetDisplayPlaneCapabilitiesKHR.html)

* 
[vkGetDisplayPlaneSupportedDisplaysKHR](vkGetDisplayPlaneSupportedDisplaysKHR.html)

* 
[vkGetPhysicalDeviceDisplayPlanePropertiesKHR](vkGetPhysicalDeviceDisplayPlanePropertiesKHR.html)

* 
[vkGetPhysicalDeviceDisplayPropertiesKHR](vkGetPhysicalDeviceDisplayPropertiesKHR.html)

* 
[VkDisplayModeCreateInfoKHR](VkDisplayModeCreateInfoKHR.html)

* 
[VkDisplayModeParametersKHR](VkDisplayModeParametersKHR.html)

* 
[VkDisplayModePropertiesKHR](VkDisplayModePropertiesKHR.html)

* 
[VkDisplayPlaneCapabilitiesKHR](VkDisplayPlaneCapabilitiesKHR.html)

* 
[VkDisplayPlanePropertiesKHR](VkDisplayPlanePropertiesKHR.html)

* 
[VkDisplayPropertiesKHR](VkDisplayPropertiesKHR.html)

* 
[VkDisplaySurfaceCreateInfoKHR](VkDisplaySurfaceCreateInfoKHR.html)

* 
[VkDisplayPlaneAlphaFlagBitsKHR](VkDisplayPlaneAlphaFlagBitsKHR.html)

* 
[VkDisplayModeCreateFlagsKHR](VkDisplayModeCreateFlagsKHR.html)

* 
[VkDisplayPlaneAlphaFlagsKHR](VkDisplayPlaneAlphaFlagsKHR.html)

* 
[VkDisplaySurfaceCreateFlagsKHR](VkDisplaySurfaceCreateFlagsKHR.html)

* 
[VkSurfaceTransformFlagsKHR](VkSurfaceTransformFlagsKHR.html)
...
`[VK_KHR_surface](VK_KHR_surface.html)` and `[VK_KHR_swapchain](VK_KHR_swapchain.html)` query mechanisms.
...
| --- | --- |
`[VK_KHR_display_swapchain](VK_KHR_display_swapchain.html)` extensions was removed from the appendix
...
For more information, see the [Vulkan Specification](../../../../spec/latest/appendices/extensions.html#VK_KHR_display).

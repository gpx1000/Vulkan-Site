...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/vkCmdTraceRaysKHR.html
...
vkCmdTraceRaysKHR is not affected by [conditional rendering](../../../../spec/latest/chapters/drawing.html#drawing-conditional-rendering)

[VK_KHR_ray_tracing_pipeline](VK_KHR_ray_tracing_pipeline.html), [VkCommandBuffer](VkCommandBuffer.html), [VkStridedDeviceAddressRegionKHR](VkStridedDeviceAddressRegionKHR.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/raytracing.html#vkCmdTraceRaysKHR).

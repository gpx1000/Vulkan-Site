...
`flags` defines the [effective create flags](../../../../spec/latest/chapters/fundamentals.html#fundamentals-effective-flags) for the image.
If the `pNext` chain includes a [VkImageCreateFlags2CreateInfoKHR](VkImageCreateFlags2CreateInfoKHR.html)
structure, `flags` is ignored, and the effective create flags are
defined by [VkImageCreateFlags2CreateInfoKHR](VkImageCreateFlags2CreateInfoKHR.html)::`flags`.

`usage` defines the [effective usage flags](../../../../spec/latest/chapters/fundamentals.html#fundamentals-effective-flags) for the image.
If the `pNext` chain includes a [VkImageUsageFlags2CreateInfoKHR](VkImageUsageFlags2CreateInfoKHR.html)
structure, `usage` is ignored, and the effective usage flags are defined
by [VkImageUsageFlags2CreateInfoKHR](VkImageUsageFlags2CreateInfoKHR.html)::`usage`.
...
If the [`maintenance11`](../../../../spec/latest/chapters/features.html#features-maintenance11) feature is enabled
and `sharingMode` is [VK_SHARING_MODE_CONCURRENT](VkSharingMode.html), then
...
If
the [`maintenance11`](../../../../spec/latest/chapters/features.html#features-maintenance11) feature is not
enabled and
`sharingMode` is [VK_SHARING_MODE_CONCURRENT](VkSharingMode.html), then
...
[](#VUID-VkImageCreateInfo-initialLayout-00993) VUID-VkImageCreateInfo-initialLayout-00993
    ...
    `initialLayout` **must** be [VK_IMAGE_LAYOUT_UNDEFINED](VkImageLayout.html),
[VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT](VkImageLayout.html),
    or [VK_IMAGE_LAYOUT_PREINITIALIZED](VkImageLayout.html)

* 
[](#VUID-VkImageCreateInfo-initialLayout-12478) VUID-VkImageCreateInfo-initialLayout-12478

If `initialLayout` is [VK_IMAGE_LAYOUT_PREINITIALIZED](VkImageLayout.html),
...
If `flags` contains
[VK_IMAGE_CREATE_ALIAS_SINGLE_LAYER_DESCRIPTOR_BIT_KHR](VkImageCreateFlagBits.html), the
[`maintenance11`](../../../../spec/latest/chapters/features.html#features-maintenance11) feature **must** be enabled
...
`imageType` **must** be [VK_IMAGE_TYPE_1D](VkImageType.html) or
[VK_IMAGE_TYPE_2D](VkImageType.html)
...
If the `pNext` chain includes a
[VkImageTilingControlCreateInfoEXT](VkImageTilingControlCreateInfoEXT.html) structure, then the `pNext`
...
[VkImageStencilUsageCreateInfo](VkImageStencilUsageCreateInfo.html) and
...
[](#VUID-VkImageCreateInfo-pNext-pNext) VUID-VkImageCreateInfo-pNext-pNext
 ...
 Each `pNext` member of any structure (including this one) in the `pNext` chain **must** be either `NULL` or a pointer to a valid instance of [VkBufferCollectionImageCreateInfoFUCHSIA](VkBufferCollectionImageCreateInfoFUCHSIA.html), [VkDataGraphOpticalFlowImageFormatInfoARM](VkDataGraphOpticalFlowImageFormatInfoARM.html), [VkDedicatedAllocationImageCreateInfoNV](VkDedicatedAllocationImageCreateInfoNV.html), [VkExportMetalObjectCreateInfoEXT](VkExportMetalObjectCreateInfoEXT.html), [VkExternalFormatANDROID](VkExternalFormatANDROID.html), [VkExternalFormatOHOS](VkExternalFormatOHOS.html), [VkExternalFormatQNX](VkExternalFormatQNX.html), [VkExternalMemoryImageCreateInfo](VkExternalMemoryImageCreateInfo.html), [VkExternalMemoryImageCreateInfoNV](VkExternalMemoryImageCreateInfoNV.html), [VkImageAlignmentControlCreateInfoMESA](VkImageAlignmentControlCreateInfoMESA.html), [VkImageCompressionControlEXT](VkImageCompressionControlEXT.html), [VkImageCreateFlags2CreateInfoKHR](VkImageCreateFlags2CreateInfoKHR.html), [VkImageDrmFormatModifierExplicitCreateInfoEXT](VkImageDrmFormatModifierExplicitCreateInfoEXT.html), [VkImageDrmFormatModifierListCreateInfoEXT](VkImageDrmFormatModifierListCreateInfoEXT.html), [VkImageFormatListCreateInfo](VkImageFormatListCreateInfo.html), [VkImageStencilUsage2CreateInfoKHR](VkImageStencilUsage2CreateInfoKHR.html), [VkImageStencilUsageCreateInfo](VkImageStencilUsageCreateInfo.html), [VkImageSwapchainCreateInfoKHR](VkImageSwapchainCreateInfoKHR.html), [VkImageTilingControlCreateInfoEXT](VkImageTilingControlCreateInfoEXT.html), [VkImageUsageFlags2CreateInfoKHR](VkImageUsageFlags2CreateInfoKHR.html), [VkImportMetalIOSurfaceInfoEXT](VkImportMetalIOSurfaceInfoEXT.html), [VkImportMetalTextureInfoEXT](VkImportMetalTextureInfoEXT.html), [VkOpaqueCaptureDataCreateInfoEXT](VkOpaqueCaptureDataCreateInfoEXT.html), [VkOpaqueCaptureDescriptorDataCreateInfoEXT](VkOpaqueCaptureDescriptorDataCreateInfoEXT.html), [VkOpticalFlowImageFormatInfoNV](VkOpticalFlowImageFormatInfoNV.html), or [VkVideoProfileListInfoKHR](VkVideoProfileListInfoKHR.html)

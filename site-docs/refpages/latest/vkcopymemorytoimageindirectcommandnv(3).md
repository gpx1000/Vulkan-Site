# VkCopyMemoryToImageIndirectCommandNV(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VkCopyMemoryToImageIndirectCommandNV.html
...
[vkCmdCopyMemoryToImageIndirectNV](vkCmdCopyMemoryToImageIndirectNV.html) during command recording.
...
[VK_NV_copy_memory_indirect](VK_NV_copy_memory_indirect.html), `VkDeviceAddress`, [VkExtent3D](VkExtent3D.html), [VkImageSubresourceLayers](VkImageSubresourceLayers.html), [VkOffset3D](VkOffset3D.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/copies.html#VkCopyMemoryToImageIndirectCommandNV).

# vkCmdSetStencilTestEnable(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/vkCmdSetStencilTestEnable.html
...
To [dynamically enable or disable](../../../../spec/latest/chapters/pipelines.html#pipelines-dynamic-state) the stencil
test, call:
...
[VkPipelineDepthStencilStateCreateInfo](VkPipelineDepthStencilStateCreateInfo.html)::`stencilTestEnable` value
...
vkCmdSetStencilTestEnable is not affected by [conditional rendering](../../../../spec/latest/chapters/drawing.html#drawing-conditional-rendering)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/fragops.html#vkCmdSetStencilTestEnable).

# vkCmdDispatchGraphAMDX(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/vkCmdDispatchGraphAMDX.html
...
contain valid [VkDispatchGraphInfoAMDX](VkDispatchGraphInfoAMDX.html) structures in the first 24
bytes
...
vkCmdDispatchGraphAMDX is affected by [conditional rendering](../../../../spec/latest/chapters/drawing.html#drawing-conditional-rendering)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/executiongraphs.html#vkCmdDispatchGraphAMDX).

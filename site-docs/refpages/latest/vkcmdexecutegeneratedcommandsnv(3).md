# vkCmdExecuteGeneratedCommandsNV(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/vkCmdExecuteGeneratedCommandsNV.html
...
With `[VK_NV_device_generated_commands](VK_NV_device_generated_commands.html)`, the actual generation of
...
If the [VK_INDIRECT_COMMANDS_LAYOUT_USAGE_UNORDERED_SEQUENCES_BIT_NV](VkIndirectCommandsLayoutUsageFlagBitsNV.html)
flag was used to create the
[VkGeneratedCommandsInfoNV](VkGeneratedCommandsInfoNV.html)::`indirectCommandsLayout` then the order
...
[VkGeneratedCommandsInfoNV](VkGeneratedCommandsInfoNV.html)::`pStreams`.
...
specified in [VkGeneratedCommandsInfoNV](VkGeneratedCommandsInfoNV.html)::`pStreams`.
...
If `isPreprocessed` is [VK_TRUE](VK_TRUE.html) then
[vkCmdPreprocessGeneratedCommandsNV](vkCmdPreprocessGeneratedCommandsNV.html) **must** have already been
...
except [VkGeneratedCommandsInfoNV](VkGeneratedCommandsInfoNV.html)::`preprocessBuffer`).
...
[VkGeneratedCommandsInfoNV](VkGeneratedCommandsInfoNV.html)::`pipeline` **must** match the current
bound pipeline at
[VkGeneratedCommandsInfoNV](VkGeneratedCommandsInfoNV.html)::`pipelineBindPoint`
...
vkCmdExecuteGeneratedCommandsNV is affected by [conditional rendering](../../../../spec/latest/chapters/drawing.html#drawing-conditional-rendering)

[VK_NV_device_generated_commands](VK_NV_device_generated_commands.html), `VkBool32`, [VkCommandBuffer](VkCommandBuffer.html), [VkGeneratedCommandsInfoNV](VkGeneratedCommandsInfoNV.html)

For more information, see the [Vulkan Specification](../../../../spec/latest/chapters/device_generated_commands/generatedcommands.html#vkCmdExecuteGeneratedCommandsNV).

...
- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_EXT_image_drm_format_modifier.html
...
`EGL_EXT_image_dma_buf_import_modifiers`[2](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn2)
and
`EGL_MESA_image_dma_buf_export`[3](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn3).
...
[VkImportMemoryFdInfoKHR](VkImportMemoryFdInfoKHR.html) and its *modifier* to
[VkImageDrmFormatModifierExplicitCreateInfoEXT](VkImageDrmFormatModifierExplicitCreateInfoEXT.html).
...
defined in
[`drm_fourcc.h`](https://git.kernel.org/pub/scm/linux/kernel/git/torvalds/linux.git/tree/include/uapi/drm/drm_fourcc.h).
However, `VK_EXT_image_drm_format_modifier` uses [VkFormat](VkFormat.html) instead of
DRM formats.
The application must convert between [VkFormat](VkFormat.html) and DRM format when it
sends or receives a DRM format to or from an external API.

The mapping from [VkFormat](VkFormat.html) to DRM format is lossy.
...
DRM format to a [VkFormat](VkFormat.html).
...
The mapping between [VkFormat](VkFormat.html) and DRM format is also incomplete.
...
In this extension, [vkGetPhysicalDeviceFormatProperties2](vkGetPhysicalDeviceFormatProperties2.html) with
[VkDrmFormatModifierPropertiesListEXT](VkDrmFormatModifierPropertiesListEXT.html) serves a primary role during the
negotiation, and [vkGetPhysicalDeviceImageFormatProperties2](vkGetPhysicalDeviceImageFormatProperties2.html) with
[VkPhysicalDeviceImageDrmFormatModifierInfoEXT](VkPhysicalDeviceImageDrmFormatModifierInfoEXT.html) serves a secondary role.
...
[VkDrmFormatModifierPropertiesListEXT](VkDrmFormatModifierPropertiesListEXT.html) and
[vkGetPhysicalDeviceImageFormatProperties2](vkGetPhysicalDeviceImageFormatProperties2.html) with
...
[VkImageDrmFormatModifierExplicitCreateInfoEXT](VkImageDrmFormatModifierExplicitCreateInfoEXT.html) and
[VkExternalMemoryImageCreateInfo](VkExternalMemoryImageCreateInfo.html) onto [VkImageCreateInfo](VkImageCreateInfo.html).
...
[`offset`](../../../../spec/latest/chapters/resources.html#VkSubresourceLayout),
[`size`](../../../../spec/latest/chapters/resources.html#VkSubresourceLayout), and
[`rowPitch`](../../../../spec/latest/chapters/resources.html#VkSubresourceLayout) of each *memory plane*.
...
[VkImageDrmFormatModifierListCreateInfoEXT](VkImageDrmFormatModifierListCreateInfoEXT.html) and
[VkExternalMemoryImageCreateInfo](VkExternalMemoryImageCreateInfo.html) onto [VkImageCreateInfo](VkImageCreateInfo.html).
...
[vkGetImageDrmFormatModifierPropertiesEXT](vkGetImageDrmFormatModifierPropertiesEXT.html), and queries the memory
layout of each plane with [vkGetImageSubresourceLayout](vkGetImageSubresourceLayout.html).

The application then allocates the image’s memory with
[VkMemoryAllocateInfo](VkMemoryAllocateInfo.html), adding chained extending structures for external
...
Extension
`EGL_EXT_image_dma_buf_import`[1](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn1)
...
drm_mode_fb_cmd2`[4](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn4), allows one to
...
`EGL_EXT_image_dma_buf_import_modifiers`[1](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn1);
and symmetrically allows exporting the same data from the `gbm_bo`.
See the references to *modifier* and *plane* in
`gbm.h`[5](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn5).

* 
[vkGetImageDrmFormatModifierPropertiesEXT](vkGetImageDrmFormatModifierPropertiesEXT.html)

* 
[VkDrmFormatModifierPropertiesEXT](VkDrmFormatModifierPropertiesEXT.html)

* 
[VkImageDrmFormatModifierPropertiesEXT](VkImageDrmFormatModifierPropertiesEXT.html)
...
* 
[VkImageDrmFormatModifierListCreateInfoEXT](VkImageDrmFormatModifierListCreateInfoEXT.html)
...
* 
[VkDrmFormatModifierProperties2EXT](VkDrmFormatModifierProperties2EXT.html)

* 
Extending [VkFormatProperties2](VkFormatProperties2.html):

[VkDrmFormatModifierPropertiesList2EXT](VkDrmFormatModifierPropertiesList2EXT.html)
...
`EGL_EXT_image_dma_buf_import_modifiers`[2](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn2),
`struct drm_mode_fb_cmd2`[4](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn4), and
`struct
gbm_import_fd_modifier_data`[5](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier-fn5),
...
[VkImageDrmFormatModifierExplicitCreateInfoEXT](VkImageDrmFormatModifierExplicitCreateInfoEXT.html), which is typically used
...
[VkImageDrmFormatModifierExplicitCreateInfoEXT](VkImageDrmFormatModifierExplicitCreateInfoEXT.html)::`pPlaneLayouts->size`
**must** be 0.
...
[vkCreateImage](vkCreateImage.html), the implementation would observe the mismatched size
...
implementation-calculated size.
If the application provided the external image’s size to
[vkCreateImage](vkCreateImage.html), for reasons similar to above the implementation would
...
This decision renders [VkSubresourceLayout](VkSubresourceLayout.html)::`size` an unused field
...
For more information, see the [Vulkan Specification](../../../../spec/latest/appendices/extensions.html#VK_EXT_image_drm_format_modifier).

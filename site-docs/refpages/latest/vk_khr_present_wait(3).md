# VK_KHR_present_wait(3)

## Metadata

- **Component**: refpages
- **Version**: latest
- **URL**: /refpages/latest/refpages/source/VK_KHR_present_wait.html
...
* 
[vkWaitForPresentKHR](vkWaitForPresentKHR.html)

* 
Extending [VkPhysicalDeviceFeatures2](VkPhysicalDeviceFeatures2.html), [VkDeviceCreateInfo](VkDeviceCreateInfo.html):

[VkPhysicalDevicePresentWaitFeaturesKHR](VkPhysicalDevicePresentWaitFeaturesKHR.html)
...
For more information, see the [Vulkan Specification](../../../../spec/latest/appendices/extensions.html#VK_KHR_present_wait).

...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/atomics.html

## Table of Contents

- [Variations of Atomics](#_variations_of_atomics)
- [Variations_of_Atomics](#_variations_of_atomics)
- [Baseline Support](#_baseline_support)
- [Atomic Counters](#_atomic_counters)
- [Expanding Atomic support](#_expanding_atomic_support)
- [Expanding_Atomic_support](#_expanding_atomic_support)
- [VK_KHR_shader_atomic_int64](#VK_KHR_shader_atomic_int64)
- [VK_EXT_shader_image_atomic_int64](#VK_EXT_shader_image_atomic_int64)
- [Image vs Sparse Image support](#_image_vs_sparse_image_support)
- [Image_vs_Sparse_Image_support](#_image_vs_sparse_image_support)
...
* 
[VK_KHR_shader_atomic_int64](https://registry.khronos.org/vulkan/specs/latest/man/html/VK_KHR_shader_atomic_int64.html)

* 
[VK_EXT_shader_image_atomic_int64](https://registry.khronos.org/vulkan/specs/latest/man/html/VK_EXT_shader_image_atomic_int64.html)

* 
[VK_EXT_shader_atomic_float](https://registry.khronos.org/vulkan/specs/latest/man/html/VK_EXT_shader_atomic_float.html)

* 
[VK_EXT_shader_atomic_float2](https://registry.khronos.org/vulkan/specs/latest/man/html/VK_EXT_shader_atomic_float2.html)

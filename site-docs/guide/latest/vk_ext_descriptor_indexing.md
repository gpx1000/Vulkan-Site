...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/extensions/VK_EXT_descriptor_indexing.html

## Table of Contents

- [Update after Bind](#_update_after_bind)
- [Update_after_Bind](#_update_after_bind)
- [Partially bound](#_partially_bound)
- [Dynamic Indexing](#_dynamic_indexing)
- [Dynamic Non-Uniform Indexing](#_dynamic_non_uniform_indexing)
- [Dynamic_Non-Uniform_Indexing](#_dynamic_non_uniform_indexing)
...
![VK_EXT_descriptor_indexing_update_after_bind.png](../_images/extensions/VK_EXT_descriptor_indexing_update_after_bind.png)

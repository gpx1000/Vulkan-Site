...
varying ([removed in GLSL 4.20](https://registry.khronos.org/OpenGL/specs/gl/GLSLangSpec.4.20.pdf))
Matching semantics
...
memory type
automatically managed, [texture storage hint](https://registry.khronos.org/OpenGL/extensions/APPLE/APPLE_texture_range.txt), [buffer storage](https://registry.khronos.org/OpenGL/extensions/ARB/ARB_buffer_storage.txt)

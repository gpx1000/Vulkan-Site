...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/extensions/VK_KHR_synchronization2.html

## Table of Contents

- [Rethinking Pipeline Stages and Access Flags](#_rethinking_pipeline_stages_and_access_flags)
- [Rethinking_Pipeline_Stages_and_Access_Flags](#_rethinking_pipeline_stages_and_access_flags)
- [Adding barriers for setting events](#_adding_barriers_for_setting_events)
- [Adding_barriers_for_setting_events](#_adding_barriers_for_setting_events)
- [Reusing the same pipeline stage and access flag names](#_reusing_the_same_pipeline_stage_and_access_flag_names)
- [Reusing_the_same_pipeline_stage_and_access_flag_names](#_reusing_the_same_pipeline_stage_and_access_flag_names)
- [VkSubpassDependency](#_vksubpassdependency)
- [Splitting up pipeline stages and access masks](#_splitting_up_pipeline_stages_and_access_masks)
...
- [Combining_shader_stages_for_pre-rasterization](#_combining_shader_stages_for_pre_rasterization)
- [VK_ACCESS_SHADER_WRITE_BIT alias](#_vk_access_shader_write_bit_alias)
- [VK_ACCESS_SHADER_WRITE_BIT_alias](#_vk_access_shader_write_bit_alias)
- [TOP_OF_PIPE and BOTTOM_OF_PIPE deprecation](#_top_of_pipe_and_bottom_of_pipe_deprecation)
- [TOP_OF_PIPE_and_BOTTOM_OF_PIPE_deprecation](#_top_of_pipe_and_bottom_of_pipe_deprecation)
- [Making use of new image layouts](#_making_use_of_new_image_layouts)
- [Making_use_of_new_image_layouts](#_making_use_of_new_image_layouts)
- [New submission flow](#_new_submission_flow)
- [New_submission_flow](#_new_submission_flow)
- [Emulation Layer](#_emulation_layer)
...
![VK_KHR_synchronization2_stage_access](../_images/extensions/VK_KHR_synchronization2_stage_access.png)

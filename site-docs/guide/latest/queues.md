...
- **Component**: guide
- **Version**: latest
- **URL**: /guide/latest/queues.html

## Table of Contents

- [Queue Family](#_queue_family)
- [Knowing which Queue Family is needed](#_knowing_which_queue_family_is_needed)
- [Knowing_which_Queue_Family_is_needed](#_knowing_which_queue_family_is_needed)
- [Querying for Queue Family](#_querying_for_queue_family)
- [Querying_for_Queue_Family](#_querying_for_queue_family)
- [Creating and getting a Queue](#_creating_and_getting_a_queue)
- [Creating_and_getting_a_Queue](#_creating_and_getting_a_queue)
...
The following are the queue operations found in [VkQueueFlagBits](https://registry.khronos.org/vulkan/specs/latest/man/html/VkQueueFlagBits.html):
...
[VK_PIPELINE_STAGE_TRANSFER_BIT](https://registry.khronos.org/vulkan/specs/latest/man/html/VkPipelineStageFlagBits.html) in the Spec describes “transfer commands”.
...
`VK_QUEUE_SPARSE_BINDING_BIT` used for binding [sparse resources](sparse_resources.html#sparse-resources) to memory with `vkQueueBindSparse`.

`VK_QUEUE_PROTECTED_BIT` used for [protected memory](protected.html#protected).
...
Each operation in the Vulkan Spec has a “Supported Queue Types” section generated from the [vk.xml](https://github.com/KhronosGroup/Vulkan-Docs/blob/main/xml/vk.xml) file. The following is 3 different examples of what it looks like in the Spec:

![queues_cmd_dispatch.png](_images/queues_cmd_draw.png)

![queues_cmd_dispatch.png](_images/queues_cmd_dispatch.png)

![queues_cmd_dispatch.png](_images/queues_cmd_executecommands.png)
...
![queues_hypothetical.png](_images/queues_hypothetical.png)
